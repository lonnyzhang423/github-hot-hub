...
1. [input-output-hk / lobster-challenge](https://github.com/input-output-hk/lobster-challenge)
    ...
    - language: **Haskell** &nbsp;&nbsp; stars: **93** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `12 stars today`
...
1. [AngeloCasi / FUGU-ARDUINO-MPPT-FIRMWARE](https://github.com/AngeloCasi/FUGU-ARDUINO-MPPT-FIRMWARE)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **116** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `9 stars today`
...
1. [CyberPunkMetalHead / binance-trading-bot-new-coins](https://github.com/CyberPunkMetalHead/binance-trading-bot-new-coins)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,061** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `104 stars today`

1. [TaKO8Ki / gobang](https://github.com/TaKO8Ki/gobang)
    - A cross-platform TUI database management tool written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **1,263** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `280 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **119,109** &nbsp;&nbsp; folks: **19,627**  &nbsp;&nbsp; `236 stars today`
...
1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **739** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `252 stars this week`

1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    - Real-ESRGAN aims at developing Practical Algorithms for General Image Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **2,388** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `922 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **20,805** &nbsp;&nbsp; folks: **4,374**  &nbsp;&nbsp; `3,099 stars this week`

1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,775** &nbsp;&nbsp; folks: **1,848**  &nbsp;&nbsp; `1,763 stars this week`
...
1. [bespoyasov / frontend-clean-architecture](https://github.com/bespoyasov/frontend-clean-architecture)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **950** &nbsp;&nbsp; folks: **60**  &nbsp;&nbsp; `371 stars this week`
...
1. [lima-vm / lima](https://github.com/lima-vm/lima)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,990** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `381 stars this week`
...
1. [microsoft / recommenders](https://github.com/microsoft/recommenders)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,215** &nbsp;&nbsp; folks: **1,918**  &nbsp;&nbsp; `180 stars this week`

1. [solana-labs / solana](https://github.com/solana-labs/solana)
    - Web-Scale Blockchain for fast, secure, scalable, decentralized apps and marketplaces.
    - language: **Rust** &nbsp;&nbsp; stars: **3,910** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `282 stars this week`

1. [pyg-team / pytorch_geometric](https://github.com/pyg-team/pytorch_geometric)
    - Graph Neural Network Library for PyTorch
    - language: **Python** &nbsp;&nbsp; stars: **12,067** &nbsp;&nbsp; folks: **2,094**  &nbsp;&nbsp; `189 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **84,157** &nbsp;&nbsp; folks: **8,972**  &nbsp;&nbsp; `964 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, support 80+ languages recognition, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **16,147** &nbsp;&nbsp; folks: **3,235**  &nbsp;&nbsp; `1,095 stars this week`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **8,827** &nbsp;&nbsp; folks: **1,953**  &nbsp;&nbsp; `285 stars this week`
...
1. [khanhas / spicetify-cli](https://github.com/khanhas/spicetify-cli)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,234** &nbsp;&nbsp; folks: **308**  &nbsp;&nbsp; `327 stars this week`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **129,785** &nbsp;&nbsp; folks: **18,658**  &nbsp;&nbsp; `1,115 stars this week`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,836** &nbsp;&nbsp; folks: **916**  &nbsp;&nbsp; `785 stars this week`

1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    - Create generative art by using the canvas api and node js
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,021** &nbsp;&nbsp; folks: **265**  &nbsp;&nbsp; `378 stars this week`
...
1. [huggingface / datasets](https://github.com/huggingface/datasets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,785** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `889 stars this week`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,243** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `4,803 stars this month`
...
1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **49,369** &nbsp;&nbsp; folks: **4,223**  &nbsp;&nbsp; `2,578 stars this month`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    - Web-Scale Blockchain for fast, secure, scalable, decentralized apps and marketplaces.
    - language: **Rust** &nbsp;&nbsp; stars: **3,910** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `1,004 stars this month`

1. [containers / podman](https://github.com/containers/podman)
    - Podman: A tool for managing OCI containers and pods.
    - language: **Go** &nbsp;&nbsp; stars: **10,189** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `1,650 stars this month`
...
1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **15,552** &nbsp;&nbsp; folks: **4,109**  &nbsp;&nbsp; `1,895 stars this month`

1. [google / zx](https://github.com/google/zx)
    - A tool for writing better scripts
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,708** &nbsp;&nbsp; folks: **431**  &nbsp;&nbsp; `4,238 stars this month`
