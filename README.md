...
`更新时间：2021-08-06 09:53:08 +0800`

## 今日热门仓库

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **27,047** &nbsp;&nbsp; folks: **5,324**  &nbsp;&nbsp; `373 stars today`
...
1. [bytedance / Fastbot_iOS](https://github.com/bytedance/Fastbot_iOS)
    ...
    - language: **Objective-C** &nbsp;&nbsp; stars: **153** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `47 stars today`

1. [clouDr-f2e / rubick](https://github.com/clouDr-f2e/rubick)
    - 🔧 基于 electron 的开源工具箱，自由集成丰富插件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,289** &nbsp;&nbsp; folks: **149**  &nbsp;&nbsp; `130 stars today`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **528** &nbsp;&nbsp; folks: **188**  &nbsp;&nbsp; `342 stars this week`

1. [fuzhengwei / small-spring](https://github.com/fuzhengwei/small-spring)
    - 🌱《 Spring 手撸专栏》，本专栏以 Spring 源码学习为目的，通过手写简化版 Spring 框架，了解 Spring 核心原理。在手写的过程中会简化 Spring 源码，摘取整体框架中的核心逻辑，简化代码实现过程，保留核心功能，例如：IOC、AOP、Bean生命周期、上下文、作用域、资源处理等内容实现。
    - language: **Java** &nbsp;&nbsp; stars: **989** &nbsp;&nbsp; folks: **182**  &nbsp;&nbsp; `480 stars this week`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,926** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `1,030 stars this week`
...
1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,995** &nbsp;&nbsp; folks: **2,985**  &nbsp;&nbsp; `934 stars this week`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,018** &nbsp;&nbsp; folks: **1,470**  &nbsp;&nbsp; `482 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **27,047** &nbsp;&nbsp; folks: **5,324**  &nbsp;&nbsp; `968 stars this week`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **328,293** &nbsp;&nbsp; folks: **26,306**  &nbsp;&nbsp; `1,466 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **7,901** &nbsp;&nbsp; folks: **1,840**  &nbsp;&nbsp; `1,015 stars this week`
...
1. [clouDr-f2e / rubick](https://github.com/clouDr-f2e/rubick)
    - 🔧 基于 electron 的开源工具箱，自由集成丰富插件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,289** &nbsp;&nbsp; folks: **149**  &nbsp;&nbsp; `468 stars this week`
...
1. [erda-project / erda](https://github.com/erda-project/erda)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,556** &nbsp;&nbsp; folks: **185**  &nbsp;&nbsp; `367 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,392** &nbsp;&nbsp; folks: **5,249**  &nbsp;&nbsp; `378 stars this week`

1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,447** &nbsp;&nbsp; folks: **1,441**  &nbsp;&nbsp; `180 stars this week`
...
1. [dromara / Sa-Token](https://github.com/dromara/Sa-Token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,277** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `1,664 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,807** &nbsp;&nbsp; folks: **3,629**  &nbsp;&nbsp; `10,232 stars this month`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **7,901** &nbsp;&nbsp; folks: **1,840**  &nbsp;&nbsp; `2,995 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,926** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `1,296 stars this month`
...
1. [go-kratos / kratos](https://github.com/go-kratos/kratos)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **14,270** &nbsp;&nbsp; folks: **2,882**  &nbsp;&nbsp; `1,271 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,497** &nbsp;&nbsp; folks: **769**  &nbsp;&nbsp; `2,231 stars this month`
...
1. [zero205 / JD_tencent_scf](https://github.com/zero205/JD_tencent_scf)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **708** &nbsp;&nbsp; folks: **226**  &nbsp;&nbsp; `533 stars this month`
...
1. [serverless-stack / serverless-stack](https://github.com/serverless-stack/serverless-stack)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,430** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `406 stars this month`
...
1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,018** &nbsp;&nbsp; folks: **1,470**  &nbsp;&nbsp; `735 stars this month`
