...
`更新时间：2022-03-24 05:12:34 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,604** &nbsp;&nbsp; folks: **4,220**  &nbsp;&nbsp; `464 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,820** &nbsp;&nbsp; folks: **730**  &nbsp;&nbsp; `250 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,168** &nbsp;&nbsp; folks: **1,496**  &nbsp;&nbsp; `784 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,422** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `363 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,565** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `2,546 stars this week`

1. [nkallen / plasticity](https://github.com/nkallen/plasticity)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,538** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `755 stars this week`

1. [AmruthPillai / Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume)
    - A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,803** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `917 stars this week`
...
1. [cat-milk / Anime-Girls-Holding-Programming-Books](https://github.com/cat-milk/Anime-Girls-Holding-Programming-Books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,921** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `3,537 stars this month`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,604** &nbsp;&nbsp; folks: **4,220**  &nbsp;&nbsp; `15,427 stars this month`

1. [MHProDev / MHDDoS](https://github.com/MHProDev/MHDDoS)
    - Best DDoS Attack Script Python3, Cyber Attack With 51 Methods
    - language: **Python** &nbsp;&nbsp; stars: **3,280** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `2,451 stars this month`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,565** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `4,237 stars this month`

1. [alibaba / lowcode-engine](https://github.com/alibaba/lowcode-engine)
    - An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,657** &nbsp;&nbsp; folks: **332**  &nbsp;&nbsp; `1,827 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **227,333** &nbsp;&nbsp; folks: **47,991**  &nbsp;&nbsp; `5,288 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,711** &nbsp;&nbsp; folks: **6,461**  &nbsp;&nbsp; `3,919 stars this month`

1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    - 👽 Open source API development ecosystem - https://hoppscotch.io
    - language: **Vue** &nbsp;&nbsp; stars: **40,537** &nbsp;&nbsp; folks: **2,760**  &nbsp;&nbsp; `3,734 stars this month`
...
1. [OpenIMSDK / Open-IM-Server](https://github.com/OpenIMSDK/Open-IM-Server)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,986** &nbsp;&nbsp; folks: **1,064**  &nbsp;&nbsp; `504 stars this month`

1. [trailofbits / algo](https://github.com/trailofbits/algo)
    - Set up a personal VPN in the cloud
    - language: **Jinja** &nbsp;&nbsp; stars: **25,142** &nbsp;&nbsp; folks: **2,077**  &nbsp;&nbsp; `547 stars this month`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **61,886** &nbsp;&nbsp; folks: **16,841**  &nbsp;&nbsp; `1,365 stars this month`

1. [iamadamdev / bypass-paywalls-chrome](https://github.com/iamadamdev/bypass-paywalls-chrome)
    - Bypass Paywalls web browser extension for Chrome and Firefox.
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,308** &nbsp;&nbsp; folks: **1,748**  &nbsp;&nbsp; `2,027 stars this month`

1. [vulhub / vulhub](https://github.com/vulhub/vulhub)
    - Pre-Built Vulnerable Environments Based on Docker-Compose
    - language: **Dockerfile** &nbsp;&nbsp; stars: **9,846** &nbsp;&nbsp; folks: **3,347**  &nbsp;&nbsp; `441 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,422** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `2,172 stars this month`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,765** &nbsp;&nbsp; folks: **1,306**  &nbsp;&nbsp; `842 stars this month`
...
1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **18,224** &nbsp;&nbsp; folks: **2,217**  &nbsp;&nbsp; `1,259 stars this month`

1. [mdn / content](https://github.com/mdn/content)
    - The content behind MDN Web Docs
    - language: **Markdown** &nbsp;&nbsp; stars: **4,957** &nbsp;&nbsp; folks: **7,526**  &nbsp;&nbsp; `676 stars this month`

1. [facebook / react](https://github.com/facebook/react)
    - A declarative, efficient, and flexible JavaScript library for building user interfaces.
    - language: **JavaScript** &nbsp;&nbsp; stars: **184,784** &nbsp;&nbsp; folks: **37,869**  &nbsp;&nbsp; `2,481 stars this month`

1. [ultralytics / yolov5](https://github.com/ultralytics/yolov5)
    - YOLOv5 🚀 in PyTorch > ONNX > CoreML > TFLite
    - language: **Python** &nbsp;&nbsp; stars: **23,714** &nbsp;&nbsp; folks: **8,453**  &nbsp;&nbsp; `1,402 stars this month`

1. [vuejs / vue](https://github.com/vuejs/vue)
    - 🖖 Vue.js is a progressive, incrementally-adoptable JavaScript framework for building UI on the web.
    - language: **JavaScript** &nbsp;&nbsp; stars: **194,373** &nbsp;&nbsp; folks: **31,748**  &nbsp;&nbsp; `1,458 stars this month`

1. [type-challenges / type-challenges](https://github.com/type-challenges/type-challenges)
    - Collection of TypeScript type challenges with online judge
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,828** &nbsp;&nbsp; folks: **1,135**  &nbsp;&nbsp; `1,792 stars this month`

1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    - 🤓 Build your own (insert technology here)
    - language: **无** &nbsp;&nbsp; stars: **136,202** &nbsp;&nbsp; folks: **12,951**  &nbsp;&nbsp; `4,365 stars this month`
