...
1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,319** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `393 stars this week`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **2,956** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `1,488 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,854** &nbsp;&nbsp; folks: **5,322**  &nbsp;&nbsp; `741 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **28,443** &nbsp;&nbsp; folks: **5,363**  &nbsp;&nbsp; `2,029 stars this week`

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **2,044** &nbsp;&nbsp; folks: **93**  &nbsp;&nbsp; `1,179 stars this week`
...
1. [kubernetes / kompose](https://github.com/kubernetes/kompose)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,914** &nbsp;&nbsp; folks: **558**  &nbsp;&nbsp; `461 stars this week`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **15,130** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `1,605 stars this week`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,308** &nbsp;&nbsp; folks: **4,200**  &nbsp;&nbsp; `713 stars this week`

1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,564** &nbsp;&nbsp; folks: **1,457**  &nbsp;&nbsp; `193 stars this week`
...
1. [clouDr-f2e / rubick](https://github.com/clouDr-f2e/rubick)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,511** &nbsp;&nbsp; folks: **166**  &nbsp;&nbsp; `547 stars this week`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **627** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `158 stars this week`

1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    - A Modern Real-Time Data Processing & Analytics DBMS with Cloud-Native Architecture, built to make the Data Cloud easy
    - language: **Rust** &nbsp;&nbsp; stars: **1,764** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `802 stars this week`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,196** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `406 stars this week`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **11,172** &nbsp;&nbsp; folks: **1,629**  &nbsp;&nbsp; `125 stars this week`
...
1. [sveltejs / kit](https://github.com/sveltejs/kit)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,323** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `92 stars this week`

1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants
    - language: **Python** &nbsp;&nbsp; stars: **12,470** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `700 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,393** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `763 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,059** &nbsp;&nbsp; folks: **2,897**  &nbsp;&nbsp; `337 stars this week`

1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    - A modular embodied agent architecture and platform for building embodied agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **609** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `153 stars this week`
...
1. [dromara / Sa-Token](https://github.com/dromara/Sa-Token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,396** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `1,748 stars this month`

1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    - 12 Weeks, 24 Lessons, IoT for All!
    - language: **C++** &nbsp;&nbsp; stars: **6,640** &nbsp;&nbsp; folks: **638**  &nbsp;&nbsp; `6,356 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,393** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `1,711 stars this month`

1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **9,456** &nbsp;&nbsp; folks: **755**  &nbsp;&nbsp; `2,153 stars this month`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **8,217** &nbsp;&nbsp; folks: **1,942**  &nbsp;&nbsp; `2,358 stars this month`

1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - language: **Python** &nbsp;&nbsp; stars: **24,158** &nbsp;&nbsp; folks: **2,997**  &nbsp;&nbsp; `1,395 stars this month`

1. [shufflewzc / faker2](https://github.com/shufflewzc/faker2)
    - 不知名大佬备份
    - language: **JavaScript** &nbsp;&nbsp; stars: **833** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `739 stars this month`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **22,838** &nbsp;&nbsp; folks: **1,707**  &nbsp;&nbsp; `4,033 stars this month`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **8,669** &nbsp;&nbsp; folks: **1,250**  &nbsp;&nbsp; `2,570 stars this month`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,854** &nbsp;&nbsp; folks: **5,322**  &nbsp;&nbsp; `1,065 stars this month`
...
1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,196** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `855 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,845** &nbsp;&nbsp; folks: **787**  &nbsp;&nbsp; `2,380 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,373** &nbsp;&nbsp; folks: **14,191**  &nbsp;&nbsp; `575 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,014** &nbsp;&nbsp; folks: **4,505**  &nbsp;&nbsp; `3,334 stars this month`
