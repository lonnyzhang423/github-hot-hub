...
`更新时间：2021-01-31 13:14:47 +0800`

## 今日热门仓库

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,859** &nbsp;&nbsp; folks: **999**  &nbsp;&nbsp; `307 stars today`

1. [evilsocket / ditto](https://github.com/evilsocket/ditto)
    - A tool for IDN homograph attacks and detection.
    - language: **Go** &nbsp;&nbsp; stars: **248** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `111 stars today`

1. [bullhe4d / bigwatermelon](https://github.com/bullhe4d/bigwatermelon)
    - 合成大西瓜源码,修改版
    - language: **JavaScript** &nbsp;&nbsp; stars: **382** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `172 stars today`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,299** &nbsp;&nbsp; folks: **2,195**  &nbsp;&nbsp; `323 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,370** &nbsp;&nbsp; folks: **1,175**  &nbsp;&nbsp; `377 stars today`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,698** &nbsp;&nbsp; folks: **484**  &nbsp;&nbsp; `46 stars today`
...
1. [yeungon / In-JavaScript-we-trust](https://github.com/yeungon/In-JavaScript-we-trust)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **343** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `35 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,567** &nbsp;&nbsp; folks: **21,004**  &nbsp;&nbsp; `65 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,292** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `187 stars today`
...
1. [ErickWendel / semana-javascript-expert02](https://github.com/ErickWendel/semana-javascript-expert02)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **462** &nbsp;&nbsp; folks: **48**  &nbsp;&nbsp; `104 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **606** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `227 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,329** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `4,480 stars this week`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,579** &nbsp;&nbsp; folks: **6,762**  &nbsp;&nbsp; `2,105 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,859** &nbsp;&nbsp; folks: **999**  &nbsp;&nbsp; `402 stars this week`
...
1. [leon-thomm / Ryven](https://github.com/leon-thomm/Ryven)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,465** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `1,013 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,593** &nbsp;&nbsp; folks: **1,309**  &nbsp;&nbsp; `1,464 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,292** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `610 stars this week`
...
1. [Hunlongyu / ZY-Player](https://github.com/Hunlongyu/ZY-Player)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **7,747** &nbsp;&nbsp; folks: **1,255**  &nbsp;&nbsp; `437 stars this week`

1. [coolsnowwolf / lede](https://github.com/coolsnowwolf/lede)
    - Lean's OpenWrt source
    - language: **C** &nbsp;&nbsp; stars: **14,581** &nbsp;&nbsp; folks: **12,803**  &nbsp;&nbsp; `279 stars this week`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,299** &nbsp;&nbsp; folks: **2,195**  &nbsp;&nbsp; `695 stars this week`
...
1. [BrasilAPI / BrasilAPI](https://github.com/BrasilAPI/BrasilAPI)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,373** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `121 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,486** &nbsp;&nbsp; folks: **1,344**  &nbsp;&nbsp; `3,229 stars this month`
...
1. [cehui0303 / Tmall_Tickets](https://github.com/cehui0303/Tmall_Tickets)
    - 天猫超市茅台抢票功能
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,830** &nbsp;&nbsp; folks: **1,763**  &nbsp;&nbsp; `1,644 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,627** &nbsp;&nbsp; folks: **920**  &nbsp;&nbsp; `2,563 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,579** &nbsp;&nbsp; folks: **6,762**  &nbsp;&nbsp; `2,958 stars this month`
...
1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,400** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `728 stars this month`

1. [HarisIqbal88 / PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet)
    - Latex code for making neural networks diagrams
    - language: **TeX** &nbsp;&nbsp; stars: **11,935** &nbsp;&nbsp; folks: **1,664**  &nbsp;&nbsp; `2,127 stars this month`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,592** &nbsp;&nbsp; folks: **1,230**  &nbsp;&nbsp; `261 stars this month`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **48,385** &nbsp;&nbsp; folks: **27,285**  &nbsp;&nbsp; `1,273 stars this month`
