...
1. [authzed / spicedb](https://github.com/authzed/spicedb)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **728** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `236 stars today`
...
1. [twowaits / make-pull-request](https://github.com/twowaits/make-pull-request)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **388** &nbsp;&nbsp; folks: **1,168**  &nbsp;&nbsp; `147 stars today`

1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    - 🛁 Clean Code concepts adapted for JavaScript
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,477** &nbsp;&nbsp; folks: **7,295**  &nbsp;&nbsp; `162 stars today`

1. [ripienaar / free-for-dev](https://github.com/ripienaar/free-for-dev)
    - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
    - language: **HTML** &nbsp;&nbsp; stars: **49,328** &nbsp;&nbsp; folks: **5,331**  &nbsp;&nbsp; `162 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **121,037** &nbsp;&nbsp; folks: **19,882**  &nbsp;&nbsp; `248 stars today`
...
1. [vinitshahdeo / Hacktoberfest2021](https://github.com/vinitshahdeo/Hacktoberfest2021)
    ...
    - language: **无** &nbsp;&nbsp; stars: **489** &nbsp;&nbsp; folks: **421**  &nbsp;&nbsp; `40 stars today`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **15,742** &nbsp;&nbsp; folks: **1,610**  &nbsp;&nbsp; `15 stars today`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,514** &nbsp;&nbsp; folks: **8,253**  &nbsp;&nbsp; `100 stars today`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **5,389** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `329 stars today`

1. [Ganapati / RsaCtfTool](https://github.com/Ganapati/RsaCtfTool)
    - RSA attack tool (mainly for ctf) - retreive private key from weak public key and/or uncipher data
    - language: **Python** &nbsp;&nbsp; stars: **2,825** &nbsp;&nbsp; folks: **584**  &nbsp;&nbsp; `5 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,597** &nbsp;&nbsp; folks: **2,460**  &nbsp;&nbsp; `125 stars today`
...
1. [Tencent / secguide](https://github.com/Tencent/secguide)
    - 面向开发人员梳理的代码安全指南
    - language: **无** &nbsp;&nbsp; stars: **8,499** &nbsp;&nbsp; folks: **1,098**  &nbsp;&nbsp; `662 stars this week`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **500** &nbsp;&nbsp; folks: **175**  &nbsp;&nbsp; `223 stars this week`

1. [containers / youki](https://github.com/containers/youki)
    - A container runtime written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **2,150** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `700 stars this week`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,053** &nbsp;&nbsp; folks: **940**  &nbsp;&nbsp; `439 stars this week`

1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    - Build completely custom admin panels and internal tools. Use 30+ react components to build pages without HTML/CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,055** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `457 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **170,716** &nbsp;&nbsp; folks: **21,740**  &nbsp;&nbsp; `909 stars this week`

1. [7eu7d7 / genshin_auto_fish](https://github.com/7eu7d7/genshin_auto_fish)
    - 基于深度强化学习的原神自动钓鱼AI
    - language: **Python** &nbsp;&nbsp; stars: **1,779** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `418 stars this week`
...
1. [waydroid / waydroid](https://github.com/waydroid/waydroid)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,182** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `819 stars this week`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **15,725** &nbsp;&nbsp; folks: **1,656**  &nbsp;&nbsp; `107 stars this week`
...
1. [unknwon / the-way-to-go_ZH_CN](https://github.com/unknwon/the-way-to-go_ZH_CN)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,423** &nbsp;&nbsp; folks: **7,455**  &nbsp;&nbsp; `392 stars this week`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,709** &nbsp;&nbsp; folks: **2,163**  &nbsp;&nbsp; `8,717 stars this month`

1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    - Real-ESRGAN aims at developing Practical Algorithms for General Image Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **3,238** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `2,146 stars this month`
...
1. [robertdavidgraham / masscan](https://github.com/robertdavidgraham/masscan)
    - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
    - language: **C** &nbsp;&nbsp; stars: **17,501** &nbsp;&nbsp; folks: **2,565**  &nbsp;&nbsp; `1,718 stars this month`
...
1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    - Guide on Domain-Driven Design, Hexagonal architecture, best practices etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,646** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `1,064 stars this month`

1. [shengcaishizhan / kkndme_tianya](https://github.com/shengcaishizhan/kkndme_tianya)
    - 天涯 kkndme 神贴聊房价
    - language: **无** &nbsp;&nbsp; stars: **3,804** &nbsp;&nbsp; folks: **770**  &nbsp;&nbsp; `1,651 stars this month`
...
1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    - 📚 Learn to write an embedded OS in Rust 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **6,501** &nbsp;&nbsp; folks: **372**  &nbsp;&nbsp; `1,438 stars this month`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,212** &nbsp;&nbsp; folks: **358**  &nbsp;&nbsp; `754 stars this month`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **9,185** &nbsp;&nbsp; folks: **2,026**  &nbsp;&nbsp; `1,022 stars this month`

1. [solana-labs / solana](https://github.com/solana-labs/solana)
    - Web-Scale Blockchain for fast, secure, scalable, decentralized apps and marketplaces.
    - language: **Rust** &nbsp;&nbsp; stars: **4,272** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `849 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,403** &nbsp;&nbsp; folks: **9,133**  &nbsp;&nbsp; `4,298 stars this month`

1. [0voice / Introduction-to-Golang](https://github.com/0voice/Introduction-to-Golang)
    - 【未来服务器端编程语言】最全空降golang资料补给包（满血战斗），包含文章，书籍，作者论文，理论分析，开源框架，云原生，大佬视频，大厂实战分享ppt
    - language: **无** &nbsp;&nbsp; stars: **3,300** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `1,641 stars this month`
...
1. [metaplex-foundation / metaplex](https://github.com/metaplex-foundation/metaplex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,269** &nbsp;&nbsp; folks: **2,309**  &nbsp;&nbsp; `782 stars this month`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,514** &nbsp;&nbsp; folks: **8,253**  &nbsp;&nbsp; `2,653 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,597** &nbsp;&nbsp; folks: **2,460**  &nbsp;&nbsp; `2,180 stars this month`

1. [containers / podman](https://github.com/containers/podman)
    - Podman: A tool for managing OCI containers and pods.
    - language: **Go** &nbsp;&nbsp; stars: **10,566** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `1,728 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,592** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `3,774 stars this month`
...
1. [PySimpleGUI / PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,397** &nbsp;&nbsp; folks: **1,235**  &nbsp;&nbsp; `1,366 stars this month`
