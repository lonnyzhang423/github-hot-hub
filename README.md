...
`更新时间：2021-04-30 16:13:04 +0800`

## 今日热门仓库

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,171** &nbsp;&nbsp; folks: **29,499**  &nbsp;&nbsp; `468 stars today`

1. [scala-open-letter / scala-open-letter.github.io](https://github.com/scala-open-letter/scala-open-letter.github.io)
    - 无
    - language: **Ruby** &nbsp;&nbsp; stars: **71** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `40 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,524** &nbsp;&nbsp; folks: **17,466**  &nbsp;&nbsp; `372 stars today`

1. [openssl / openssl](https://github.com/openssl/openssl)
    - TLS/SSL and crypto library
    - language: **C** &nbsp;&nbsp; stars: **15,536** &nbsp;&nbsp; folks: **6,838**  &nbsp;&nbsp; `145 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **3,405** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `307 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **22,846** &nbsp;&nbsp; folks: **3,162**  &nbsp;&nbsp; `211 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,834** &nbsp;&nbsp; folks: **114**  &nbsp;&nbsp; `1,390 stars this week`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,423** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `1,215 stars this week`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **13,358** &nbsp;&nbsp; folks: **694**  &nbsp;&nbsp; `1,767 stars this week`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,149** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `948 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,934** &nbsp;&nbsp; folks: **712**  &nbsp;&nbsp; `1,263 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **5,148** &nbsp;&nbsp; folks: **569**  &nbsp;&nbsp; `858 stars this week`

1. [zellij-org / zellij](https://github.com/zellij-org/zellij)
    - A terminal workspace with batteries included
    - language: **Rust** &nbsp;&nbsp; stars: **2,416** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `778 stars this week`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,171** &nbsp;&nbsp; folks: **29,499**  &nbsp;&nbsp; `2,719 stars this week`
...
1. [DidierRLopes / GamestonkTerminal](https://github.com/DidierRLopes/GamestonkTerminal)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,439** &nbsp;&nbsp; folks: **827**  &nbsp;&nbsp; `489 stars this week`
...
1. [CyberPunkMetalHead / Binance-News-Sentiment-Bot](https://github.com/CyberPunkMetalHead/Binance-News-Sentiment-Bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,076** &nbsp;&nbsp; folks: **167**  &nbsp;&nbsp; `218 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,723** &nbsp;&nbsp; folks: **8,059**  &nbsp;&nbsp; `1,247 stars this week`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **102,823** &nbsp;&nbsp; folks: **41,034**  &nbsp;&nbsp; `986 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **185,961** &nbsp;&nbsp; folks: **41,879**  &nbsp;&nbsp; `2,688 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **5,148** &nbsp;&nbsp; folks: **569**  &nbsp;&nbsp; `4,273 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,423** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `1,334 stars this month`

1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    - Productive & portable programming language for high-performance, sparse & differentiable computing on CPUs & GPUs
    - language: **C++** &nbsp;&nbsp; stars: **14,379** &nbsp;&nbsp; folks: **1,496**  &nbsp;&nbsp; `1,412 stars this month`

1. [Kethku / neovide](https://github.com/Kethku/neovide)
    - No Nonsense Neovim Client in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,684** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `1,449 stars this month`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,039** &nbsp;&nbsp; folks: **2,419**  &nbsp;&nbsp; `1,304 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,672** &nbsp;&nbsp; folks: **249**  &nbsp;&nbsp; `3,194 stars this month`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **7,111** &nbsp;&nbsp; folks: **1,432**  &nbsp;&nbsp; `2,407 stars this month`
