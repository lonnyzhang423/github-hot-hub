...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,723** &nbsp;&nbsp; folks: **1,453**  &nbsp;&nbsp; `179 stars today`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,845** &nbsp;&nbsp; folks: **4,795**  &nbsp;&nbsp; `350 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,415** &nbsp;&nbsp; folks: **7,941**  &nbsp;&nbsp; `465 stars today`

1. [vitling / acid-banger](https://github.com/vitling/acid-banger)
    - The Endless Acid Banger
    - language: **TypeScript** &nbsp;&nbsp; stars: **682** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `156 stars today`
...
1. [CyberPunkMetalHead / Binance-News-Sentiment-Bot](https://github.com/CyberPunkMetalHead/Binance-News-Sentiment-Bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **818** &nbsp;&nbsp; folks: **112**  &nbsp;&nbsp; `149 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,059** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `169 stars today`
...
1. [NeuromatchAcademy / course-content-dl](https://github.com/NeuromatchAcademy/course-content-dl)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **83** &nbsp;&nbsp; folks: **7**  &nbsp;&nbsp; `9 stars today`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **无** &nbsp;&nbsp; stars: **109,820** &nbsp;&nbsp; folks: **36,781**  &nbsp;&nbsp; `299 stars today`

1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,627** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `152 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **118,720** &nbsp;&nbsp; folks: **16,945**  &nbsp;&nbsp; `179 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,799** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `1,870 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,204** &nbsp;&nbsp; folks: **408**  &nbsp;&nbsp; `2,427 stars this week`
...
1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,619** &nbsp;&nbsp; folks: **881**  &nbsp;&nbsp; `724 stars this week`

1. [openethereum / openethereum](https://github.com/openethereum/openethereum)
    - The fast, light, and robust client for the Ethereum mainnet.
    - language: **Rust** &nbsp;&nbsp; stars: **722** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `300 stars this week`
...
1. [microsoft / Swin-Transformer](https://github.com/microsoft/Swin-Transformer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,733** &nbsp;&nbsp; folks: **213**  &nbsp;&nbsp; `662 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,412** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `561 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,415** &nbsp;&nbsp; folks: **7,941**  &nbsp;&nbsp; `1,676 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **269** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `137 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,627** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `212 stars this week`
...
1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,073** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `575 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,600** &nbsp;&nbsp; folks: **524**  &nbsp;&nbsp; `1,112 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,845** &nbsp;&nbsp; folks: **4,795**  &nbsp;&nbsp; `493 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,204** &nbsp;&nbsp; folks: **408**  &nbsp;&nbsp; `3,454 stars this month`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,937** &nbsp;&nbsp; folks: **2,376**  &nbsp;&nbsp; `1,304 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,373** &nbsp;&nbsp; folks: **234**  &nbsp;&nbsp; `3,017 stars this month`

1. [Kethku / neovide](https://github.com/Kethku/neovide)
    - No Nonsense Neovim Client in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,432** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `1,235 stars this month`
...
1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,567** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `749 stars this month`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,736** &nbsp;&nbsp; folks: **965**  &nbsp;&nbsp; `1,219 stars this month`
...
1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **651** &nbsp;&nbsp; folks: **638**  &nbsp;&nbsp; `207 stars this month`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **103,848** &nbsp;&nbsp; folks: **17,253**  &nbsp;&nbsp; `4,598 stars this month`
