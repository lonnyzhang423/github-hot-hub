...
`更新时间：2021-04-25 12:17:50 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **496** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `210 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **119,174** &nbsp;&nbsp; folks: **16,961**  &nbsp;&nbsp; `197 stars today`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,785** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `312 stars today`

1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    - A list of awesome applications, software, tools and other materials for Linux distros.
    - language: **Python** &nbsp;&nbsp; stars: **15,381** &nbsp;&nbsp; folks: **1,580**  &nbsp;&nbsp; `181 stars today`
...
1. [gh0stkey / Binary-Learning](https://github.com/gh0stkey/Binary-Learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **265** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `50 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **82,020** &nbsp;&nbsp; folks: **11,678**  &nbsp;&nbsp; `396 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,833** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `318 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **179** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `119 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,577** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `2,201 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,910** &nbsp;&nbsp; folks: **1,408**  &nbsp;&nbsp; `1,236 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,757** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `857 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,217** &nbsp;&nbsp; folks: **244**  &nbsp;&nbsp; `2,101 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,141** &nbsp;&nbsp; folks: **601**  &nbsp;&nbsp; `1,687 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,022** &nbsp;&nbsp; folks: **7,967**  &nbsp;&nbsp; `2,253 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,382** &nbsp;&nbsp; folks: **45,708**  &nbsp;&nbsp; `2,531 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **310** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `183 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    ...
    - language: **C** &nbsp;&nbsp; stars: **53,321** &nbsp;&nbsp; folks: **4,809**  &nbsp;&nbsp; `1,095 stars this week`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,225** &nbsp;&nbsp; folks: **647**  &nbsp;&nbsp; `712 stars this week`
...
1. [pulumi / pulumi](https://github.com/pulumi/pulumi)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,351** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `182 stars this week`

1. [jarun / nnn](https://github.com/jarun/nnn)
    - n³ The unorthodox terminal file manager
    - language: **C** &nbsp;&nbsp; stars: **11,213** &nbsp;&nbsp; folks: **442**  &nbsp;&nbsp; `340 stars this week`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,529** &nbsp;&nbsp; folks: **15,513**  &nbsp;&nbsp; `777 stars this week`

1. [UKPLab / sentence-transformers](https://github.com/UKPLab/sentence-transformers)
    - Sentence Embeddings with BERT & XLNet
    - language: **Python** &nbsp;&nbsp; stars: **4,836** &nbsp;&nbsp; folks: **912**  &nbsp;&nbsp; `113 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,807** &nbsp;&nbsp; folks: **7,395**  &nbsp;&nbsp; `187 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,767** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `407 stars this week`

1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    - 「企业级低代码平台」前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis-plus，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新的开发模式OnlineCoding->代码生成->手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高效率，帮助公司节省成本，同时又不失灵活性。
    - language: **Java** &nbsp;&nbsp; stars: **22,110** &nbsp;&nbsp; folks: **8,540**  &nbsp;&nbsp; `373 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,577** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `3,788 stars this month`
...
1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,268** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `2,632 stars this month`
...
1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,294** &nbsp;&nbsp; folks: **483**  &nbsp;&nbsp; `1,405 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,022** &nbsp;&nbsp; folks: **7,967**  &nbsp;&nbsp; `3,445 stars this month`
...
1. [zhangdaiscott / JimuReport](https://github.com/zhangdaiscott/JimuReport)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,271** &nbsp;&nbsp; folks: **507**  &nbsp;&nbsp; `654 stars this month`
...
1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **663** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `210 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,561** &nbsp;&nbsp; folks: **1,012**  &nbsp;&nbsp; `2,737 stars this month`
