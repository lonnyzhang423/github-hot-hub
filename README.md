...
`更新时间：2021-01-31 05:07:17 +0800`

## 今日热门仓库

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,781** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `163 stars today`

1. [evilsocket / ditto](https://github.com/evilsocket/ditto)
    - A tool for IDN homograph attacks and detection.
    - language: **Go** &nbsp;&nbsp; stars: **213** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `89 stars today`

1. [bullhe4d / bigwatermelon](https://github.com/bullhe4d/bigwatermelon)
    - 合成大西瓜源码,修改版
    - language: **JavaScript** &nbsp;&nbsp; stars: **359** &nbsp;&nbsp; folks: **227**  &nbsp;&nbsp; `171 stars today`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,243** &nbsp;&nbsp; folks: **2,190**  &nbsp;&nbsp; `312 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,315** &nbsp;&nbsp; folks: **1,173**  &nbsp;&nbsp; `442 stars today`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,645** &nbsp;&nbsp; folks: **483**  &nbsp;&nbsp; `14 stars today`
...
1. [yeungon / In-JavaScript-we-trust](https://github.com/yeungon/In-JavaScript-we-trust)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **294** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `17 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,551** &nbsp;&nbsp; folks: **21,002**  &nbsp;&nbsp; `27 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,265** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `209 stars today`
...
1. [ErickWendel / semana-javascript-expert02](https://github.com/ErickWendel/semana-javascript-expert02)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **446** &nbsp;&nbsp; folks: **46**  &nbsp;&nbsp; `62 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **542** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `66 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,293** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `4,392 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,781** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `262 stars this week`
...
1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,398** &nbsp;&nbsp; folks: **973**  &nbsp;&nbsp; `813 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,585** &nbsp;&nbsp; folks: **1,306**  &nbsp;&nbsp; `1,441 stars this week`

1. [hathach / tinyusb](https://github.com/hathach/tinyusb)
    - An open source cross-platform USB stack for embedded system
    - language: **C** &nbsp;&nbsp; stars: **1,415** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `572 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,265** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `496 stars this week`
...
1. [rqlite / rqlite](https://github.com/rqlite/rqlite)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,479** &nbsp;&nbsp; folks: **386**  &nbsp;&nbsp; `690 stars this week`
...
1. [qutebrowser / qutebrowser](https://github.com/qutebrowser/qutebrowser)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,381** &nbsp;&nbsp; folks: **822**  &nbsp;&nbsp; `233 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,483** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `3,218 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,609** &nbsp;&nbsp; folks: **920**  &nbsp;&nbsp; `2,500 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,593** &nbsp;&nbsp; folks: **3,913**  &nbsp;&nbsp; `1,104 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    - Next generation Brave browser for Android, Linux, macOS, Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,305** &nbsp;&nbsp; folks: **848**  &nbsp;&nbsp; `474 stars this month`
