...
1. [ruffle-rs / ruffle](https://github.com/ruffle-rs/ruffle)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,980** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `111 stars today`
...
1. [archivy / archivy](https://github.com/archivy/archivy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,724** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `86 stars today`

1. [TheAlgorithms / C](https://github.com/TheAlgorithms/C)
    - Collection of various algorithms in mathematics, machine learning, computer science, physics, etc implemented in C for educational purposes.
    - language: **C** &nbsp;&nbsp; stars: **6,997** &nbsp;&nbsp; folks: **2,250**  &nbsp;&nbsp; `232 stars today`
...
1. [itdevbooks / pdf](https://github.com/itdevbooks/pdf)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,875** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `361 stars today`
...
1. [haizlin / fe-interview](https://github.com/haizlin/fe-interview)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,331** &nbsp;&nbsp; folks: **2,180**  &nbsp;&nbsp; `93 stars today`

1. [tgbot-collection / YYeTsBot](https://github.com/tgbot-collection/YYeTsBot)
    - 🎬 人人影视bot，完全对接人人影视全部无删减资源
    - language: **Python** &nbsp;&nbsp; stars: **495** &nbsp;&nbsp; folks: **76**  &nbsp;&nbsp; `91 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,400** &nbsp;&nbsp; folks: **28,354**  &nbsp;&nbsp; `305 stars today`

1. [Homebrew / brew](https://github.com/Homebrew/brew)
    - 🍺 The missing package manager for macOS (or Linux)
    - language: **Ruby** &nbsp;&nbsp; stars: **26,191** &nbsp;&nbsp; folks: **5,865**  &nbsp;&nbsp; `91 stars today`

1. [rust-lang / rust](https://github.com/rust-lang/rust)
    - Empowering everyone to build reliable and efficient software.
    - language: **Rust** &nbsp;&nbsp; stars: **51,840** &nbsp;&nbsp; folks: **7,549**  &nbsp;&nbsp; `48 stars today`

1. [cosmos / cosmos-sdk](https://github.com/cosmos/cosmos-sdk)
    - ⛓️ A Framework for Building High Value Public Blockchains ✨
    - language: **Go** &nbsp;&nbsp; stars: **2,086** &nbsp;&nbsp; folks: **983**  &nbsp;&nbsp; `6 stars today`

1. [wesbos / Advanced-React](https://github.com/wesbos/Advanced-React)
    - Starter Files and Solutions for Full Stack Advanced React and GraphQL
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,877** &nbsp;&nbsp; folks: **1,756**  &nbsp;&nbsp; `104 stars today`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,386** &nbsp;&nbsp; folks: **659**  &nbsp;&nbsp; `380 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **3,555** &nbsp;&nbsp; folks: **1,043**  &nbsp;&nbsp; `833 stars this week`

1. [bullhe4d / bigwatermelon](https://github.com/bullhe4d/bigwatermelon)
    - 合成大西瓜源码,修改版
    - language: **JavaScript** &nbsp;&nbsp; stars: **648** &nbsp;&nbsp; folks: **440**  &nbsp;&nbsp; `316 stars this week`

1. [RustPython / RustPython](https://github.com/RustPython/RustPython)
    - A Python Interpreter written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **7,145** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `731 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **11,048** &nbsp;&nbsp; folks: **3,370**  &nbsp;&nbsp; `1,171 stars this week`

1. [berty / berty](https://github.com/berty/berty)
    - Berty is a secure peer-to-peer messaging app that works with or without internet access, cellular data or trust in the network
    - language: **Go** &nbsp;&nbsp; stars: **3,785** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `1,181 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,400** &nbsp;&nbsp; folks: **28,354**  &nbsp;&nbsp; `1,713 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,499** &nbsp;&nbsp; folks: **16,001**  &nbsp;&nbsp; `1,426 stars this week`
...
1. [microsoft / terminal](https://github.com/microsoft/terminal)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **71,682** &nbsp;&nbsp; folks: **6,481**  &nbsp;&nbsp; `290 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **20,456** &nbsp;&nbsp; folks: **7,181**  &nbsp;&nbsp; `340 stars this week`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,860** &nbsp;&nbsp; folks: **2,256**  &nbsp;&nbsp; `707 stars this week`
...
1. [Light-City / CPlusPlusThings](https://github.com/Light-City/CPlusPlusThings)
    - C++那些事
    - language: **C++** &nbsp;&nbsp; stars: **9,640** &nbsp;&nbsp; folks: **2,284**  &nbsp;&nbsp; `313 stars this week`
...
1. [shidenggui / easytrader](https://github.com/shidenggui/easytrader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,187** &nbsp;&nbsp; folks: **1,987**  &nbsp;&nbsp; `375 stars this week`
...
1. [aamini / introtodeeplearning](https://github.com/aamini/introtodeeplearning)
    - Lab Materials for MIT 6.S191: Introduction to Deep Learning
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,161** &nbsp;&nbsp; folks: **1,681**  &nbsp;&nbsp; `83 stars this week`

1. [explosion / spaCy](https://github.com/explosion/spaCy)
    - 💫 Industrial-strength Natural Language Processing (NLP) in Python
    - language: **Python** &nbsp;&nbsp; stars: **19,416** &nbsp;&nbsp; folks: **3,276**  &nbsp;&nbsp; `1,312 stars this week`

1. [chartjs / Chart.js](https://github.com/chartjs/Chart.js)
    - Simple HTML5 Charts using the <canvas> tag
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,024** &nbsp;&nbsp; folks: **10,774**  &nbsp;&nbsp; `143 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,612** &nbsp;&nbsp; folks: **1,366**  &nbsp;&nbsp; `3,338 stars this month`

1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    - A private messenger for Android.
    - language: **Java** &nbsp;&nbsp; stars: **19,682** &nbsp;&nbsp; folks: **4,638**  &nbsp;&nbsp; `5,513 stars this month`
...
1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,234** &nbsp;&nbsp; folks: **1,808**  &nbsp;&nbsp; `3,740 stars this month`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,386** &nbsp;&nbsp; folks: **659**  &nbsp;&nbsp; `584 stars this month`
...
1. [openai / CLIP](https://github.com/openai/CLIP)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,807** &nbsp;&nbsp; folks: **166**  &nbsp;&nbsp; `1,509 stars this month`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **C++** &nbsp;&nbsp; stars: **16,194** &nbsp;&nbsp; folks: **5,774**  &nbsp;&nbsp; `820 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,410** &nbsp;&nbsp; folks: **964**  &nbsp;&nbsp; `2,881 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,843** &nbsp;&nbsp; folks: **13,443**  &nbsp;&nbsp; `1,078 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,733** &nbsp;&nbsp; folks: **2,049**  &nbsp;&nbsp; `2,557 stars this month`
...
1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,421** &nbsp;&nbsp; folks: **9,334**  &nbsp;&nbsp; `466 stars this month`

1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    - 大数据面试题，大数据成神之路开启...Flink/Spark/Hadoop/Hbase/Hive...
    - language: **无** &nbsp;&nbsp; stars: **3,813** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `503 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,641** &nbsp;&nbsp; folks: **3,920**  &nbsp;&nbsp; `1,086 stars this month`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,860** &nbsp;&nbsp; folks: **2,256**  &nbsp;&nbsp; `1,492 stars this month`
