...
1. [apache / incubator-seatunnel](https://github.com/apache/incubator-seatunnel)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,610** &nbsp;&nbsp; folks: **233**  &nbsp;&nbsp; `719 stars this week`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,839** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `980 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **4,469** &nbsp;&nbsp; folks: **792**  &nbsp;&nbsp; `228 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **183,673** &nbsp;&nbsp; folks: **22,535**  &nbsp;&nbsp; `1,610 stars this week`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **51,730** &nbsp;&nbsp; folks: **4,360**  &nbsp;&nbsp; `594 stars this week`

1. [fanux / sealos](https://github.com/fanux/sealos)
    - 一条命令离线安装高可用 Kubernetes，3min 装完，500M，100年证书，版本不要太全，生产环境稳如老狗🔥 ⎈ 🐳
    - language: **Go** &nbsp;&nbsp; stars: **7,517** &nbsp;&nbsp; folks: **1,219**  &nbsp;&nbsp; `643 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,193** &nbsp;&nbsp; folks: **4,421**  &nbsp;&nbsp; `508 stars this week`
...
1. [notthebee / infra](https://github.com/notthebee/infra)
    ...
    - language: **Jinja** &nbsp;&nbsp; stars: **378** &nbsp;&nbsp; folks: **53**  &nbsp;&nbsp; `109 stars this week`

1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    - Magnificent app which corrects your previous console command.
    - language: **Python** &nbsp;&nbsp; stars: **65,876** &nbsp;&nbsp; folks: **3,037**  &nbsp;&nbsp; `355 stars this week`
...
1. [danielyxie / bitburner](https://github.com/danielyxie/bitburner)
    - Bitburner Game
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,131** &nbsp;&nbsp; folks: **323**  &nbsp;&nbsp; `323 stars this week`

1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,278** &nbsp;&nbsp; folks: **3,046**  &nbsp;&nbsp; `163 stars this week`

1. [nlohmann / json](https://github.com/nlohmann/json)
    - JSON for Modern C++
    - language: **C++** &nbsp;&nbsp; stars: **28,181** &nbsp;&nbsp; folks: **4,795**  &nbsp;&nbsp; `229 stars this week`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **133,985** &nbsp;&nbsp; folks: **20,107**  &nbsp;&nbsp; `335 stars this week`

1. [logseq / logseq](https://github.com/logseq/logseq)
    - A privacy-first, open-source platform for knowledge management and collaboration. Desktop app download link: https://github.com/logseq/logseq/releases, roadmap: https://trello.com/b/8txSM12G/roadmap
    - language: **Clojure** &nbsp;&nbsp; stars: **8,780** &nbsp;&nbsp; folks: **528**  &nbsp;&nbsp; `272 stars this week`
...
1. [carlospolop / PEASS-ng](https://github.com/carlospolop/PEASS-ng)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,337** &nbsp;&nbsp; folks: **1,838**  &nbsp;&nbsp; `83 stars this week`

1. [betaflight / betaflight](https://github.com/betaflight/betaflight)
    - Open Source Flight Controller Firmware
    - language: **C** &nbsp;&nbsp; stars: **5,341** &nbsp;&nbsp; folks: **2,161**  &nbsp;&nbsp; `321 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,167** &nbsp;&nbsp; folks: **2,365**  &nbsp;&nbsp; `11,794 stars this month`

1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    - A terminal for a more modern age
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,963** &nbsp;&nbsp; folks: **1,613**  &nbsp;&nbsp; `7,037 stars this month`

1. [ja-netfilter / ja-netfilter](https://github.com/ja-netfilter/ja-netfilter)
    - A javaagent framework
    - language: **Java** &nbsp;&nbsp; stars: **2,902** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `2,130 stars this month`

1. [ssssssss-team / spider-flow](https://github.com/ssssssss-team/spider-flow)
    - 新一代爬虫平台，以图形化方式定义爬虫流程，不写代码即可完成爬虫。
    - language: **Java** &nbsp;&nbsp; stars: **5,273** &nbsp;&nbsp; folks: **918**  &nbsp;&nbsp; `2,904 stars this month`

1. [anchore / syft](https://github.com/anchore/syft)
    - CLI tool and library for generating a Software Bill of Materials from container images and filesystems
    - language: **Go** &nbsp;&nbsp; stars: **1,640** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `1,044 stars this month`

1. [mpcabete / bombcrypto-bot](https://github.com/mpcabete/bombcrypto-bot)
    - This is a python bot that automatically logs in, clicks the new button, and sends heroes to work in the bombcrypto game. It is fully open source and free.
    - language: **Python** &nbsp;&nbsp; stars: **694** &nbsp;&nbsp; folks: **416**  &nbsp;&nbsp; `438 stars this month`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,391** &nbsp;&nbsp; folks: **1,886**  &nbsp;&nbsp; `4,373 stars this month`

1. [jynew / jynew](https://github.com/jynew/jynew)
    - 金庸群侠传3D重制版
    - language: **C#** &nbsp;&nbsp; stars: **3,963** &nbsp;&nbsp; folks: **832**  &nbsp;&nbsp; `1,520 stars this month`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **11,484** &nbsp;&nbsp; folks: **2,550**  &nbsp;&nbsp; `1,259 stars this month`

1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    - 清华大学计算机系课程攻略 Guidance for courses in Department of Computer Science and Technology, Tsinghua University
    - language: **HTML** &nbsp;&nbsp; stars: **21,222** &nbsp;&nbsp; folks: **5,774**  &nbsp;&nbsp; `1,830 stars this month`
...
1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,278** &nbsp;&nbsp; folks: **3,046**  &nbsp;&nbsp; `479 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,600** &nbsp;&nbsp; folks: **2,263**  &nbsp;&nbsp; `4,539 stars this month`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,630** &nbsp;&nbsp; folks: **1,896**  &nbsp;&nbsp; `1,779 stars this month`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **15,786** &nbsp;&nbsp; folks: **1,088**  &nbsp;&nbsp; `3,695 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Roadmap to becoming a developer in 2022
    - language: **TypeScript** &nbsp;&nbsp; stars: **182,643** &nbsp;&nbsp; folks: **26,244**  &nbsp;&nbsp; `4,348 stars this month`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **133,985** &nbsp;&nbsp; folks: **20,107**  &nbsp;&nbsp; `1,488 stars this month`

1. [justjavac / free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN)
    - 📚 免费的计算机编程类中文书籍，欢迎投稿
    - language: **无** &nbsp;&nbsp; stars: **86,261** &nbsp;&nbsp; folks: **24,752**  &nbsp;&nbsp; `1,704 stars this month`

1. [thunlp / WantWords](https://github.com/thunlp/WantWords)
    - An open-source online reverse dictionary.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,985** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `1,954 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **157,555** &nbsp;&nbsp; folks: **29,072**  &nbsp;&nbsp; `5,021 stars this month`

1. [lucidrains / vit-pytorch](https://github.com/lucidrains/vit-pytorch)
    - Implementation of Vision Transformer, a simple way to achieve SOTA in vision classification with only a single transformer encoder, in Pytorch
    - language: **Python** &nbsp;&nbsp; stars: **8,008** &nbsp;&nbsp; folks: **1,233**  &nbsp;&nbsp; `1,116 stars this month`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Java** &nbsp;&nbsp; stars: **5,453** &nbsp;&nbsp; folks: **1,385**  &nbsp;&nbsp; `533 stars this month`

1. [tailwindlabs / tailwindcss](https://github.com/tailwindlabs/tailwindcss)
    - A utility-first CSS framework for rapid UI development.
    - language: **JavaScript** &nbsp;&nbsp; stars: **51,878** &nbsp;&nbsp; folks: **2,484**  &nbsp;&nbsp; `2,339 stars this month`

1. [qier222 / YesPlayMusic](https://github.com/qier222/YesPlayMusic)
    - 高颜值的第三方网易云播放器，支持 Windows / macOS / Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,729** &nbsp;&nbsp; folks: **1,903**  &nbsp;&nbsp; `1,092 stars this month`
