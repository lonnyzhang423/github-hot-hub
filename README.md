...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,314** &nbsp;&nbsp; folks: **4,201**  &nbsp;&nbsp; `713 stars this week`

1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,567** &nbsp;&nbsp; folks: **1,457**  &nbsp;&nbsp; `193 stars this week`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **631** &nbsp;&nbsp; folks: **243**  &nbsp;&nbsp; `158 stars this week`

1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    - A Modern Real-Time Data Processing & Analytics DBMS with Cloud-Native Architecture, built to make the Data Cloud easy
    - language: **Rust** &nbsp;&nbsp; stars: **1,766** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `802 stars this week`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,198** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `406 stars this week`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **11,174** &nbsp;&nbsp; folks: **1,630**  &nbsp;&nbsp; `125 stars this week`

1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **14,645** &nbsp;&nbsp; folks: **1,860**  &nbsp;&nbsp; `115 stars this week`

1. [carla-simulator / carla](https://github.com/carla-simulator/carla)
    - Open-source simulator for autonomous driving research.
    - language: **C++** &nbsp;&nbsp; stars: **6,317** &nbsp;&nbsp; folks: **1,895**  &nbsp;&nbsp; `53 stars this week`

1. [sveltejs / kit](https://github.com/sveltejs/kit)
    - The fastest way to build Svelte apps
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,325** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `97 stars this week`

1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants
    - language: **Python** &nbsp;&nbsp; stars: **12,471** &nbsp;&nbsp; folks: **3,648**  &nbsp;&nbsp; `700 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,400** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `763 stars this week`
...
1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **611** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `153 stars this week`
...
1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,666** &nbsp;&nbsp; folks: **638**  &nbsp;&nbsp; `6,358 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,400** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `1,714 stars this month`

1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **9,460** &nbsp;&nbsp; folks: **755**  &nbsp;&nbsp; `2,156 stars this month`

1. [facebookresearch / ParlAI](https://github.com/facebookresearch/ParlAI)
    - A framework for training and evaluating AI models on a variety of openly available dialogue datasets.
    - language: **Python** &nbsp;&nbsp; stars: **8,161** &nbsp;&nbsp; folks: **1,622**  &nbsp;&nbsp; `878 stars this month`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **8,222** &nbsp;&nbsp; folks: **1,942**  &nbsp;&nbsp; `2,360 stars this month`
...
1. [shufflewzc / faker2](https://github.com/shufflewzc/faker2)
    - 不知名大佬备份
    - language: **JavaScript** &nbsp;&nbsp; stars: **838** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `736 stars this month`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **22,850** &nbsp;&nbsp; folks: **1,707**  &nbsp;&nbsp; `4,043 stars this month`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **8,670** &nbsp;&nbsp; folks: **1,250**  &nbsp;&nbsp; `2,546 stars this month`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,857** &nbsp;&nbsp; folks: **5,323**  &nbsp;&nbsp; `1,065 stars this month`

1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    - Open source distributed and RESTful search engine.
    - language: **Java** &nbsp;&nbsp; stars: **3,501** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `932 stars this month`
...
1. [yuzu-emu / yuzu](https://github.com/yuzu-emu/yuzu)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **15,888** &nbsp;&nbsp; folks: **1,348**  &nbsp;&nbsp; `892 stars this month`

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,850** &nbsp;&nbsp; folks: **787**  &nbsp;&nbsp; `2,381 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,389** &nbsp;&nbsp; folks: **14,195**  &nbsp;&nbsp; `589 stars this month`
...
1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,916** &nbsp;&nbsp; folks: **863**  &nbsp;&nbsp; `527 stars this month`

1. [quii / learn-go-with-tests](https://github.com/quii/learn-go-with-tests)
    - Learn Go with test-driven development
    - language: **Go** &nbsp;&nbsp; stars: **15,065** &nbsp;&nbsp; folks: **1,916**  &nbsp;&nbsp; `450 stars this month`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,015** &nbsp;&nbsp; folks: **4,507**  &nbsp;&nbsp; `3,332 stars this month`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **50,617** &nbsp;&nbsp; folks: **5,168**  &nbsp;&nbsp; `910 stars this month`
