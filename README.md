...
1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **699** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `227 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,386** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `4,479 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,989** &nbsp;&nbsp; folks: **1,009**  &nbsp;&nbsp; `417 stars this week`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,649** &nbsp;&nbsp; folks: **6,766**  &nbsp;&nbsp; `2,105 stars this week`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,475** &nbsp;&nbsp; folks: **1,989**  &nbsp;&nbsp; `1,966 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,614** &nbsp;&nbsp; folks: **1,312**  &nbsp;&nbsp; `1,467 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,329** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `620 stars this week`

1. [leon-thomm / Ryven](https://github.com/leon-thomm/Ryven)
    - Flow-based visual scripting for Python
    - language: **Python** &nbsp;&nbsp; stars: **1,508** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `1,011 stars this week`

1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    - Secure and fast microVMs for serverless computing.
    - language: **Rust** &nbsp;&nbsp; stars: **14,415** &nbsp;&nbsp; folks: **973**  &nbsp;&nbsp; `832 stars this week`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,437** &nbsp;&nbsp; folks: **2,213**  &nbsp;&nbsp; `687 stars this week`

1. [qutebrowser / qutebrowser](https://github.com/qutebrowser/qutebrowser)
    - A keyboard-driven, vim-like browser based on PyQt5.
    - language: **Python** &nbsp;&nbsp; stars: **6,384** &nbsp;&nbsp; folks: **823**  &nbsp;&nbsp; `230 stars this week`
...
1. [BrasilAPI / BrasilAPI](https://github.com/BrasilAPI/BrasilAPI)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,392** &nbsp;&nbsp; folks: **271**  &nbsp;&nbsp; `121 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **71,474** &nbsp;&nbsp; folks: **6,458**  &nbsp;&nbsp; `524 stars this week`

1. [coolsnowwolf / lede](https://github.com/coolsnowwolf/lede)
    - Lean's OpenWrt source
    - language: **C** &nbsp;&nbsp; stars: **14,596** &nbsp;&nbsp; folks: **12,817**  &nbsp;&nbsp; `284 stars this week`
...
1. [micropython / micropython](https://github.com/micropython/micropython)
    ...
    - language: **C** &nbsp;&nbsp; stars: **11,874** &nbsp;&nbsp; folks: **4,020**  &nbsp;&nbsp; `124 stars this week`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,424** &nbsp;&nbsp; folks: **1,184**  &nbsp;&nbsp; `981 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,529** &nbsp;&nbsp; folks: **4,600**  &nbsp;&nbsp; `5,380 stars this month`

1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    - Server supporting the Signal Private Messenger applications on Android, Desktop, and iOS
    - language: **Java** &nbsp;&nbsp; stars: **5,497** &nbsp;&nbsp; folks: **1,345**  &nbsp;&nbsp; `3,230 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,117** &nbsp;&nbsp; folks: **1,789**  &nbsp;&nbsp; `3,642 stars this month`

1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    - A private messenger for iOS.
    - language: **Swift** &nbsp;&nbsp; stars: **7,651** &nbsp;&nbsp; folks: **2,007**  &nbsp;&nbsp; `2,309 stars this month`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,649** &nbsp;&nbsp; folks: **6,766**  &nbsp;&nbsp; `2,966 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,660** &nbsp;&nbsp; folks: **925**  &nbsp;&nbsp; `2,575 stars this month`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,475** &nbsp;&nbsp; folks: **1,989**  &nbsp;&nbsp; `2,453 stars this month`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **10,467** &nbsp;&nbsp; folks: **538**  &nbsp;&nbsp; `2,556 stars this month`

1. [probml / pyprobml](https://github.com/probml/pyprobml)
    - Python code for "Machine learning: a probabilistic perspective" (2nd edition)
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,876** &nbsp;&nbsp; folks: **735**  &nbsp;&nbsp; `1,118 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,606** &nbsp;&nbsp; folks: **3,918**  &nbsp;&nbsp; `1,112 stars this month`
...
1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,627** &nbsp;&nbsp; folks: **4,766**  &nbsp;&nbsp; `402 stars this month`

1. [excalidraw / excalidraw](https://github.com/excalidraw/excalidraw)
    - Virtual whiteboard for sketching hand-drawn like diagrams
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,392** &nbsp;&nbsp; folks: **1,099**  &nbsp;&nbsp; `2,450 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **48,404** &nbsp;&nbsp; folks: **27,294**  &nbsp;&nbsp; `1,287 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,459** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `3,272 stars this month`

1. [brave / brave-browser](https://github.com/brave/brave-browser)
    - Next generation Brave browser for Android, Linux, macOS, Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,320** &nbsp;&nbsp; folks: **847**  &nbsp;&nbsp; `478 stars this month`
...
1. [HarisIqbal88 / PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet)
    ...
    - language: **TeX** &nbsp;&nbsp; stars: **11,940** &nbsp;&nbsp; folks: **1,664**  &nbsp;&nbsp; `2,141 stars this month`

1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    - Secure and fast microVMs for serverless computing.
    - language: **Rust** &nbsp;&nbsp; stars: **14,415** &nbsp;&nbsp; folks: **973**  &nbsp;&nbsp; `994 stars this month`
