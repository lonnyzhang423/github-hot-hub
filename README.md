...
1. [metersphere / metersphere](https://github.com/metersphere/metersphere)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,222** &nbsp;&nbsp; folks: **1,198**  &nbsp;&nbsp; `171 stars this week`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **618** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `157 stars this week`

1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    - A Modern Real-Time Data Processing & Analytics DBMS with Cloud-Native Architecture, built to make the Data Cloud easy
    - language: **Rust** &nbsp;&nbsp; stars: **1,754** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `795 stars this week`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,189** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `445 stars this week`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **11,169** &nbsp;&nbsp; folks: **1,626**  &nbsp;&nbsp; `254 stars this week`
...
1. [sveltejs / kit](https://github.com/sveltejs/kit)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,317** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `99 stars this week`

1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants
    - language: **Python** &nbsp;&nbsp; stars: **12,463** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `697 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,377** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `803 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,050** &nbsp;&nbsp; folks: **2,889**  &nbsp;&nbsp; `346 stars this week`

1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    - A modular embodied agent architecture and platform for building embodied agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **601** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `196 stars this week`
...
1. [dromara / Sa-Token](https://github.com/dromara/Sa-Token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,386** &nbsp;&nbsp; folks: **975**  &nbsp;&nbsp; `1,739 stars this month`

1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    - 12 Weeks, 24 Lessons, IoT for All!
    - language: **C++** &nbsp;&nbsp; stars: **6,590** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `6,447 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,377** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `1,695 stars this month`
...
1. [facebookresearch / ParlAI](https://github.com/facebookresearch/ParlAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,151** &nbsp;&nbsp; folks: **1,618**  &nbsp;&nbsp; `873 stars this month`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **8,187** &nbsp;&nbsp; folks: **1,932**  &nbsp;&nbsp; `2,345 stars this month`

1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - language: **Python** &nbsp;&nbsp; stars: **24,149** &nbsp;&nbsp; folks: **2,997**  &nbsp;&nbsp; `1,390 stars this month`

1. [shufflewzc / faker2](https://github.com/shufflewzc/faker2)
    - 不知名大佬备份
    - language: **JavaScript** &nbsp;&nbsp; stars: **824** &nbsp;&nbsp; folks: **397**  &nbsp;&nbsp; `749 stars this month`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **22,801** &nbsp;&nbsp; folks: **1,703**  &nbsp;&nbsp; `4,001 stars this month`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **8,664** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `2,609 stars this month`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,840** &nbsp;&nbsp; folks: **5,322**  &nbsp;&nbsp; `1,049 stars this month`

1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    - Open source distributed and RESTful search engine.
    - language: **Java** &nbsp;&nbsp; stars: **3,482** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `913 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,817** &nbsp;&nbsp; folks: **787**  &nbsp;&nbsp; `2,360 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,306** &nbsp;&nbsp; folks: **14,164**  &nbsp;&nbsp; `508 stars this month`

1. [avelino / awesome-go](https://github.com/avelino/awesome-go)
    - A curated list of awesome Go frameworks, libraries and software
    - language: **Go** &nbsp;&nbsp; stars: **67,068** &nbsp;&nbsp; folks: **8,764**  &nbsp;&nbsp; `1,509 stars this month`

1. [elastic / elasticsearch-py](https://github.com/elastic/elasticsearch-py)
    - Official Elasticsearch client library for Python
    - language: **Python** &nbsp;&nbsp; stars: **3,335** &nbsp;&nbsp; folks: **1,025**  &nbsp;&nbsp; `89 stars this month`

1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    - Powerful yet simple to use screenshot software 🖥️ 📸
    - language: **C++** &nbsp;&nbsp; stars: **13,909** &nbsp;&nbsp; folks: **863**  &nbsp;&nbsp; `522 stars this month`

1. [quii / learn-go-with-tests](https://github.com/quii/learn-go-with-tests)
    - Learn Go with test-driven development
    - language: **Go** &nbsp;&nbsp; stars: **15,055** &nbsp;&nbsp; folks: **1,914**  &nbsp;&nbsp; `443 stars this month`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,002** &nbsp;&nbsp; folks: **4,504**  &nbsp;&nbsp; `3,349 stars this month`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **50,607** &nbsp;&nbsp; folks: **5,166**  &nbsp;&nbsp; `907 stars this month`
