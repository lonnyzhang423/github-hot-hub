...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    ...
    - language: **无** &nbsp;&nbsp; stars: **182,476** &nbsp;&nbsp; folks: **22,452**  &nbsp;&nbsp; `292 stars today`
...
1. [DataTalksClub / data-engineering-zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
    ...
    - language: **无** &nbsp;&nbsp; stars: **604** &nbsp;&nbsp; folks: **93**  &nbsp;&nbsp; `54 stars today`
...
1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **51,349** &nbsp;&nbsp; folks: **4,340**  &nbsp;&nbsp; `209 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **156,804** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `323 stars today`
...
1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,171** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `49 stars today`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **5,356** &nbsp;&nbsp; folks: **1,491**  &nbsp;&nbsp; `35 stars today`
...
1. [gatsbyjs / gatsby](https://github.com/gatsbyjs/gatsby)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,033** &nbsp;&nbsp; folks: **10,070**  &nbsp;&nbsp; `47 stars today`

1. [google / gvisor](https://github.com/google/gvisor)
    - Application Kernel for Containers
    - language: **Go** &nbsp;&nbsp; stars: **12,195** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `94 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native applications using React
    - language: **JavaScript** &nbsp;&nbsp; stars: **100,193** &nbsp;&nbsp; folks: **21,590**  &nbsp;&nbsp; `61 stars today`

1. [hibiken / asynq](https://github.com/hibiken/asynq)
    - Asynq: simple, reliable, and efficient distributed task queue in Go
    - language: **Go** &nbsp;&nbsp; stars: **2,177** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `122 stars today`

1. [alibaba / formily](https://github.com/alibaba/formily)
    - Alibaba Group Unified Form Solution -- Support React/ReactNative/Vue2/Vue3
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,841** &nbsp;&nbsp; folks: **878**  &nbsp;&nbsp; `90 stars today`
...
1. [cisagov / log4j-scanner](https://github.com/cisagov/log4j-scanner)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **965** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `461 stars this week`
...
1. [EmbarkStudios / kajiya](https://github.com/EmbarkStudios/kajiya)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,819** &nbsp;&nbsp; folks: **36**  &nbsp;&nbsp; `630 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,804** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `1,890 stars this week`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,138** &nbsp;&nbsp; folks: **2,151**  &nbsp;&nbsp; `1,992 stars this week`

1. [codenotary / immudb](https://github.com/codenotary/immudb)
    - immudb - world’s fastest immutable database, built on a zero trust model
    - language: **Go** &nbsp;&nbsp; stars: **6,428** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `1,176 stars this week`
...
1. [openai / glide-text2im](https://github.com/openai/glide-text2im)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,240** &nbsp;&nbsp; folks: **107**  &nbsp;&nbsp; `478 stars this week`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **11,326** &nbsp;&nbsp; folks: **2,520**  &nbsp;&nbsp; `390 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **90,508** &nbsp;&nbsp; folks: **9,566**  &nbsp;&nbsp; `1,187 stars this week`
...
1. [mpcabete / bombcrypto-bot](https://github.com/mpcabete/bombcrypto-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **617** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `158 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **131,213** &nbsp;&nbsp; folks: **21,503**  &nbsp;&nbsp; `1,617 stars this week`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,485** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `1,731 stars this week`

1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,171** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `258 stars this week`

1. [wader / fq](https://github.com/wader/fq)
    - jq for binary formats
    - language: **Go** &nbsp;&nbsp; stars: **3,000** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `789 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,156** &nbsp;&nbsp; folks: **2,223**  &nbsp;&nbsp; `11,434 stars this month`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,415** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `7,404 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **181,993** &nbsp;&nbsp; folks: **26,151**  &nbsp;&nbsp; `5,004 stars this month`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,485** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `4,724 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,804** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `5,336 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **133,777** &nbsp;&nbsp; folks: **20,009**  &nbsp;&nbsp; `1,417 stars this month`
...
1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,171** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `376 stars this month`
