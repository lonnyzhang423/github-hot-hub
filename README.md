...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **785** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `221 stars today`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **62,558** &nbsp;&nbsp; folks: **6,118**  &nbsp;&nbsp; `139 stars today`

1. [ansible / ansible](https://github.com/ansible/ansible)
    - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
    - language: **Python** &nbsp;&nbsp; stars: **47,502** &nbsp;&nbsp; folks: **20,444**  &nbsp;&nbsp; `72 stars today`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **47,147** &nbsp;&nbsp; folks: **12,583**  &nbsp;&nbsp; `103 stars today`
...
1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,786** &nbsp;&nbsp; folks: **172**  &nbsp;&nbsp; `2,103 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,270** &nbsp;&nbsp; folks: **16,905**  &nbsp;&nbsp; `2,633 stars this week`

1. [Uniswap / uniswap-v3-core](https://github.com/Uniswap/uniswap-v3-core)
    - 🦄 🦄 🦄 Core smart contracts of Uniswap v3
    - language: **TypeScript** &nbsp;&nbsp; stars: **515** &nbsp;&nbsp; folks: **72**  &nbsp;&nbsp; `183 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,198** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `1,207 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,680** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `700 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,198** &nbsp;&nbsp; folks: **7,780**  &nbsp;&nbsp; `422 stars this week`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **9,892** &nbsp;&nbsp; folks: **874**  &nbsp;&nbsp; `296 stars this week`

1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,429** &nbsp;&nbsp; folks: **2,876**  &nbsp;&nbsp; `909 stars this week`
...
1. [alibaba / nacos](https://github.com/alibaba/nacos)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **16,977** &nbsp;&nbsp; folks: **6,607**  &nbsp;&nbsp; `169 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,837** &nbsp;&nbsp; folks: **1,111**  &nbsp;&nbsp; `5,533 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run Mac in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X!
    - language: **Shell** &nbsp;&nbsp; stars: **13,231** &nbsp;&nbsp; folks: **579**  &nbsp;&nbsp; `4,609 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **7,198** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `4,021 stars this month`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,470** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `3,787 stars this month`
...
1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,899** &nbsp;&nbsp; folks: **5,443**  &nbsp;&nbsp; `1,796 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **117,255** &nbsp;&nbsp; folks: **16,762**  &nbsp;&nbsp; `3,689 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,720** &nbsp;&nbsp; folks: **3,191**  &nbsp;&nbsp; `5,911 stars this month`
...
1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **101,027** &nbsp;&nbsp; folks: **34,791**  &nbsp;&nbsp; `3,034 stars this month`

1. [openjdk / jdk](https://github.com/openjdk/jdk)
    - JDK main-line development
    - language: **Java** &nbsp;&nbsp; stars: **8,767** &nbsp;&nbsp; folks: **2,099**  &nbsp;&nbsp; `883 stars this month`
...
1. [facebook / react](https://github.com/facebook/react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **166,287** &nbsp;&nbsp; folks: **33,383**  &nbsp;&nbsp; `2,158 stars this month`
...
1. [OpenZeppelin / openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,731** &nbsp;&nbsp; folks: **4,377**  &nbsp;&nbsp; `454 stars this month`

1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    - 📚 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计、Java、Python、C++
    - language: **Java** &nbsp;&nbsp; stars: **124,999** &nbsp;&nbsp; folks: **40,547**  &nbsp;&nbsp; `3,185 stars this month`
