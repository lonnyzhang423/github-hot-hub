...
1. [extreme-assistant / CVPR2021-Paper-Code-Interpretation](https://github.com/extreme-assistant/CVPR2021-Paper-Code-Interpretation)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,842** &nbsp;&nbsp; folks: **1,404**  &nbsp;&nbsp; `68 stars today`

1. [adobe / brackets](https://github.com/adobe/brackets)
    - An open source code editor for the web, written in JavaScript, HTML and CSS.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,871** &nbsp;&nbsp; folks: **6,880**  &nbsp;&nbsp; `100 stars today`

1. [influxdata / influxdb](https://github.com/influxdata/influxdb)
    - Scalable datastore for metrics, events, and real-time analytics
    - language: **Go** &nbsp;&nbsp; stars: **20,808** &nbsp;&nbsp; folks: **2,899**  &nbsp;&nbsp; `126 stars today`
...
1. [alievk / avatarify](https://github.com/alievk/avatarify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,262** &nbsp;&nbsp; folks: **1,699**  &nbsp;&nbsp; `2,267 stars this week`

1. [jart / cosmopolitan](https://github.com/jart/cosmopolitan)
    - fast portable static native textmode containers
    - language: **C** &nbsp;&nbsp; stars: **3,891** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `2,590 stars this week`

1. [coding-horror / basic-computer-games](https://github.com/coding-horror/basic-computer-games)
    - An updated version of the classic "Basic Computer Games" book, with well-written examples in a variety of common programming languages
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,360** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `1,161 stars this week`

1. [android / compose-samples](https://github.com/android/compose-samples)
    - Official Jetpack Compose samples.
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,945** &nbsp;&nbsp; folks: **972**  &nbsp;&nbsp; `766 stars this week`

1. [iperov / DeepFaceLab](https://github.com/iperov/DeepFaceLab)
    - DeepFaceLab is the leading software for creating deepfakes.
    - language: **Python** &nbsp;&nbsp; stars: **24,482** &nbsp;&nbsp; folks: **5,520**  &nbsp;&nbsp; `1,027 stars this week`

1. [AliaksandrSiarohin / first-order-model](https://github.com/AliaksandrSiarohin/first-order-model)
    - This repository contains the source code for the paper First Order Motion Model for Image Animation
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,121** &nbsp;&nbsp; folks: **2,119**  &nbsp;&nbsp; `827 stars this week`
...
1. [Nimdy / Dedicated_Valheim_Server_Script](https://github.com/Nimdy/Dedicated_Valheim_Server_Script)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **357** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `116 stars this week`

1. [pyroscope-io / pyroscope](https://github.com/pyroscope-io/pyroscope)
    - 🔥 Continuous Profiling Platform 🔥 Debug performance issues down to a single line of code
    - language: **Go** &nbsp;&nbsp; stars: **1,899** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `858 stars this week`
...
1. [lloesche / valheim-server-docker](https://github.com/lloesche/valheim-server-docker)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **397** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `129 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **25,220** &nbsp;&nbsp; folks: **4,803**  &nbsp;&nbsp; `542 stars this week`

1. [jetlinks / jetlinks-community](https://github.com/jetlinks/jetlinks-community)
    - JetLinks 基于Java8,Spring Boot 2.x ,WebFlux,Netty,Vert.x,Reactor等开发, 是一个全响应式的企业级物联网平台。支持统一物模型管理,多种设备,多种厂家,统一管理。统一设备连接管理,多协议适配(TCP,MQTT,UDP,CoAP,HTTP等),屏蔽网络编程复杂性,灵活接入不同厂家不同协议等设备。实时数据处理,设备告警,消息通知,数据转发。地理位置,数据可视化等。能帮助你快速建立物联网相关业务系统。
    - language: **Java** &nbsp;&nbsp; stars: **1,295** &nbsp;&nbsp; folks: **462**  &nbsp;&nbsp; `132 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,003** &nbsp;&nbsp; folks: **7,254**  &nbsp;&nbsp; `360 stars this week`

1. [elunez / eladmin](https://github.com/elunez/eladmin)
    - 项目基于 Spring Boot 2.1.0 、 Jpa、 Spring Security、redis、Vue的前后端分离的后台管理系统，项目采用分模块开发方式， 权限控制采用 RBAC，支持数据字典与数据权限管理，支持一键生成前后端代码，支持动态路由
    - language: **Java** &nbsp;&nbsp; stars: **14,585** &nbsp;&nbsp; folks: **5,404**  &nbsp;&nbsp; `240 stars this week`

1. [utmapp / UTM](https://github.com/utmapp/UTM)
    - Virtual machines for iOS
    - language: **Objective-C** &nbsp;&nbsp; stars: **7,169** &nbsp;&nbsp; folks: **471**  &nbsp;&nbsp; `323 stars this week`
...
1. [alievk / avatarify](https://github.com/alievk/avatarify)
    - Avatars for Zoom, Skype and other video-conferencing apps.
    - language: **Python** &nbsp;&nbsp; stars: **12,262** &nbsp;&nbsp; folks: **1,699**  &nbsp;&nbsp; `2,473 stars this month`

1. [aamini / introtodeeplearning](https://github.com/aamini/introtodeeplearning)
    - Lab Materials for MIT 6.S191: Introduction to Deep Learning
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **4,245** &nbsp;&nbsp; folks: **1,925**  &nbsp;&nbsp; `1,204 stars this month`
...
1. [achannarasappa / ticker](https://github.com/achannarasappa/ticker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,337** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `1,132 stars this month`

1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    - Powerful yet simple to use screenshot software 🖥️ 📸
    - language: **C++** &nbsp;&nbsp; stars: **10,417** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `2,620 stars this month`

1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **11,417** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `2,629 stars this month`

1. [jart / cosmopolitan](https://github.com/jart/cosmopolitan)
    - fast portable static native textmode containers
    - language: **C** &nbsp;&nbsp; stars: **3,891** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `2,731 stars this month`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **4,509** &nbsp;&nbsp; folks: **1,190**  &nbsp;&nbsp; `1,142 stars this month`

1. [android / compose-samples](https://github.com/android/compose-samples)
    - Official Jetpack Compose samples.
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,945** &nbsp;&nbsp; folks: **972**  &nbsp;&nbsp; `1,085 stars this month`

1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,036** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `3,620 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,042** &nbsp;&nbsp; folks: **1,170**  &nbsp;&nbsp; `4,068 stars this month`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,705** &nbsp;&nbsp; folks: **1,637**  &nbsp;&nbsp; `1,478 stars this month`

1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,825** &nbsp;&nbsp; folks: **684**  &nbsp;&nbsp; `1,358 stars this month`

1. [cuixiaorui / mini-vue](https://github.com/cuixiaorui/mini-vue)
    - 实现最简 vue3 模型
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,938** &nbsp;&nbsp; folks: **281**  &nbsp;&nbsp; `1,007 stars this month`
...
1. [bitwarden / server](https://github.com/bitwarden/server)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,205** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `492 stars this month`

1. [input-output-hk / cardano-node](https://github.com/input-output-hk/cardano-node)
    - The core component that is used to participate in a Cardano decentralised blockchain.
    - language: **Haskell** &nbsp;&nbsp; stars: **804** &nbsp;&nbsp; folks: **190**  &nbsp;&nbsp; `326 stars this month`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,006** &nbsp;&nbsp; folks: **1,858**  &nbsp;&nbsp; `325 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **25,220** &nbsp;&nbsp; folks: **4,803**  &nbsp;&nbsp; `1,401 stars this month`

1. [cosmos / cosmos-sdk](https://github.com/cosmos/cosmos-sdk)
    - ⛓️ A Framework for Building High Value Public Blockchains ✨
    - language: **Go** &nbsp;&nbsp; stars: **2,219** &nbsp;&nbsp; folks: **1,023**  &nbsp;&nbsp; `226 stars this month`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,797** &nbsp;&nbsp; folks: **438**  &nbsp;&nbsp; `2,451 stars this month`

1. [athensresearch / athens](https://github.com/athensresearch/athens)
    - Desktop app links: https://tinyurl.com/athens-mac, https://tinyurl.com/athens-windows, https://tinyurl.com/athens-linux; paid tiers available through https://opencollective.com/athens; try the demo at https://athensresearch.github.io/athens
    - language: **Clojure** &nbsp;&nbsp; stars: **2,986** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `773 stars this month`
