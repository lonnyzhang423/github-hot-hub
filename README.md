...
1. [yuchenlin / rebiber](https://github.com/yuchenlin/rebiber)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **705** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `140 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,203** &nbsp;&nbsp; folks: **1,161**  &nbsp;&nbsp; `402 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,200** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `224 stars today`

1. [qutebrowser / qutebrowser](https://github.com/qutebrowser/qutebrowser)
    - A keyboard-driven, vim-like browser based on PyQt5.
    - language: **Python** &nbsp;&nbsp; stars: **6,342** &nbsp;&nbsp; folks: **821**  &nbsp;&nbsp; `79 stars today`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,630** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `163 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **74,312** &nbsp;&nbsp; folks: **10,732**  &nbsp;&nbsp; `130 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **396** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `68 stars today`
...
1. [alura-challenges / aluraquiz-base](https://github.com/alura-challenges/aluraquiz-base)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,200** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `108 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,519** &nbsp;&nbsp; folks: **20,998**  &nbsp;&nbsp; `27 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,661** &nbsp;&nbsp; folks: **13,390**  &nbsp;&nbsp; `368 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,562** &nbsp;&nbsp; folks: **1,303**  &nbsp;&nbsp; `1,438 stars this week`
...
1. [Marak / faker.js](https://github.com/Marak/faker.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,551** &nbsp;&nbsp; folks: **2,600**  &nbsp;&nbsp; `502 stars this week`

1. [Hunlongyu / ZY-Player](https://github.com/Hunlongyu/ZY-Player)
    - ▶️ 跨平台桌面端视频资源播放器.简洁无广告.免费高颜值. 🎞
    - language: **Vue** &nbsp;&nbsp; stars: **7,729** &nbsp;&nbsp; folks: **1,253**  &nbsp;&nbsp; `438 stars this week`

1. [laravel / framework](https://github.com/laravel/framework)
    - 无
    - language: **PHP** &nbsp;&nbsp; stars: **23,316** &nbsp;&nbsp; folks: **7,901**  &nbsp;&nbsp; `164 stars this week`
...
1. [directus / directus](https://github.com/directus/directus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,801** &nbsp;&nbsp; folks: **898**  &nbsp;&nbsp; `261 stars this week`

1. [jgthms / bulma](https://github.com/jgthms/bulma)
    - Modern CSS framework based on Flexbox
    - language: **CSS** &nbsp;&nbsp; stars: **42,502** &nbsp;&nbsp; folks: **3,660**  &nbsp;&nbsp; `101 stars this week`

1. [micropython / micropython](https://github.com/micropython/micropython)
    - MicroPython - a lean and efficient Python implementation for microcontrollers and constrained systems
    - language: **C** &nbsp;&nbsp; stars: **11,853** &nbsp;&nbsp; folks: **4,011**  &nbsp;&nbsp; `113 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,200** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `497 stars this week`
...
1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **18,233** &nbsp;&nbsp; folks: **1,650**  &nbsp;&nbsp; `275 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,491** &nbsp;&nbsp; folks: **4,586**  &nbsp;&nbsp; `5,357 stars this month`

1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    - Server supporting the Signal Private Messenger applications on Android, Desktop, and iOS
    - language: **Java** &nbsp;&nbsp; stars: **5,477** &nbsp;&nbsp; folks: **1,339**  &nbsp;&nbsp; `3,218 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,085** &nbsp;&nbsp; folks: **1,783**  &nbsp;&nbsp; `3,621 stars this month`

1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    - A private messenger for iOS.
    - language: **Swift** &nbsp;&nbsp; stars: **7,630** &nbsp;&nbsp; folks: **2,001**  &nbsp;&nbsp; `2,299 stars this month`

1. [cehui0303 / Tmall_Tickets](https://github.com/cehui0303/Tmall_Tickets)
    - 天猫超市茅台抢票功能
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,823** &nbsp;&nbsp; folks: **1,758**  &nbsp;&nbsp; `1,685 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,428** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `3,277 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,537** &nbsp;&nbsp; folks: **916**  &nbsp;&nbsp; `2,500 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,521** &nbsp;&nbsp; folks: **6,758**  &nbsp;&nbsp; `2,919 stars this month`

1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    - Matrix (An open network for secure, decentralized communication) server setup using Ansible and Docker
    - language: **HTML** &nbsp;&nbsp; stars: **1,597** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `648 stars this month`

1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,397** &nbsp;&nbsp; folks: **9,325**  &nbsp;&nbsp; `550 stars this month`

1. [owid / covid-19-data](https://github.com/owid/covid-19-data)
    - Data on COVID-19 (coronavirus) cases, deaths, hospitalizations, tests • All countries • Updated daily by Our World in Data
    - language: **Python** &nbsp;&nbsp; stars: **2,323** &nbsp;&nbsp; folks: **1,067**  &nbsp;&nbsp; `715 stars this month`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **10,427** &nbsp;&nbsp; folks: **532**  &nbsp;&nbsp; `2,547 stars this month`
...
1. [mxrch / GHunt](https://github.com/mxrch/GHunt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,895** &nbsp;&nbsp; folks: **632**  &nbsp;&nbsp; `2,380 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,424** &nbsp;&nbsp; folks: **1,982**  &nbsp;&nbsp; `2,415 stars this month`
...
1. [thecodingmachine / workadventure](https://github.com/thecodingmachine/workadventure)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,049** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `777 stars this month`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,176** &nbsp;&nbsp; folks: **681**  &nbsp;&nbsp; `2,464 stars this month`

1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    - 一站式Apache Kafka集群指标监控与运维管控平台
    - language: **Java** &nbsp;&nbsp; stars: **1,379** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `704 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **48,362** &nbsp;&nbsp; folks: **27,270**  &nbsp;&nbsp; `1,266 stars this month`
