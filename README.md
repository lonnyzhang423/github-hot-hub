...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,065** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `234 stars today`

1. [microsoft / vscode](https://github.com/microsoft/vscode)
    - Visual Studio Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **113,923** &nbsp;&nbsp; folks: **18,456**  &nbsp;&nbsp; `169 stars today`
...
1. [microsoft / ProjectReunion](https://github.com/microsoft/ProjectReunion)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,612** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `69 stars today`
...
1. [nicehash / NiceHashQuickMiner](https://github.com/nicehash/NiceHashQuickMiner)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **352** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `60 stars today`

1. [alibaba / COLA](https://github.com/alibaba/COLA)
    - 🥤 COLA: Clean Object-oriented & Layered Architecture
    - language: **Java** &nbsp;&nbsp; stars: **4,460** &nbsp;&nbsp; folks: **1,215**  &nbsp;&nbsp; `48 stars today`
...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,725** &nbsp;&nbsp; folks: **438**  &nbsp;&nbsp; `2,541 stars this week`

1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    - Simple command line tool for text to image generation using OpenAI's CLIP and Siren (Implicit neural representation network)
    - language: **Python** &nbsp;&nbsp; stars: **2,852** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `2,091 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,352** &nbsp;&nbsp; folks: **16,925**  &nbsp;&nbsp; `2,484 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,766** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `761 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,315** &nbsp;&nbsp; folks: **833**  &nbsp;&nbsp; `1,150 stars this week`

1. [catchorg / Catch2](https://github.com/catchorg/Catch2)
    - A modern, C++-native, header-only, test framework for unit-tests, TDD and BDD - using C++11, C++14, C++17 and later (or C++03 on the Catch1.x branch)
    - language: **C++** &nbsp;&nbsp; stars: **13,148** &nbsp;&nbsp; folks: **2,209**  &nbsp;&nbsp; `250 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,258** &nbsp;&nbsp; folks: **7,788**  &nbsp;&nbsp; `443 stars this week`
...
1. [getify / You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS)
    ...
    - language: **无** &nbsp;&nbsp; stars: **135,538** &nbsp;&nbsp; folks: **26,962**  &nbsp;&nbsp; `554 stars this week`
...
1. [denoland / deno](https://github.com/denoland/deno)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **74,018** &nbsp;&nbsp; folks: **3,895**  &nbsp;&nbsp; `430 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,889** &nbsp;&nbsp; folks: **1,120**  &nbsp;&nbsp; `5,578 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run Mac in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X!
    - language: **Shell** &nbsp;&nbsp; stars: **13,298** &nbsp;&nbsp; folks: **583**  &nbsp;&nbsp; `4,668 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **7,315** &nbsp;&nbsp; folks: **833**  &nbsp;&nbsp; `4,136 stars this month`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,500** &nbsp;&nbsp; folks: **966**  &nbsp;&nbsp; `3,764 stars this month`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - 🔎 Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **24,087** &nbsp;&nbsp; folks: **2,421**  &nbsp;&nbsp; `3,419 stars this month`
...
1. [spring-projects-experimental / spring-native](https://github.com/spring-projects-experimental/spring-native)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,645** &nbsp;&nbsp; folks: **175**  &nbsp;&nbsp; `635 stars this month`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **965** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `633 stars this month`
...
1. [stefan-jansen / machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,708** &nbsp;&nbsp; folks: **1,161**  &nbsp;&nbsp; `1,776 stars this month`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **117,296** &nbsp;&nbsp; folks: **16,775**  &nbsp;&nbsp; `3,691 stars this month`
...
1. [openjdk / jdk](https://github.com/openjdk/jdk)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,789** &nbsp;&nbsp; folks: **2,105**  &nbsp;&nbsp; `893 stars this month`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **101,085** &nbsp;&nbsp; folks: **34,815**  &nbsp;&nbsp; `2,983 stars this month`

1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    - 📚 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计、Java、Python、C++
    - language: **Java** &nbsp;&nbsp; stars: **125,083** &nbsp;&nbsp; folks: **40,578**  &nbsp;&nbsp; `3,168 stars this month`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **985** &nbsp;&nbsp; folks: **1,096**  &nbsp;&nbsp; `575 stars this month`
...
1. [chatwoot / chatwoot](https://github.com/chatwoot/chatwoot)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **8,778** &nbsp;&nbsp; folks: **860**  &nbsp;&nbsp; `1,771 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,746** &nbsp;&nbsp; folks: **3,204**  &nbsp;&nbsp; `5,773 stars this month`
...
1. [WZMIAOMIAO / deep-learning-for-image-processing](https://github.com/WZMIAOMIAO/deep-learning-for-image-processing)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,173** &nbsp;&nbsp; folks: **1,121**  &nbsp;&nbsp; `364 stars this month`
