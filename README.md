...
1. [pittcsc / Summer2023-Internships](https://github.com/pittcsc/Summer2023-Internships)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,433** &nbsp;&nbsp; folks: **950**  &nbsp;&nbsp; `166 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,576** &nbsp;&nbsp; folks: **3,199**  &nbsp;&nbsp; `331 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-js](https://github.com/smartcontractkit/full-blockchain-solidity-course-js)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,662** &nbsp;&nbsp; folks: **287**  &nbsp;&nbsp; `274 stars today`
...
1. [sottlmarek / DevSecOps](https://github.com/sottlmarek/DevSecOps)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,817** &nbsp;&nbsp; folks: **419**  &nbsp;&nbsp; `130 stars today`
...
1. [prowler-cloud / prowler](https://github.com/prowler-cloud/prowler)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **5,656** &nbsp;&nbsp; folks: **905**  &nbsp;&nbsp; `97 stars today`
...
1. [xianfei / SysMocap](https://github.com/xianfei/SysMocap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **593** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `164 stars today`

1. [nodejs / undici](https://github.com/nodejs/undici)
    - An HTTP/1.1 client, written from scratch for Node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,794** &nbsp;&nbsp; folks: **237**  &nbsp;&nbsp; `59 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,576** &nbsp;&nbsp; folks: **3,199**  &nbsp;&nbsp; `1,431 stars this week`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **19,349** &nbsp;&nbsp; folks: **2,124**  &nbsp;&nbsp; `1,458 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **194,814** &nbsp;&nbsp; folks: **22,443**  &nbsp;&nbsp; `851 stars this week`
...
1. [pyscript / pyscript](https://github.com/pyscript/pyscript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,197** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `10,620 stars this month`
...
1. [Grasscutters / Grasscutter](https://github.com/Grasscutters/Grasscutter)
    - A server software reimplementation for a certain anime game.
    - language: **Java** &nbsp;&nbsp; stars: **7,852** &nbsp;&nbsp; folks: **2,775**  &nbsp;&nbsp; `4,587 stars this month`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,576** &nbsp;&nbsp; folks: **3,199**  &nbsp;&nbsp; `1,963 stars this month`
