...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **518** &nbsp;&nbsp; folks: **55**  &nbsp;&nbsp; `36 stars today`
...
1. [veler / DevToys](https://github.com/veler/DevToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,073** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `3,772 stars this week`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **11,819** &nbsp;&nbsp; folks: **2,228**  &nbsp;&nbsp; `1,858 stars this week`

1. [khuedoan / homelab](https://github.com/khuedoan/homelab)
    - My self-hosting infrastructure, fully automated from empty disk to operating services
    - language: **Python** &nbsp;&nbsp; stars: **4,983** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `1,784 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **178,414** &nbsp;&nbsp; folks: **20,546**  &nbsp;&nbsp; `1,756 stars this week`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,931** &nbsp;&nbsp; folks: **2,932**  &nbsp;&nbsp; `420 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,287** &nbsp;&nbsp; folks: **5,543**  &nbsp;&nbsp; `656 stars this week`

1. [flxzt / rnote](https://github.com/flxzt/rnote)
    - A simple drawing application to create handwritten notes.
    - language: **Rust** &nbsp;&nbsp; stars: **1,759** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `874 stars this week`

1. [yuzu-emu / yuzu](https://github.com/yuzu-emu/yuzu)
    - Nintendo Switch Emulator
    - language: **C++** &nbsp;&nbsp; stars: **18,430** &nbsp;&nbsp; folks: **1,554**  &nbsp;&nbsp; `569 stars this week`

1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    - Project Cider. A new look into listening and enjoying Apple Music in style and performance. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **518** &nbsp;&nbsp; folks: **55**  &nbsp;&nbsp; `132 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **11,109** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `360 stars this week`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **C** &nbsp;&nbsp; stars: **126,033** &nbsp;&nbsp; folks: **41,167**  &nbsp;&nbsp; `1,607 stars this week`

1. [vercel / platforms](https://github.com/vercel/platforms)
    - A template for site builders and low-code tools.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,282** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `545 stars this week`
...
1. [rancher-sandbox / rancher-desktop](https://github.com/rancher-sandbox/rancher-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,364** &nbsp;&nbsp; folks: **92**  &nbsp;&nbsp; `445 stars this week`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,149** &nbsp;&nbsp; folks: **9,043**  &nbsp;&nbsp; `813 stars this week`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,657** &nbsp;&nbsp; folks: **1,118**  &nbsp;&nbsp; `362 stars this week`

1. [abiosoft / colima](https://github.com/abiosoft/colima)
    - Container runtimes on macOS (and Linux) with minimal setup
    - language: **Go** &nbsp;&nbsp; stars: **1,949** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `533 stars this week`

1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    - A Python framework for creating reproducible, maintainable and modular data science code.
    - language: **Python** &nbsp;&nbsp; stars: **6,336** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `937 stars this week`

1. [microsoft / playwright](https://github.com/microsoft/playwright)
    - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,624** &nbsp;&nbsp; folks: **1,474**  &nbsp;&nbsp; `1,058 stars this week`

1. [scikit-learn / scikit-learn](https://github.com/scikit-learn/scikit-learn)
    - scikit-learn: machine learning in Python
    - language: **Python** &nbsp;&nbsp; stars: **48,833** &nbsp;&nbsp; folks: **22,576**  &nbsp;&nbsp; `239 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,074** &nbsp;&nbsp; folks: **3,101**  &nbsp;&nbsp; `3,723 stars this month`

1. [files-community / Files](https://github.com/files-community/Files)
    - A modern file manager for Windows
    - language: **C#** &nbsp;&nbsp; stars: **19,250** &nbsp;&nbsp; folks: **1,052**  &nbsp;&nbsp; `3,991 stars this month`
...
1. [adrianhajdin / project_web3.0](https://github.com/adrianhajdin/project_web3.0)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,285** &nbsp;&nbsp; folks: **260**  &nbsp;&nbsp; `1,071 stars this month`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **11,819** &nbsp;&nbsp; folks: **2,228**  &nbsp;&nbsp; `2,507 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **29,774** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `4,353 stars this month`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **13,852** &nbsp;&nbsp; folks: **1,243**  &nbsp;&nbsp; `1,374 stars this month`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,587** &nbsp;&nbsp; folks: **1,833**  &nbsp;&nbsp; `1,114 stars this month`
...
1. [coqui-ai / TTS](https://github.com/coqui-ai/TTS)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,756** &nbsp;&nbsp; folks: **334**  &nbsp;&nbsp; `795 stars this month`

1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    - 你管这破玩意叫操作系统源码 — 像小说一样品读 Linux 0.11 核心代码
    - language: **C** &nbsp;&nbsp; stars: **6,642** &nbsp;&nbsp; folks: **718**  &nbsp;&nbsp; `3,219 stars this month`

1. [Textualize / rich](https://github.com/Textualize/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **34,421** &nbsp;&nbsp; folks: **1,108**  &nbsp;&nbsp; `2,665 stars this month`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,350** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `1,499 stars this month`
...
1. [safak / youtube](https://github.com/safak/youtube)
    - 无
    - language: **CSS** &nbsp;&nbsp; stars: **1,932** &nbsp;&nbsp; folks: **2,141**  &nbsp;&nbsp; `375 stars this month`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,371** &nbsp;&nbsp; folks: **684**  &nbsp;&nbsp; `2,308 stars this month`

1. [google / log4jscanner](https://github.com/google/log4jscanner)
    - A log4j vulnerability filesystem scanner and Go package for analyzing JAR files.
    - language: **Go** &nbsp;&nbsp; stars: **1,485** &nbsp;&nbsp; folks: **108**  &nbsp;&nbsp; `1,103 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,931** &nbsp;&nbsp; folks: **2,932**  &nbsp;&nbsp; `830 stars this month`

1. [dwyl / english-words](https://github.com/dwyl/english-words)
    - 📝 A text file containing 479k English words for all your dictionary/word-based projects e.g: auto-completion / autosuggestion
    - language: **Python** &nbsp;&nbsp; stars: **6,248** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `404 stars this month`

1. [TandoorRecipes / recipes](https://github.com/TandoorRecipes/recipes)
    - Application for managing recipes, planning meals, building shopping lists and much much more!
    - language: **HTML** &nbsp;&nbsp; stars: **2,560** &nbsp;&nbsp; folks: **208**  &nbsp;&nbsp; `598 stars this month`
