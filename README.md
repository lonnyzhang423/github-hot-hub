...
`更新时间：2021-01-29 01:37:34 +0800`

## 今日热门仓库

1. [googlevr / tilt-brush](https://github.com/googlevr/tilt-brush)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **1,278** &nbsp;&nbsp; folks: **234**  &nbsp;&nbsp; `362 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,739** &nbsp;&nbsp; folks: **1,089**  &nbsp;&nbsp; `101 stars today`
...
1. [apache / superset](https://github.com/apache/superset)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,422** &nbsp;&nbsp; folks: **6,747**  &nbsp;&nbsp; `1,949 stars this week`
...
1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,353** &nbsp;&nbsp; folks: **972**  &nbsp;&nbsp; `788 stars this week`
...
1. [developedbyed / glass-website](https://github.com/developedbyed/glass-website)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **487** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `154 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,170** &nbsp;&nbsp; folks: **1,941**  &nbsp;&nbsp; `1,260 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,412** &nbsp;&nbsp; folks: **1,286**  &nbsp;&nbsp; `1,080 stars this week`

1. [Marak / faker.js](https://github.com/Marak/faker.js)
    - generate massive amounts of realistic fake data in Node.js and the browser
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,521** &nbsp;&nbsp; folks: **2,600**  &nbsp;&nbsp; `910 stars this week`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **8,458** &nbsp;&nbsp; folks: **721**  &nbsp;&nbsp; `370 stars this week`

1. [laravel / framework](https://github.com/laravel/framework)
    - 无
    - language: **PHP** &nbsp;&nbsp; stars: **23,300** &nbsp;&nbsp; folks: **7,897**  &nbsp;&nbsp; `304 stars this week`

1. [microsoft / DeepSpeed](https://github.com/microsoft/DeepSpeed)
    - DeepSpeed is a deep learning optimization library that makes distributed training easy, efficient, and effective.
    - language: **Python** &nbsp;&nbsp; stars: **4,169** &nbsp;&nbsp; folks: **390**  &nbsp;&nbsp; `166 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **173,236** &nbsp;&nbsp; folks: **40,149**  &nbsp;&nbsp; `1,363 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **973** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `188 stars this week`

1. [hashicorp / vault](https://github.com/hashicorp/vault)
    - A tool for secrets management, encryption as a service, and privileged access management
    - language: **Go** &nbsp;&nbsp; stars: **19,075** &nbsp;&nbsp; folks: **2,766**  &nbsp;&nbsp; `81 stars this week`
...
1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **18,165** &nbsp;&nbsp; folks: **1,635**  &nbsp;&nbsp; `296 stars this week`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,214** &nbsp;&nbsp; folks: **114**  &nbsp;&nbsp; `158 stars this week`

1. [livewire / livewire](https://github.com/livewire/livewire)
    - A full-stack framework for Laravel that takes the pain out of building dynamic UIs.
    - language: **Blade** &nbsp;&nbsp; stars: **9,179** &nbsp;&nbsp; folks: **580**  &nbsp;&nbsp; `165 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,429** &nbsp;&nbsp; folks: **4,573**  &nbsp;&nbsp; `5,265 stars this month`

1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    - Server supporting the Signal Private Messenger applications on Android, Desktop, and iOS
    - language: **Java** &nbsp;&nbsp; stars: **5,446** &nbsp;&nbsp; folks: **1,333**  &nbsp;&nbsp; `3,183 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,048** &nbsp;&nbsp; folks: **1,780**  &nbsp;&nbsp; `3,568 stars this month`

1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    - A private messenger for iOS.
    - language: **Swift** &nbsp;&nbsp; stars: **7,610** &nbsp;&nbsp; folks: **1,994**  &nbsp;&nbsp; `2,271 stars this month`
...
1. [mxrch / GHunt](https://github.com/mxrch/GHunt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,872** &nbsp;&nbsp; folks: **628**  &nbsp;&nbsp; `2,371 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,410** &nbsp;&nbsp; folks: **907**  &nbsp;&nbsp; `2,395 stars this month`

1. [owid / covid-19-data](https://github.com/owid/covid-19-data)
    - Data on COVID-19 (coronavirus) cases, deaths, hospitalizations, tests • All countries • Updated daily by Our World in Data
    - language: **Python** &nbsp;&nbsp; stars: **2,300** &nbsp;&nbsp; folks: **1,051**  &nbsp;&nbsp; `704 stars this month`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,422** &nbsp;&nbsp; folks: **6,747**  &nbsp;&nbsp; `2,571 stars this month`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **10,402** &nbsp;&nbsp; folks: **532**  &nbsp;&nbsp; `2,552 stars this month`
...
1. [excalidraw / excalidraw](https://github.com/excalidraw/excalidraw)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,303** &nbsp;&nbsp; folks: **1,092**  &nbsp;&nbsp; `2,418 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **48,308** &nbsp;&nbsp; folks: **27,248**  &nbsp;&nbsp; `1,258 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,571** &nbsp;&nbsp; folks: **3,905**  &nbsp;&nbsp; `1,093 stars this month`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - 🔎 Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **20,451** &nbsp;&nbsp; folks: **2,078**  &nbsp;&nbsp; `1,782 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,170** &nbsp;&nbsp; folks: **1,941**  &nbsp;&nbsp; `1,812 stars this month`
