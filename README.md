...
1. [CyberPunkMetalHead / backtesting-for-cryptocurrency-trading](https://github.com/CyberPunkMetalHead/backtesting-for-cryptocurrency-trading)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68** &nbsp;&nbsp; folks: **7**  &nbsp;&nbsp; `36 stars today`

1. [discordjs / discord.js](https://github.com/discordjs/discord.js)
    - A powerful JavaScript library for interacting with the Discord API
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,405** &nbsp;&nbsp; folks: **2,566**  &nbsp;&nbsp; `156 stars today`

1. [atom / atom](https://github.com/atom/atom)
    - The hackable text editor
    - language: **JavaScript** &nbsp;&nbsp; stars: **55,471** &nbsp;&nbsp; folks: **16,176**  &nbsp;&nbsp; `35 stars today`

1. [thanos-io / thanos](https://github.com/thanos-io/thanos)
    - Highly available Prometheus setup with long term storage capabilities. A CNCF Incubating project.
    - language: **Go** &nbsp;&nbsp; stars: **8,701** &nbsp;&nbsp; folks: **1,272**  &nbsp;&nbsp; `105 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,455** &nbsp;&nbsp; folks: **1,774**  &nbsp;&nbsp; `146 stars today`
...
1. [madMAx43v3r / chia-plotter](https://github.com/madMAx43v3r/chia-plotter)
    - 无
    - language: **C** &nbsp;&nbsp; stars: **1,591** &nbsp;&nbsp; folks: **487**  &nbsp;&nbsp; `1,372 stars this week`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - An open-source no-code platform for building and deploying internal tools.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,544** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `913 stars this week`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Shell** &nbsp;&nbsp; stars: **4,007** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `582 stars this week`
...
1. [PaddlePaddle / PaddleHub](https://github.com/PaddlePaddle/PaddleHub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,430** &nbsp;&nbsp; folks: **1,279**  &nbsp;&nbsp; `895 stars this week`

1. [microsoft / playwright](https://github.com/microsoft/playwright)
    - Node.js library to automate Chromium, Firefox and WebKit with a single API
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,042** &nbsp;&nbsp; folks: **1,021**  &nbsp;&nbsp; `633 stars this week`

1. [firstcontributions / first-contributions](https://github.com/firstcontributions/first-contributions)
    - 🚀✨ Help beginners to contribute to open source projects
    - language: **无** &nbsp;&nbsp; stars: **20,031** &nbsp;&nbsp; folks: **36,866**  &nbsp;&nbsp; `893 stars this week`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,768** &nbsp;&nbsp; folks: **341**  &nbsp;&nbsp; `137 stars this week`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **17,897** &nbsp;&nbsp; folks: **4,037**  &nbsp;&nbsp; `382 stars this week`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **962** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `745 stars this month`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,460** &nbsp;&nbsp; folks: **446**  &nbsp;&nbsp; `1,480 stars this month`
...
1. [deepfakes / faceswap](https://github.com/deepfakes/faceswap)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,231** &nbsp;&nbsp; folks: **10,973**  &nbsp;&nbsp; `2,163 stars this month`

1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    - Fig adds autocomplete to your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,307** &nbsp;&nbsp; folks: **480**  &nbsp;&nbsp; `2,088 stars this month`

1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **6,601** &nbsp;&nbsp; folks: **1,436**  &nbsp;&nbsp; `1,397 stars this month`

1. [microsoft / winget-cli](https://github.com/microsoft/winget-cli)
    - Windows Package Manager CLI (aka winget)
    - language: **C++** &nbsp;&nbsp; stars: **13,850** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `2,159 stars this month`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **68,354** &nbsp;&nbsp; folks: **21,291**  &nbsp;&nbsp; `2,640 stars this month`

1. [firstcontributions / first-contributions](https://github.com/firstcontributions/first-contributions)
    - 🚀✨ Help beginners to contribute to open source projects
    - language: **无** &nbsp;&nbsp; stars: **20,031** &nbsp;&nbsp; folks: **36,866**  &nbsp;&nbsp; `1,916 stars this month`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **180,378** &nbsp;&nbsp; folks: **48,786**  &nbsp;&nbsp; `11,383 stars this month`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,684** &nbsp;&nbsp; folks: **1,148**  &nbsp;&nbsp; `1,765 stars this month`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **2,749** &nbsp;&nbsp; folks: **1,772**  &nbsp;&nbsp; `1,264 stars this month`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **13,484** &nbsp;&nbsp; folks: **1,284**  &nbsp;&nbsp; `2,428 stars this month`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **39,007** &nbsp;&nbsp; folks: **12,798**  &nbsp;&nbsp; `1,758 stars this month`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Shell** &nbsp;&nbsp; stars: **4,007** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `693 stars this month`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **17,897** &nbsp;&nbsp; folks: **4,037**  &nbsp;&nbsp; `931 stars this month`

1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,223** &nbsp;&nbsp; folks: **2,175**  &nbsp;&nbsp; `810 stars this month`

1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    - Matter (formerly Project CHIP) is creating more connections between more objects, simplifying development for manufacturers and increasing compatibility for consumers, guided by the Connectivity Standards Alliance (formerly Zigbee Alliance).
    - language: **C++** &nbsp;&nbsp; stars: **1,768** &nbsp;&nbsp; folks: **341**  &nbsp;&nbsp; `426 stars this month`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,741** &nbsp;&nbsp; folks: **7,586**  &nbsp;&nbsp; `806 stars this month`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **5,295** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `3,120 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,743** &nbsp;&nbsp; folks: **757**  &nbsp;&nbsp; `2,944 stars this month`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **JavaScript** &nbsp;&nbsp; stars: **151,200** &nbsp;&nbsp; folks: **73,662**  &nbsp;&nbsp; `1,359 stars this month`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,154** &nbsp;&nbsp; folks: **2,245**  &nbsp;&nbsp; `3,477 stars this month`
