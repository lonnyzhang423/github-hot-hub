...
1. [yuchenlin / rebiber](https://github.com/yuchenlin/rebiber)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **677** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `136 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,164** &nbsp;&nbsp; folks: **1,155**  &nbsp;&nbsp; `442 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,174** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `209 stars today`

1. [qutebrowser / qutebrowser](https://github.com/qutebrowser/qutebrowser)
    - A keyboard-driven, vim-like browser based on PyQt5.
    - language: **Python** &nbsp;&nbsp; stars: **6,307** &nbsp;&nbsp; folks: **819**  &nbsp;&nbsp; `92 stars today`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,596** &nbsp;&nbsp; folks: **982**  &nbsp;&nbsp; `163 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **74,262** &nbsp;&nbsp; folks: **10,731**  &nbsp;&nbsp; `121 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **350** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `66 stars today`
...
1. [stnkl / EverythingToolbar](https://github.com/stnkl/EverythingToolbar)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **1,993** &nbsp;&nbsp; folks: **120**  &nbsp;&nbsp; `56 stars today`
...
1. [alura-challenges / aluraquiz-base](https://github.com/alura-challenges/aluraquiz-base)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,185** &nbsp;&nbsp; folks: **482**  &nbsp;&nbsp; `131 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,508** &nbsp;&nbsp; folks: **20,999**  &nbsp;&nbsp; `27 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,202** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `4,392 stars this week`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,512** &nbsp;&nbsp; folks: **6,756**  &nbsp;&nbsp; `2,164 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,400** &nbsp;&nbsp; folks: **1,979**  &nbsp;&nbsp; `1,928 stars this week`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **23,658** &nbsp;&nbsp; folks: **4,519**  &nbsp;&nbsp; `454 stars this week`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,648** &nbsp;&nbsp; folks: **13,389**  &nbsp;&nbsp; `368 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,556** &nbsp;&nbsp; folks: **1,301**  &nbsp;&nbsp; `1,441 stars this week`
...
1. [hathach / tinyusb](https://github.com/hathach/tinyusb)
    ...
    - language: **C** &nbsp;&nbsp; stars: **1,408** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `572 stars this week`
...
1. [microsoft / windows-rs](https://github.com/microsoft/windows-rs)
    - Rust for Windows
    - language: **Rust** &nbsp;&nbsp; stars: **4,118** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `606 stars this week`
...
1. [laravel / framework](https://github.com/laravel/framework)
    - 无
    - language: **PHP** &nbsp;&nbsp; stars: **23,313** &nbsp;&nbsp; folks: **7,900**  &nbsp;&nbsp; `156 stars this week`
...
1. [directus / directus](https://github.com/directus/directus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,798** &nbsp;&nbsp; folks: **897**  &nbsp;&nbsp; `259 stars this week`

1. [jgthms / bulma](https://github.com/jgthms/bulma)
    - Modern CSS framework based on Flexbox
    - language: **CSS** &nbsp;&nbsp; stars: **42,499** &nbsp;&nbsp; folks: **3,660**  &nbsp;&nbsp; `101 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,174** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `496 stars this week`
...
1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **18,228** &nbsp;&nbsp; folks: **1,647**  &nbsp;&nbsp; `279 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,471** &nbsp;&nbsp; folks: **1,338**  &nbsp;&nbsp; `3,218 stars this month`
...
1. [cehui0303 / Tmall_Tickets](https://github.com/cehui0303/Tmall_Tickets)
    - 天猫超市茅台抢票功能
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,821** &nbsp;&nbsp; folks: **1,759**  &nbsp;&nbsp; `1,685 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,423** &nbsp;&nbsp; folks: **173**  &nbsp;&nbsp; `3,277 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,516** &nbsp;&nbsp; folks: **915**  &nbsp;&nbsp; `2,500 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,512** &nbsp;&nbsp; folks: **6,756**  &nbsp;&nbsp; `2,919 stars this month`
...
1. [owid / covid-19-data](https://github.com/owid/covid-19-data)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,321** &nbsp;&nbsp; folks: **1,066**  &nbsp;&nbsp; `715 stars this month`
...
1. [mxrch / GHunt](https://github.com/mxrch/GHunt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,891** &nbsp;&nbsp; folks: **631**  &nbsp;&nbsp; `2,380 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,400** &nbsp;&nbsp; folks: **1,979**  &nbsp;&nbsp; `2,415 stars this month`
...
1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,606** &nbsp;&nbsp; folks: **4,755**  &nbsp;&nbsp; `399 stars this month`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of 5000+ publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,170** &nbsp;&nbsp; folks: **681**  &nbsp;&nbsp; `2,464 stars this month`

1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    - 一站式Apache Kafka集群指标监控与运维管控平台
    - language: **Java** &nbsp;&nbsp; stars: **1,369** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `704 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **48,348** &nbsp;&nbsp; folks: **27,268**  &nbsp;&nbsp; `1,266 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,586** &nbsp;&nbsp; folks: **3,909**  &nbsp;&nbsp; `1,104 stars this month`
