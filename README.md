...
1. [tastyigniter / TastyIgniter](https://github.com/tastyigniter/TastyIgniter)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **1,749** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `155 stars today`

1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    - A Simple and Comprehensive Vulnerability Scanner for Containers, Suitable for CI
    - language: **Go** &nbsp;&nbsp; stars: **6,301** &nbsp;&nbsp; folks: **557**  &nbsp;&nbsp; `53 stars today`
...
1. [achannarasappa / ticker](https://github.com/achannarasappa/ticker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,031** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `2,122 stars this week`

1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,582** &nbsp;&nbsp; folks: **711**  &nbsp;&nbsp; `683 stars this week`

1. [liyupi / daxigua](https://github.com/liyupi/daxigua)
    - 最简单的魔改发布『 合成大西瓜 』，配套改图工具，不用改代码，修改配置即可！
    - language: **JavaScript** &nbsp;&nbsp; stars: **938** &nbsp;&nbsp; folks: **617**  &nbsp;&nbsp; `367 stars this week`

1. [cuixiaorui / mini-vue](https://github.com/cuixiaorui/mini-vue)
    - 实现最简 vue3 模型
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,452** &nbsp;&nbsp; folks: **207**  &nbsp;&nbsp; `541 stars this week`
...
1. [aamini / introtodeeplearning](https://github.com/aamini/introtodeeplearning)
    - Lab Materials for MIT 6.S191: Introduction to Deep Learning
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,697** &nbsp;&nbsp; folks: **1,736**  &nbsp;&nbsp; `645 stars this week`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,643** &nbsp;&nbsp; folks: **28,393**  &nbsp;&nbsp; `1,380 stars this week`
...
1. [jasontaylordev / CleanArchitecture](https://github.com/jasontaylordev/CleanArchitecture)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,401** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `466 stars this week`

1. [fastlane / fastlane](https://github.com/fastlane/fastlane)
    - 🚀 The easiest way to automate building and releasing your iOS and Android apps
    - language: **Ruby** &nbsp;&nbsp; stars: **31,295** &nbsp;&nbsp; folks: **4,816**  &nbsp;&nbsp; `283 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,767** &nbsp;&nbsp; folks: **16,041**  &nbsp;&nbsp; `1,210 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **3,736** &nbsp;&nbsp; folks: **1,078**  &nbsp;&nbsp; `367 stars this week`

1. [qier222 / YesPlayMusic](https://github.com/qier222/YesPlayMusic)
    - 高颜值的第三方网易云播放器，支持 Windows / macOS / Linux
    - language: **Vue** &nbsp;&nbsp; stars: **4,246** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `972 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **11,101** &nbsp;&nbsp; folks: **3,383**  &nbsp;&nbsp; `946 stars this week`

1. [DinoZ1729 / Ray](https://github.com/DinoZ1729/Ray)
    - 无
    - language: **C++** &nbsp;&nbsp; stars: **517** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `186 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **175,374** &nbsp;&nbsp; folks: **40,472**  &nbsp;&nbsp; `1,799 stars this week`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,031** &nbsp;&nbsp; folks: **2,572**  &nbsp;&nbsp; `1,683 stars this week`

1. [TheAlgorithms / C](https://github.com/TheAlgorithms/C)
    - Collection of various algorithms in mathematics, machine learning, computer science, physics, etc implemented in C for educational purposes.
    - language: **C** &nbsp;&nbsp; stars: **7,596** &nbsp;&nbsp; folks: **2,273**  &nbsp;&nbsp; `1,127 stars this week`

1. [prometheus / prometheus](https://github.com/prometheus/prometheus)
    - The Prometheus monitoring system and time series database.
    - language: **Go** &nbsp;&nbsp; stars: **35,232** &nbsp;&nbsp; folks: **5,599**  &nbsp;&nbsp; `157 stars this week`
...
1. [explosion / spaCy](https://github.com/explosion/spaCy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,489** &nbsp;&nbsp; folks: **3,281**  &nbsp;&nbsp; `626 stars this week`

1. [ianstormtaylor / slate](https://github.com/ianstormtaylor/slate)
    - A completely customizable framework for building rich text editors. (Currently in beta.)
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,795** &nbsp;&nbsp; folks: **2,160**  &nbsp;&nbsp; `211 stars this week`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,582** &nbsp;&nbsp; folks: **711**  &nbsp;&nbsp; `796 stars this month`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,744** &nbsp;&nbsp; folks: **4,649**  &nbsp;&nbsp; `4,567 stars this month`

1. [zqjzqj / mtSecKill](https://github.com/zqjzqj/mtSecKill)
    - 京东茅台抢购
    - language: **无** &nbsp;&nbsp; stars: **2,649** &nbsp;&nbsp; folks: **1,907**  &nbsp;&nbsp; `2,141 stars this month`
...
1. [apache / superset](https://github.com/apache/superset)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,116** &nbsp;&nbsp; folks: **6,836**  &nbsp;&nbsp; `3,170 stars this month`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,787** &nbsp;&nbsp; folks: **1,367**  &nbsp;&nbsp; `2,699 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,919** &nbsp;&nbsp; folks: **13,460**  &nbsp;&nbsp; `1,129 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,733** &nbsp;&nbsp; folks: **991**  &nbsp;&nbsp; `2,826 stars this month`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **C++** &nbsp;&nbsp; stars: **16,212** &nbsp;&nbsp; folks: **5,782**  &nbsp;&nbsp; `750 stars this month`

1. [jetlinks / jetlinks-community](https://github.com/jetlinks/jetlinks-community)
    - JetLinks 基于Java8,Spring Boot 2.x ,WebFlux,Netty,Vert.x,Reactor等开发, 是一个全响应式的企业级物联网平台。支持统一物模型管理,多种设备,多种厂家,统一管理。统一设备连接管理,多协议适配(TCP,MQTT,UDP,CoAP,HTTP等),屏蔽网络编程复杂性,灵活接入不同厂家不同协议等设备。实时数据处理,设备告警,消息通知,数据转发。地理位置,数据可视化等。能帮助你快速建立物联网相关业务系统。
    - language: **Java** &nbsp;&nbsp; stars: **1,034** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `317 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,806** &nbsp;&nbsp; folks: **2,071**  &nbsp;&nbsp; `2,576 stars this month`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **8,796** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `931 stars this month`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,747** &nbsp;&nbsp; folks: **1,745**  &nbsp;&nbsp; `206 stars this month`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,703** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `312 stars this month`

1. [openai / CLIP](https://github.com/openai/CLIP)
    - Contrastive Language-Image Pretraining
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,853** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `922 stars this month`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **5,854** &nbsp;&nbsp; folks: **1,507**  &nbsp;&nbsp; `1,030 stars this month`
...
1. [snowpackjs / snowpack](https://github.com/snowpackjs/snowpack)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,996** &nbsp;&nbsp; folks: **772**  &nbsp;&nbsp; `1,911 stars this month`

1. [streamich / react-use](https://github.com/streamich/react-use)
    - React Hooks — 👍
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,304** &nbsp;&nbsp; folks: **1,356**  &nbsp;&nbsp; `1,442 stars this month`

1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    - Chrome Extensions Samples
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,736** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `403 stars this month`
