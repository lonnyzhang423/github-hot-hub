...
1. [ianhan / BitmapFonts](https://github.com/ianhan/BitmapFonts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **997** &nbsp;&nbsp; folks: **45**  &nbsp;&nbsp; `240 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **20,373** &nbsp;&nbsp; folks: **7,180**  &nbsp;&nbsp; `112 stars today`
...
1. [jasontaylordev / CleanArchitecture](https://github.com/jasontaylordev/CleanArchitecture)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,350** &nbsp;&nbsp; folks: **947**  &nbsp;&nbsp; `120 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,217** &nbsp;&nbsp; folks: **28,338**  &nbsp;&nbsp; `254 stars today`

1. [mobvoi / wenet](https://github.com/mobvoi/wenet)
    - Production First and Production Ready End-to-End Speech Recognition Toolkit
    - language: **Python** &nbsp;&nbsp; stars: **405** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `89 stars today`

1. [TheAlgorithms / C](https://github.com/TheAlgorithms/C)
    - Collection of various algorithms in mathematics, machine learning, computer science, physics, etc implemented in C for educational purposes.
    - language: **C** &nbsp;&nbsp; stars: **6,857** &nbsp;&nbsp; folks: **2,245**  &nbsp;&nbsp; `181 stars today`

1. [PaddlePaddle / VisualDL](https://github.com/PaddlePaddle/VisualDL)
    - Deep Learning Visualization Toolkit（『飞桨』深度学习可视化工具 ）
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,586** &nbsp;&nbsp; folks: **500**  &nbsp;&nbsp; `83 stars today`
...
1. [NPCat / bad-apple-bot](https://github.com/NPCat/bad-apple-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **165** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `43 stars today`

1. [cocoa-mhlw / cocoa](https://github.com/cocoa-mhlw/cocoa)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **422** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `20 stars today`

1. [MicrosoftDocs / azure-docs](https://github.com/MicrosoftDocs/azure-docs)
    - Open source documentation of Microsoft Azure
    - language: **PowerShell** &nbsp;&nbsp; stars: **5,042** &nbsp;&nbsp; folks: **12,191**  &nbsp;&nbsp; `52 stars today`
...
1. [haizlin / fe-interview](https://github.com/haizlin/fe-interview)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,249** &nbsp;&nbsp; folks: **2,176**  &nbsp;&nbsp; `92 stars today`

1. [uo-ec607 / lectures](https://github.com/uo-ec607/lectures)
    - Lecture notes for EC 607
    - language: **HTML** &nbsp;&nbsp; stars: **738** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `56 stars today`
...
1. [MathInspector / MathInspector](https://github.com/MathInspector/MathInspector)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **596** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `114 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **3,517** &nbsp;&nbsp; folks: **1,042**  &nbsp;&nbsp; `913 stars this week`

1. [berty / berty](https://github.com/berty/berty)
    - Berty is a secure peer-to-peer messaging app that works with or without internet access, cellular data or trust in the network
    - language: **Go** &nbsp;&nbsp; stars: **3,749** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `1,563 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **11,004** &nbsp;&nbsp; folks: **3,367**  &nbsp;&nbsp; `1,077 stars this week`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,842** &nbsp;&nbsp; folks: **2,252**  &nbsp;&nbsp; `751 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **71,661** &nbsp;&nbsp; folks: **6,481**  &nbsp;&nbsp; `307 stars this week`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,239** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `314 stars this week`

1. [tiangolo / full-stack-fastapi-postgresql](https://github.com/tiangolo/full-stack-fastapi-postgresql)
    - Full stack, modern web application generator. Using FastAPI, PostgreSQL as database, Docker, automatic HTTPS and more.
    - language: **Python** &nbsp;&nbsp; stars: **4,609** &nbsp;&nbsp; folks: **749**  &nbsp;&nbsp; `309 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,433** &nbsp;&nbsp; folks: **15,993**  &nbsp;&nbsp; `1,376 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,217** &nbsp;&nbsp; folks: **28,338**  &nbsp;&nbsp; `1,551 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,501** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `314 stars this week`
...
1. [jasontaylordev / CleanArchitecture](https://github.com/jasontaylordev/CleanArchitecture)
    - Clean Architecture Solution Template for Angular 10 and .NET 5
    - language: **C#** &nbsp;&nbsp; stars: **4,350** &nbsp;&nbsp; folks: **947**  &nbsp;&nbsp; `483 stars this week`
...
1. [chartjs / Chart.js](https://github.com/chartjs/Chart.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,007** &nbsp;&nbsp; folks: **10,773**  &nbsp;&nbsp; `129 stars this week`

1. [explosion / spaCy](https://github.com/explosion/spaCy)
    - 💫 Industrial-strength Natural Language Processing (NLP) in Python
    - language: **Python** &nbsp;&nbsp; stars: **19,397** &nbsp;&nbsp; folks: **3,274**  &nbsp;&nbsp; `1,299 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,673** &nbsp;&nbsp; folks: **4,634**  &nbsp;&nbsp; `5,509 stars this month`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,595** &nbsp;&nbsp; folks: **1,362**  &nbsp;&nbsp; `3,333 stars this month`
...
1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,649** &nbsp;&nbsp; folks: **366**  &nbsp;&nbsp; `687 stars this month`

1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,239** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `442 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,339** &nbsp;&nbsp; folks: **962**  &nbsp;&nbsp; `2,996 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,829** &nbsp;&nbsp; folks: **13,441**  &nbsp;&nbsp; `1,076 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,717** &nbsp;&nbsp; folks: **2,049**  &nbsp;&nbsp; `2,581 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,385** &nbsp;&nbsp; folks: **851**  &nbsp;&nbsp; `524 stars this month`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,842** &nbsp;&nbsp; folks: **2,252**  &nbsp;&nbsp; `1,476 stars this month`

1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    - Chrome Extensions Samples
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,700** &nbsp;&nbsp; folks: **4,788**  &nbsp;&nbsp; `430 stars this month`
...
1. [snowpackjs / snowpack](https://github.com/snowpackjs/snowpack)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,886** &nbsp;&nbsp; folks: **762**  &nbsp;&nbsp; `1,936 stars this month`
