...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,302** &nbsp;&nbsp; folks: **4,201**  &nbsp;&nbsp; `712 stars this week`

1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,558** &nbsp;&nbsp; folks: **1,456**  &nbsp;&nbsp; `200 stars this week`
...
1. [clouDr-f2e / rubick](https://github.com/clouDr-f2e/rubick)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,507** &nbsp;&nbsp; folks: **166**  &nbsp;&nbsp; `548 stars this week`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **624** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `156 stars this week`

1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    - A Modern Real-Time Data Processing & Analytics DBMS with Cloud-Native Architecture, built to make the Data Cloud easy
    - language: **Rust** &nbsp;&nbsp; stars: **1,762** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `801 stars this week`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,192** &nbsp;&nbsp; folks: **1,497**  &nbsp;&nbsp; `410 stars this week`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **11,170** &nbsp;&nbsp; folks: **1,630**  &nbsp;&nbsp; `141 stars this week`

1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **14,645** &nbsp;&nbsp; folks: **1,860**  &nbsp;&nbsp; `116 stars this week`

1. [carla-simulator / carla](https://github.com/carla-simulator/carla)
    - Open-source simulator for autonomous driving research.
    - language: **C++** &nbsp;&nbsp; stars: **6,315** &nbsp;&nbsp; folks: **1,895**  &nbsp;&nbsp; `52 stars this week`

1. [sveltejs / kit](https://github.com/sveltejs/kit)
    - The fastest way to build Svelte apps
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,318** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `92 stars this week`

1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants
    - language: **Python** &nbsp;&nbsp; stars: **12,468** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `699 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,385** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `766 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,057** &nbsp;&nbsp; folks: **2,895**  &nbsp;&nbsp; `337 stars this week`

1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    - A modular embodied agent architecture and platform for building embodied agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **608** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `162 stars this week`
...
1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,605** &nbsp;&nbsp; folks: **632**  &nbsp;&nbsp; `6,331 stars this month`
...
1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,453** &nbsp;&nbsp; folks: **755**  &nbsp;&nbsp; `2,150 stars this month`

1. [facebookresearch / ParlAI](https://github.com/facebookresearch/ParlAI)
    - A framework for training and evaluating AI models on a variety of openly available dialogue datasets.
    - language: **Python** &nbsp;&nbsp; stars: **8,156** &nbsp;&nbsp; folks: **1,621**  &nbsp;&nbsp; `879 stars this month`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **8,204** &nbsp;&nbsp; folks: **1,940**  &nbsp;&nbsp; `2,347 stars this month`
...
1. [shufflewzc / faker2](https://github.com/shufflewzc/faker2)
    - 不知名大佬备份
    - language: **JavaScript** &nbsp;&nbsp; stars: **827** &nbsp;&nbsp; folks: **399**  &nbsp;&nbsp; `738 stars this month`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **22,818** &nbsp;&nbsp; folks: **1,705**  &nbsp;&nbsp; `4,013 stars this month`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **8,668** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `2,575 stars this month`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,846** &nbsp;&nbsp; folks: **5,322**  &nbsp;&nbsp; `1,056 stars this month`

1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    - Open source distributed and RESTful search engine.
    - language: **Java** &nbsp;&nbsp; stars: **3,495** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `927 stars this month`
...
1. [yuzu-emu / yuzu](https://github.com/yuzu-emu/yuzu)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **15,885** &nbsp;&nbsp; folks: **1,346**  &nbsp;&nbsp; `891 stars this month`
...
1. [outline / outline](https://github.com/outline/outline)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,314** &nbsp;&nbsp; folks: **932**  &nbsp;&nbsp; `459 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,344** &nbsp;&nbsp; folks: **14,180**  &nbsp;&nbsp; `546 stars this month`

1. [avelino / awesome-go](https://github.com/avelino/awesome-go)
    - A curated list of awesome Go frameworks, libraries and software
    - language: **Go** &nbsp;&nbsp; stars: **67,080** &nbsp;&nbsp; folks: **8,764**  &nbsp;&nbsp; `1,518 stars this month`
...
1. [quii / learn-go-with-tests](https://github.com/quii/learn-go-with-tests)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,061** &nbsp;&nbsp; folks: **1,915**  &nbsp;&nbsp; `447 stars this month`
