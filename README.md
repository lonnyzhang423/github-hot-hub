...
1. [googlevr / tilt-brush](https://github.com/googlevr/tilt-brush)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **1,593** &nbsp;&nbsp; folks: **316**  &nbsp;&nbsp; `415 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,910** &nbsp;&nbsp; folks: **6,810**  &nbsp;&nbsp; `773 stars this week`

1. [StevenBlack / hosts](https://github.com/StevenBlack/hosts)
    - Consolidating and extending hosts files from several well-curated sources. You can optionally pick extensions to block pornography, social media, and other categories.
    - language: **Python** &nbsp;&nbsp; stars: **17,125** &nbsp;&nbsp; folks: **1,533**  &nbsp;&nbsp; `262 stars this week`

1. [chartjs / Chart.js](https://github.com/chartjs/Chart.js)
    - Simple HTML5 Charts using the <canvas> tag
    - language: **JavaScript** &nbsp;&nbsp; stars: **51,978** &nbsp;&nbsp; folks: **10,770**  &nbsp;&nbsp; `129 stars this week`

1. [hathach / tinyusb](https://github.com/hathach/tinyusb)
    - An open source cross-platform USB stack for embedded system
    - language: **C** &nbsp;&nbsp; stars: **1,449** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `73 stars this week`

1. [oblador / hush](https://github.com/oblador/hush)
    - Noiseless Browsing – Content Blocker for Safari
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,405** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `322 stars this week`
...
1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,769** &nbsp;&nbsp; folks: **1,325**  &nbsp;&nbsp; `305 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **10,540** &nbsp;&nbsp; folks: **3,323**  &nbsp;&nbsp; `561 stars this week`

1. [RustPython / RustPython](https://github.com/RustPython/RustPython)
    - A Python Interpreter written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **7,033** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `664 stars this week`

1. [peng-zhihui / HoloCubic](https://github.com/peng-zhihui/HoloCubic)
    - 透明小电视
    - language: **C** &nbsp;&nbsp; stars: **1,002** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `252 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,676** &nbsp;&nbsp; folks: **2,036**  &nbsp;&nbsp; `637 stars this week`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **30,400** &nbsp;&nbsp; folks: **3,876**  &nbsp;&nbsp; `478 stars this week`

1. [apache / arrow](https://github.com/apache/arrow)
    - Apache Arrow is a cross-language development platform for in-memory data. It specifies a standardized language-independent columnar memory format for flat and hierarchical data, organized for efficient analytic operations on modern hardware. It also provides computational libraries and zero-copy streaming messaging and interprocess communication…
    - language: **C++** &nbsp;&nbsp; stars: **7,089** &nbsp;&nbsp; folks: **1,779**  &nbsp;&nbsp; `119 stars this week`

1. [airbnb / lottie-ios](https://github.com/airbnb/lottie-ios)
    - An iOS library to natively render After Effects vector animations
    - language: **Swift** &nbsp;&nbsp; stars: **21,009** &nbsp;&nbsp; folks: **3,005**  &nbsp;&nbsp; `45 stars this week`

1. [wagoodman / dive](https://github.com/wagoodman/dive)
    - A tool for exploring each layer in a docker image
    - language: **Go** &nbsp;&nbsp; stars: **24,484** &nbsp;&nbsp; folks: **912**  &nbsp;&nbsp; `239 stars this week`
...
1. [directus / directus](https://github.com/directus/directus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,868** &nbsp;&nbsp; folks: **904**  &nbsp;&nbsp; `267 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,567** &nbsp;&nbsp; folks: **1,356**  &nbsp;&nbsp; `3,304 stars this month`

1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    - A private messenger for Android.
    - language: **Java** &nbsp;&nbsp; stars: **19,628** &nbsp;&nbsp; folks: **4,618**  &nbsp;&nbsp; `5,477 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,181** &nbsp;&nbsp; folks: **1,795**  &nbsp;&nbsp; `3,706 stars this month`

1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    - A private messenger for iOS.
    - language: **Swift** &nbsp;&nbsp; stars: **7,692** &nbsp;&nbsp; folks: **2,016**  &nbsp;&nbsp; `2,357 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,910** &nbsp;&nbsp; folks: **6,810**  &nbsp;&nbsp; `3,282 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,117** &nbsp;&nbsp; folks: **949**  &nbsp;&nbsp; `2,952 stars this month`
...
1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,534** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `861 stars this month`

1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,414** &nbsp;&nbsp; folks: **9,329**  &nbsp;&nbsp; `524 stars this month`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,676** &nbsp;&nbsp; folks: **2,036**  &nbsp;&nbsp; `2,585 stars this month`
...
1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,015** &nbsp;&nbsp; folks: **4,773**  &nbsp;&nbsp; `1,229 stars this month`
...
1. [WebKit / WebKit](https://github.com/WebKit/WebKit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **366** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `284 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,804** &nbsp;&nbsp; folks: **13,438**  &nbsp;&nbsp; `1,077 stars this month`

1. [HarisIqbal88 / PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet)
    - Latex code for making neural networks diagrams
    - language: **TeX** &nbsp;&nbsp; stars: **11,986** &nbsp;&nbsp; folks: **1,667**  &nbsp;&nbsp; `2,010 stars this month`

1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    - Chrome Extensions Samples
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,678** &nbsp;&nbsp; folks: **4,781**  &nbsp;&nbsp; `424 stars this month`

1. [brave / brave-browser](https://github.com/brave/brave-browser)
    - Next generation Brave browser for Android, Linux, macOS, Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,366** &nbsp;&nbsp; folks: **851**  &nbsp;&nbsp; `518 stars this month`

1. [jerry3747 / taobao_seckill](https://github.com/jerry3747/taobao_seckill)
    - 淘宝、天猫半价抢购，抢电视、抢茅台，干死黄牛党
    - language: **Python** &nbsp;&nbsp; stars: **802** &nbsp;&nbsp; folks: **636**  &nbsp;&nbsp; `552 stars this month`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,801** &nbsp;&nbsp; folks: **2,244**  &nbsp;&nbsp; `1,454 stars this month`

1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    - 大数据面试题，大数据成神之路开启...Flink/Spark/Hadoop/Hbase/Hive...
    - language: **无** &nbsp;&nbsp; stars: **3,769** &nbsp;&nbsp; folks: **1,325**  &nbsp;&nbsp; `473 stars this month`
