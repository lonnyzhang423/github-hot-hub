...
1. [gordicaleksa / pytorch-GAT](https://github.com/gordicaleksa/pytorch-GAT)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **380** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `147 stars today`
...
1. [daffainfo / AllAboutBugBounty](https://github.com/daffainfo/AllAboutBugBounty)
    ...
    - language: **无** &nbsp;&nbsp; stars: **381** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `180 stars today`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **C++** &nbsp;&nbsp; stars: **16,073** &nbsp;&nbsp; folks: **5,750**  &nbsp;&nbsp; `144 stars today`
...
1. [wesdoyle / design-patterns-explained-with-food](https://github.com/wesdoyle/design-patterns-explained-with-food)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **1,568** &nbsp;&nbsp; folks: **66**  &nbsp;&nbsp; `570 stars today`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **8,867** &nbsp;&nbsp; folks: **1,374**  &nbsp;&nbsp; `249 stars today`

1. [qier222 / YesPlayMusic](https://github.com/qier222/YesPlayMusic)
    - 高颜值的第三方网易云播放器，支持 Windows / macOS / Linux
    - language: **Vue** &nbsp;&nbsp; stars: **2,878** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `571 stars today`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,657** &nbsp;&nbsp; folks: **1,321**  &nbsp;&nbsp; `966 stars this week`
...
1. [oam-dev / kubevela](https://github.com/oam-dev/kubevela)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,297** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `83 stars this week`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,648** &nbsp;&nbsp; folks: **2,226**  &nbsp;&nbsp; `1,060 stars this week`

1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    - Deskreen turns any device with a web browser into a secondary screen for your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,722** &nbsp;&nbsp; folks: **152**  &nbsp;&nbsp; `2,353 stars this week`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,463** &nbsp;&nbsp; folks: **1,213**  &nbsp;&nbsp; `1,064 stars this week`

1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    - Free universal database tool and SQL client
    - language: **Java** &nbsp;&nbsp; stars: **18,304** &nbsp;&nbsp; folks: **1,660**  &nbsp;&nbsp; `255 stars this week`

1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    - 一站式Apache Kafka集群指标监控与运维管控平台
    - language: **Java** &nbsp;&nbsp; stars: **1,466** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `321 stars this week`
...
1. [milvus-io / milvus](https://github.com/milvus-io/milvus)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **5,004** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `63 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,745** &nbsp;&nbsp; folks: **6,785**  &nbsp;&nbsp; `3,129 stars this month`

1. [cehui0303 / Tmall_Tickets](https://github.com/cehui0303/Tmall_Tickets)
    - 天猫超市茅台抢票功能
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,848** &nbsp;&nbsp; folks: **1,778**  &nbsp;&nbsp; `1,271 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,828** &nbsp;&nbsp; folks: **935**  &nbsp;&nbsp; `2,747 stars this month`
...
1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,403** &nbsp;&nbsp; folks: **9,329**  &nbsp;&nbsp; `523 stars this month`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,550** &nbsp;&nbsp; folks: **2,001**  &nbsp;&nbsp; `2,507 stars this month`

1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    - 一站式Apache Kafka集群指标监控与运维管控平台
    - language: **Java** &nbsp;&nbsp; stars: **1,466** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `796 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,342** &nbsp;&nbsp; folks: **848**  &nbsp;&nbsp; `500 stars this month`
...
1. [didi / DoraemonKit](https://github.com/didi/DoraemonKit)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **16,647** &nbsp;&nbsp; folks: **2,363**  &nbsp;&nbsp; `534 stars this month`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **C++** &nbsp;&nbsp; stars: **16,073** &nbsp;&nbsp; folks: **5,750**  &nbsp;&nbsp; `715 stars this month`

1. [excalidraw / excalidraw](https://github.com/excalidraw/excalidraw)
    - Virtual whiteboard for sketching hand-drawn like diagrams
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,442** &nbsp;&nbsp; folks: **1,104**  &nbsp;&nbsp; `2,455 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **48,579** &nbsp;&nbsp; folks: **27,311**  &nbsp;&nbsp; `1,374 stars this month`

1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    - RandomX, CryptoNight, AstroBWT and Argon2 CPU/GPU miner
    - language: **C++** &nbsp;&nbsp; stars: **3,682** &nbsp;&nbsp; folks: **1,723**  &nbsp;&nbsp; `188 stars this month`
