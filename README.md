...
1. [ianhan / BitmapFonts](https://github.com/ianhan/BitmapFonts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **976** &nbsp;&nbsp; folks: **45**  &nbsp;&nbsp; `246 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **20,366** &nbsp;&nbsp; folks: **7,179**  &nbsp;&nbsp; `112 stars today`
...
1. [jasontaylordev / CleanArchitecture](https://github.com/jasontaylordev/CleanArchitecture)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,341** &nbsp;&nbsp; folks: **947**  &nbsp;&nbsp; `109 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,201** &nbsp;&nbsp; folks: **28,335**  &nbsp;&nbsp; `264 stars today`

1. [mobvoi / wenet](https://github.com/mobvoi/wenet)
    - Production First and Production Ready End-to-End Speech Recognition Toolkit
    - language: **Python** &nbsp;&nbsp; stars: **394** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `95 stars today`

1. [TheAlgorithms / C](https://github.com/TheAlgorithms/C)
    - Collection of various algorithms in mathematics, machine learning, computer science, physics, etc implemented in C for educational purposes.
    - language: **C** &nbsp;&nbsp; stars: **6,847** &nbsp;&nbsp; folks: **2,242**  &nbsp;&nbsp; `185 stars today`

1. [PaddlePaddle / VisualDL](https://github.com/PaddlePaddle/VisualDL)
    - Deep Learning Visualization Toolkit（『飞桨』深度学习可视化工具 ）
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,580** &nbsp;&nbsp; folks: **499**  &nbsp;&nbsp; `84 stars today`
...
1. [MicrosoftDocs / azure-docs](https://github.com/MicrosoftDocs/azure-docs)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **5,039** &nbsp;&nbsp; folks: **12,191**  &nbsp;&nbsp; `51 stars today`
...
1. [haizlin / fe-interview](https://github.com/haizlin/fe-interview)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,241** &nbsp;&nbsp; folks: **2,176**  &nbsp;&nbsp; `96 stars today`

1. [uo-ec607 / lectures](https://github.com/uo-ec607/lectures)
    - Lecture notes for EC 607
    - language: **HTML** &nbsp;&nbsp; stars: **733** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `18 stars today`
...
1. [MathInspector / MathInspector](https://github.com/MathInspector/MathInspector)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **588** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `114 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **3,510** &nbsp;&nbsp; folks: **1,041**  &nbsp;&nbsp; `992 stars this week`

1. [berty / berty](https://github.com/berty/berty)
    - Berty is a secure peer-to-peer messaging app that works with or without internet access, cellular data or trust in the network
    - language: **Go** &nbsp;&nbsp; stars: **3,744** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `1,405 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **10,989** &nbsp;&nbsp; folks: **3,365**  &nbsp;&nbsp; `1,114 stars this week`

1. [DinoZ1729 / Ray](https://github.com/DinoZ1729/Ray)
    - 无
    - language: **C++** &nbsp;&nbsp; stars: **413** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `165 stars this week`
...
1. [microsoft / terminal](https://github.com/microsoft/terminal)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **71,657** &nbsp;&nbsp; folks: **6,481**  &nbsp;&nbsp; `312 stars this week`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,475** &nbsp;&nbsp; folks: **3,881**  &nbsp;&nbsp; `504 stars this week`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,230** &nbsp;&nbsp; folks: **629**  &nbsp;&nbsp; `211 stars this week`

1. [tiangolo / full-stack-fastapi-postgresql](https://github.com/tiangolo/full-stack-fastapi-postgresql)
    - Full stack, modern web application generator. Using FastAPI, PostgreSQL as database, Docker, automatic HTTPS and more.
    - language: **Python** &nbsp;&nbsp; stars: **4,607** &nbsp;&nbsp; folks: **749**  &nbsp;&nbsp; `303 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,432** &nbsp;&nbsp; folks: **15,993**  &nbsp;&nbsp; `1,374 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **99,201** &nbsp;&nbsp; folks: **28,335**  &nbsp;&nbsp; `1,533 stars this week`
...
1. [shidenggui / easytrader](https://github.com/shidenggui/easytrader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,171** &nbsp;&nbsp; folks: **1,983**  &nbsp;&nbsp; `379 stars this week`
...
1. [jasontaylordev / CleanArchitecture](https://github.com/jasontaylordev/CleanArchitecture)
    - Clean Architecture Solution Template for Angular 10 and .NET 5
    - language: **C#** &nbsp;&nbsp; stars: **4,341** &nbsp;&nbsp; folks: **947**  &nbsp;&nbsp; `477 stars this week`
...
1. [explosion / spaCy](https://github.com/explosion/spaCy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,394** &nbsp;&nbsp; folks: **3,272**  &nbsp;&nbsp; `1,281 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,671** &nbsp;&nbsp; folks: **4,633**  &nbsp;&nbsp; `5,509 stars this month`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,595** &nbsp;&nbsp; folks: **1,361**  &nbsp;&nbsp; `3,333 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,221** &nbsp;&nbsp; folks: **1,805**  &nbsp;&nbsp; `3,739 stars this month`
...
1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,649** &nbsp;&nbsp; folks: **364**  &nbsp;&nbsp; `687 stars this month`

1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    - A chrome extension for suspending all tabs to free up memory
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,230** &nbsp;&nbsp; folks: **629**  &nbsp;&nbsp; `432 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,334** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `2,996 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,828** &nbsp;&nbsp; folks: **13,441**  &nbsp;&nbsp; `1,076 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,716** &nbsp;&nbsp; folks: **2,048**  &nbsp;&nbsp; `2,581 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,384** &nbsp;&nbsp; folks: **853**  &nbsp;&nbsp; `523 stars this month`
...
1. [jetlinks / jetlinks-community](https://github.com/jetlinks/jetlinks-community)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **978** &nbsp;&nbsp; folks: **365**  &nbsp;&nbsp; `269 stars this month`
