...
1. [r4j0x00 / exploits](https://github.com/r4j0x00/exploits)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **394** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `52 stars today`
...
1. [googlevr / tilt-brush](https://github.com/googlevr/tilt-brush)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **1,594** &nbsp;&nbsp; folks: **315**  &nbsp;&nbsp; `507 stars this week`
...
1. [alura-challenges / aluraquiz-base](https://github.com/alura-challenges/aluraquiz-base)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,366** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `470 stars this week`
...
1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,765** &nbsp;&nbsp; folks: **1,325**  &nbsp;&nbsp; `300 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **10,530** &nbsp;&nbsp; folks: **3,322**  &nbsp;&nbsp; `566 stars this week`

1. [RustPython / RustPython](https://github.com/RustPython/RustPython)
    - A Python Interpreter written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **7,033** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `658 stars this week`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,669** &nbsp;&nbsp; folks: **2,036**  &nbsp;&nbsp; `920 stars this week`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **30,398** &nbsp;&nbsp; folks: **3,876**  &nbsp;&nbsp; `477 stars this week`

1. [apache / arrow](https://github.com/apache/arrow)
    - Apache Arrow is a cross-language development platform for in-memory data. It specifies a standardized language-independent columnar memory format for flat and hierarchical data, organized for efficient analytic operations on modern hardware. It also provides computational libraries and zero-copy streaming messaging and interprocess communication…
    - language: **C++** &nbsp;&nbsp; stars: **7,084** &nbsp;&nbsp; folks: **1,779**  &nbsp;&nbsp; `86 stars this week`
...
1. [wagoodman / dive](https://github.com/wagoodman/dive)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,483** &nbsp;&nbsp; folks: **912**  &nbsp;&nbsp; `242 stars this week`

1. [inancgumus / learngo](https://github.com/inancgumus/learngo)
    - 1000+ Hand-Crafted Go Examples, Exercises, and Quizzes
    - language: **Go** &nbsp;&nbsp; stars: **8,134** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `209 stars this week`
...
1. [directus / directus](https://github.com/directus/directus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,869** &nbsp;&nbsp; folks: **904**  &nbsp;&nbsp; `218 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,567** &nbsp;&nbsp; folks: **1,355**  &nbsp;&nbsp; `3,304 stars this month`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,904** &nbsp;&nbsp; folks: **6,806**  &nbsp;&nbsp; `3,280 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,095** &nbsp;&nbsp; folks: **948**  &nbsp;&nbsp; `2,902 stars this month`
...
1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,528** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `853 stars this month`

1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,413** &nbsp;&nbsp; folks: **9,329**  &nbsp;&nbsp; `522 stars this month`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **C++** &nbsp;&nbsp; stars: **16,176** &nbsp;&nbsp; folks: **5,764**  &nbsp;&nbsp; `818 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,669** &nbsp;&nbsp; folks: **2,036**  &nbsp;&nbsp; `2,583 stars this month`
...
1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,012** &nbsp;&nbsp; folks: **4,771**  &nbsp;&nbsp; `1,335 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,801** &nbsp;&nbsp; folks: **13,438**  &nbsp;&nbsp; `1,076 stars this month`

1. [HarisIqbal88 / PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet)
    - Latex code for making neural networks diagrams
    - language: **TeX** &nbsp;&nbsp; stars: **11,984** &nbsp;&nbsp; folks: **1,668**  &nbsp;&nbsp; `2,014 stars this month`

1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    - Chrome Extensions Samples
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,676** &nbsp;&nbsp; folks: **4,781**  &nbsp;&nbsp; `424 stars this month`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,800** &nbsp;&nbsp; folks: **2,244**  &nbsp;&nbsp; `1,450 stars this month`

1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    - 大数据面试题，大数据成神之路开启...Flink/Spark/Hadoop/Hbase/Hive...
    - language: **无** &nbsp;&nbsp; stars: **3,765** &nbsp;&nbsp; folks: **1,325**  &nbsp;&nbsp; `462 stars this month`
...
1. [cehui0303 / Tmall_Tickets](https://github.com/cehui0303/Tmall_Tickets)
    - 天猫超市茅台抢票功能
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,888** &nbsp;&nbsp; folks: **1,810**  &nbsp;&nbsp; `1,144 stars this month`
