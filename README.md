...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,534** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `369 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,805** &nbsp;&nbsp; folks: **7,958**  &nbsp;&nbsp; `339 stars today`

1. [zellij-org / zellij](https://github.com/zellij-org/zellij)
    - A terminal workspace with batteries included
    - language: **Rust** &nbsp;&nbsp; stars: **2,133** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `559 stars today`
...
1. [ascoders / weekly](https://github.com/ascoders/weekly)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,068** &nbsp;&nbsp; folks: **1,379**  &nbsp;&nbsp; `208 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,249** &nbsp;&nbsp; folks: **430**  &nbsp;&nbsp; `170 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **179** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `76 stars today`
...
1. [gatsbyjs / gatsby](https://github.com/gatsbyjs/gatsby)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **49,958** &nbsp;&nbsp; folks: **9,494**  &nbsp;&nbsp; `103 stars today`

1. [microsoft / wslg](https://github.com/microsoft/wslg)
    - Enabling the Windows Subsystem for Linux to include support for Wayland and X server related scenarios
    - language: **C++** &nbsp;&nbsp; stars: **1,377** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `502 stars today`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **22,078** &nbsp;&nbsp; folks: **8,520**  &nbsp;&nbsp; `117 stars today`
...
1. [reactchartjs / react-chartjs-2](https://github.com/reactchartjs/react-chartjs-2)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,907** &nbsp;&nbsp; folks: **699**  &nbsp;&nbsp; `65 stars today`

1. [wilson1yan / VideoGPT](https://github.com/wilson1yan/VideoGPT)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **176** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `35 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,458** &nbsp;&nbsp; folks: **444**  &nbsp;&nbsp; `2,402 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,188** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `1,815 stars this week`
...
1. [ferib / D2R-Offline](https://github.com/ferib/D2R-Offline)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **488** &nbsp;&nbsp; folks: **82**  &nbsp;&nbsp; `298 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,939** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `1,406 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **294** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `174 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,164** &nbsp;&nbsp; folks: **45,665**  &nbsp;&nbsp; `2,366 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,242** &nbsp;&nbsp; folks: **4,806**  &nbsp;&nbsp; `1,023 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,805** &nbsp;&nbsp; folks: **7,958**  &nbsp;&nbsp; `2,075 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,749** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `390 stars this week`
...
1. [whittlem / pycryptobot](https://github.com/whittlem/pycryptobot)
    - Python Crypto Bot
    - language: **Python** &nbsp;&nbsp; stars: **184** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `46 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,458** &nbsp;&nbsp; folks: **444**  &nbsp;&nbsp; `3,679 stars this month`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,953** &nbsp;&nbsp; folks: **2,389**  &nbsp;&nbsp; `1,313 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,455** &nbsp;&nbsp; folks: **235**  &nbsp;&nbsp; `3,079 stars this month`
...
1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **660** &nbsp;&nbsp; folks: **643**  &nbsp;&nbsp; `211 stars this month`
...
1. [getify / You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS)
    ...
    - language: **无** &nbsp;&nbsp; stars: **136,689** &nbsp;&nbsp; folks: **27,188**  &nbsp;&nbsp; `1,992 stars this month`
