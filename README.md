...
1. [salesforce / Merlion](https://github.com/salesforce/Merlion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,613** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `999 stars this week`
...
1. [7eu7d7 / genshin_auto_fish](https://github.com/7eu7d7/genshin_auto_fish)
    - 基于深度强化学习的原神自动钓鱼AI
    - language: **Python** &nbsp;&nbsp; stars: **1,761** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `481 stars this week`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,010** &nbsp;&nbsp; folks: **927**  &nbsp;&nbsp; `404 stars this week`

1. [monicahq / monica](https://github.com/monicahq/monica)
    - Personal CRM. Remember everything about your friends, family and business relationships.
    - language: **PHP** &nbsp;&nbsp; stars: **14,109** &nbsp;&nbsp; folks: **1,528**  &nbsp;&nbsp; `799 stars this week`

1. [Lux-AI-Challenge / Lux-Design-2021](https://github.com/Lux-AI-Challenge/Lux-Design-2021)
    - Home to the design and engine of the @Lux-AI-Challenge Season 1, hosted on @Kaggle
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **686** &nbsp;&nbsp; folks: **105**  &nbsp;&nbsp; `176 stars this week`

1. [AriaMinaei / theatre](https://github.com/AriaMinaei/theatre)
    - Motion design editor for the web
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,036** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `817 stars this week`

1. [7kms / react-illustration-series](https://github.com/7kms/react-illustration-series)
    - 图解react源码, 用大量配图的方式, 致力于将react原理表述清楚.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,963** &nbsp;&nbsp; folks: **245**  &nbsp;&nbsp; `329 stars this week`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **20,110** &nbsp;&nbsp; folks: **4,295**  &nbsp;&nbsp; `195 stars this week`
...
1. [flipped-aurora / gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)
    - 基于vite+vue3+gin搭建的开发基础平台，集成jwt鉴权，权限管理，动态路由，分页封装，多点登录拦截，资源权限，上传下载，代码生成器，表单生成器等开发必备功能，五分钟一套CURD前后端代码，欢迎issue和pr~
    - language: **Go** &nbsp;&nbsp; stars: **9,699** &nbsp;&nbsp; folks: **2,732**  &nbsp;&nbsp; `342 stars this week`

1. [vuejs / petite-vue](https://github.com/vuejs/petite-vue)
    - 6kb subset of Vue optimized for progressive enhancement
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,821** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `248 stars this week`
...
1. [hashicorp / nomad](https://github.com/hashicorp/nomad)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **9,950** &nbsp;&nbsp; folks: **1,408**  &nbsp;&nbsp; `248 stars this week`
...
1. [Python-World / python-mini-projects](https://github.com/Python-World/python-mini-projects)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,434** &nbsp;&nbsp; folks: **1,244**  &nbsp;&nbsp; `3,589 stars this month`

1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    - Real-ESRGAN aims at developing Practical Algorithms for General Image Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **3,218** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `2,208 stars this month`

1. [shengcaishizhan / kkndme_tianya](https://github.com/shengcaishizhan/kkndme_tianya)
    - 天涯 kkndme 神贴聊房价
    - language: **无** &nbsp;&nbsp; stars: **3,797** &nbsp;&nbsp; folks: **767**  &nbsp;&nbsp; `1,736 stars this month`
...
1. [qier222 / YesPlayMusic](https://github.com/qier222/YesPlayMusic)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,338** &nbsp;&nbsp; folks: **1,475**  &nbsp;&nbsp; `1,678 stars this month`

1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    - 📚 Learn to write an embedded OS in Rust 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **6,490** &nbsp;&nbsp; folks: **371**  &nbsp;&nbsp; `1,429 stars this month`

1. [solana-labs / dapp-scaffold](https://github.com/solana-labs/dapp-scaffold)
    - Scaffolding for a dapp built on Solana
    - language: **TypeScript** &nbsp;&nbsp; stars: **592** &nbsp;&nbsp; folks: **231**  &nbsp;&nbsp; `357 stars this month`

1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    - Guide on Domain-Driven Design, Hexagonal architecture, best practices etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,634** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `1,056 stars this month`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,211** &nbsp;&nbsp; folks: **358**  &nbsp;&nbsp; `780 stars this month`

1. [robertdavidgraham / masscan](https://github.com/robertdavidgraham/masscan)
    - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
    - language: **C** &nbsp;&nbsp; stars: **17,482** &nbsp;&nbsp; folks: **2,564**  &nbsp;&nbsp; `1,709 stars this month`
...
1. [metaplex-foundation / metaplex](https://github.com/metaplex-foundation/metaplex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,261** &nbsp;&nbsp; folks: **2,293**  &nbsp;&nbsp; `800 stars this month`
...
1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,472** &nbsp;&nbsp; folks: **8,248**  &nbsp;&nbsp; `2,637 stars this month`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,269** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `895 stars this month`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,390** &nbsp;&nbsp; folks: **9,129**  &nbsp;&nbsp; `4,302 stars this month`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,538** &nbsp;&nbsp; folks: **2,455**  &nbsp;&nbsp; `2,255 stars this month`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **15,948** &nbsp;&nbsp; folks: **4,216**  &nbsp;&nbsp; `1,618 stars this month`
...
1. [containers / podman](https://github.com/containers/podman)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **10,555** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `1,785 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,579** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `3,822 stars this month`
