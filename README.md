...
`更新时间：2022-01-08 10:41:19 +0800`

## 今日热门仓库

1. [baidu / amis](https://github.com/baidu/amis)
    - 前端低代码框架，通过 JSON 配置就能生成各种页面。
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,420** &nbsp;&nbsp; folks: **1,265**  &nbsp;&nbsp; `73 stars today`

1. [Marak / faker.js](https://github.com/Marak/faker.js)
    - What really happened with Aaron Swartz?
    - language: **无** &nbsp;&nbsp; stars: **602** &nbsp;&nbsp; folks: **258**  &nbsp;&nbsp; `293 stars today`

1. [ascoders / weekly](https://github.com/ascoders/weekly)
    - 前端精读周刊。帮你理解最前沿、实用的技术。
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,327** &nbsp;&nbsp; folks: **2,005**  &nbsp;&nbsp; `84 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,152** &nbsp;&nbsp; folks: **2,610**  &nbsp;&nbsp; `297 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **无** &nbsp;&nbsp; stars: **587** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `172 stars today`

1. [aws / aws-cdk](https://github.com/aws/aws-cdk)
    - The AWS Cloud Development Kit is a framework for defining cloud infrastructure in code
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,051** &nbsp;&nbsp; folks: **2,163**  &nbsp;&nbsp; `27 stars today`
...
1. [apache / incubator-seatunnel](https://github.com/apache/incubator-seatunnel)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,647** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `675 stars this week`

1. [google / log4jscanner](https://github.com/google/log4jscanner)
    - A log4j vulnerability filesystem scanner and Go package for analyzing JAR files.
    - language: **Go** &nbsp;&nbsp; stars: **1,325** &nbsp;&nbsp; folks: **92**  &nbsp;&nbsp; `785 stars this week`
...
1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,405** &nbsp;&nbsp; folks: **2,778**  &nbsp;&nbsp; `240 stars this week`
...
1. [cypress-io / cypress](https://github.com/cypress-io/cypress)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,845** &nbsp;&nbsp; folks: **2,157**  &nbsp;&nbsp; `550 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,256** &nbsp;&nbsp; folks: **4,434**  &nbsp;&nbsp; `508 stars this week`
...
1. [baidu / amis](https://github.com/baidu/amis)
    - 前端低代码框架，通过 JSON 配置就能生成各种页面。
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,420** &nbsp;&nbsp; folks: **1,265**  &nbsp;&nbsp; `336 stars this week`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **4,513** &nbsp;&nbsp; folks: **801**  &nbsp;&nbsp; `230 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **183,864** &nbsp;&nbsp; folks: **22,556**  &nbsp;&nbsp; `1,479 stars this week`

1. [fanux / sealos](https://github.com/fanux/sealos)
    - 一条命令离线安装高可用 Kubernetes，3min 装完，500M，100年证书，版本不要太全，生产环境稳如老狗🔥 ⎈ 🐳
    - language: **Go** &nbsp;&nbsp; stars: **7,557** &nbsp;&nbsp; folks: **1,225**  &nbsp;&nbsp; `399 stars this week`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **134,027** &nbsp;&nbsp; folks: **20,125**  &nbsp;&nbsp; `341 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **7,290** &nbsp;&nbsp; folks: **5,192**  &nbsp;&nbsp; `145 stars this week`
...
1. [starship / starship](https://github.com/starship/starship)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **21,222** &nbsp;&nbsp; folks: **886**  &nbsp;&nbsp; `547 stars this week`
...
1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **65,927** &nbsp;&nbsp; folks: **3,039**  &nbsp;&nbsp; `370 stars this week`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,042** &nbsp;&nbsp; folks: **1,623**  &nbsp;&nbsp; `6,621 stars this month`

1. [ssssssss-team / spider-flow](https://github.com/ssssssss-team/spider-flow)
    - 新一代爬虫平台，以图形化方式定义爬虫流程，不写代码即可完成爬虫。
    - language: **Java** &nbsp;&nbsp; stars: **5,342** &nbsp;&nbsp; folks: **935**  &nbsp;&nbsp; `2,916 stars this month`

1. [ja-netfilter / ja-netfilter](https://github.com/ja-netfilter/ja-netfilter)
    - A javaagent framework
    - language: **Java** &nbsp;&nbsp; stars: **2,966** &nbsp;&nbsp; folks: **744**  &nbsp;&nbsp; `2,120 stars this month`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,463** &nbsp;&nbsp; folks: **1,891**  &nbsp;&nbsp; `4,357 stars this month`
...
1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **21,302** &nbsp;&nbsp; folks: **5,797**  &nbsp;&nbsp; `1,861 stars this month`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，Go，JavaScript等多语言版本，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **21,092** &nbsp;&nbsp; folks: **5,414**  &nbsp;&nbsp; `2,224 stars this month`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **15,881** &nbsp;&nbsp; folks: **1,098**  &nbsp;&nbsp; `3,711 stars this month`
...
1. [jynew / jynew](https://github.com/jynew/jynew)
    - 金庸群侠传3D重制版
    - language: **C#** &nbsp;&nbsp; stars: **3,995** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `1,466 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Roadmap to becoming a developer in 2022
    - language: **TypeScript** &nbsp;&nbsp; stars: **182,799** &nbsp;&nbsp; folks: **26,269**  &nbsp;&nbsp; `4,087 stars this month`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **134,027** &nbsp;&nbsp; folks: **20,125**  &nbsp;&nbsp; `1,492 stars this month`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,669** &nbsp;&nbsp; folks: **1,900**  &nbsp;&nbsp; `1,650 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **157,668** &nbsp;&nbsp; folks: **29,104**  &nbsp;&nbsp; `4,861 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,660** &nbsp;&nbsp; folks: **2,279**  &nbsp;&nbsp; `4,212 stars this month`

1. [lucidrains / vit-pytorch](https://github.com/lucidrains/vit-pytorch)
    - Implementation of Vision Transformer, a simple way to achieve SOTA in vision classification with only a single transformer encoder, in Pytorch
    - language: **Python** &nbsp;&nbsp; stars: **8,033** &nbsp;&nbsp; folks: **1,241**  &nbsp;&nbsp; `1,116 stars this month`
