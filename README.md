...
1. [authzed / spicedb](https://github.com/authzed/spicedb)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **753** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `236 stars today`
...
1. [twowaits / make-pull-request](https://github.com/twowaits/make-pull-request)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **402** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `156 stars today`

1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    - 🛁 Clean Code concepts adapted for JavaScript
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,492** &nbsp;&nbsp; folks: **7,295**  &nbsp;&nbsp; `139 stars today`

1. [ripienaar / free-for-dev](https://github.com/ripienaar/free-for-dev)
    - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
    - language: **HTML** &nbsp;&nbsp; stars: **49,336** &nbsp;&nbsp; folks: **5,331**  &nbsp;&nbsp; `208 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **121,054** &nbsp;&nbsp; folks: **19,883**  &nbsp;&nbsp; `261 stars today`
...
1. [vinitshahdeo / Hacktoberfest2021](https://github.com/vinitshahdeo/Hacktoberfest2021)
    ...
    - language: **无** &nbsp;&nbsp; stars: **514** &nbsp;&nbsp; folks: **431**  &nbsp;&nbsp; `57 stars today`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **15,746** &nbsp;&nbsp; folks: **1,609**  &nbsp;&nbsp; `15 stars today`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,532** &nbsp;&nbsp; folks: **8,254**  &nbsp;&nbsp; `99 stars today`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **5,407** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `222 stars today`

1. [Ganapati / RsaCtfTool](https://github.com/Ganapati/RsaCtfTool)
    - RSA attack tool (mainly for ctf) - retreive private key from weak public key and/or uncipher data
    - language: **Python** &nbsp;&nbsp; stars: **2,830** &nbsp;&nbsp; folks: **584**  &nbsp;&nbsp; `15 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,609** &nbsp;&nbsp; folks: **2,459**  &nbsp;&nbsp; `145 stars today`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,082** &nbsp;&nbsp; folks: **942**  &nbsp;&nbsp; `468 stars this week`

1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    - Build completely custom admin panels and internal tools. Use 30+ react components to build pages without HTML/CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,095** &nbsp;&nbsp; folks: **588**  &nbsp;&nbsp; `499 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **170,731** &nbsp;&nbsp; folks: **21,741**  &nbsp;&nbsp; `918 stars this week`

1. [7eu7d7 / genshin_auto_fish](https://github.com/7eu7d7/genshin_auto_fish)
    - 基于深度强化学习的原神自动钓鱼AI
    - language: **Python** &nbsp;&nbsp; stars: **1,780** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `411 stars this week`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,142** &nbsp;&nbsp; folks: **1,324**  &nbsp;&nbsp; `785 stars this week`

1. [waydroid / waydroid](https://github.com/waydroid/waydroid)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,183** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `799 stars this week`
...
1. [grpc / grpc](https://github.com/grpc/grpc)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **31,994** &nbsp;&nbsp; folks: **8,379**  &nbsp;&nbsp; `94 stars this week`

1. [unknwon / the-way-to-go_ZH_CN](https://github.com/unknwon/the-way-to-go_ZH_CN)
    - 《The Way to Go》中文译本，中文正式名《Go 入门指南》
    - language: **Go** &nbsp;&nbsp; stars: **27,423** &nbsp;&nbsp; folks: **7,455**  &nbsp;&nbsp; `389 stars this week`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,712** &nbsp;&nbsp; folks: **2,163**  &nbsp;&nbsp; `8,719 stars this month`

1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    - Real-ESRGAN aims at developing Practical Algorithms for General Image Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **3,244** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `2,148 stars this month`

1. [authelia / authelia](https://github.com/authelia/authelia)
    - The Single Sign-On Multi-Factor portal for web apps
    - language: **Go** &nbsp;&nbsp; stars: **10,120** &nbsp;&nbsp; folks: **497**  &nbsp;&nbsp; `3,213 stars this month`
...
1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    - Guide on Domain-Driven Design, Hexagonal architecture, best practices etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,649** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `1,067 stars this month`

1. [shengcaishizhan / kkndme_tianya](https://github.com/shengcaishizhan/kkndme_tianya)
    - 天涯 kkndme 神贴聊房价
    - language: **无** &nbsp;&nbsp; stars: **3,804** &nbsp;&nbsp; folks: **770**  &nbsp;&nbsp; `1,643 stars this month`
...
1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    - 📚 Learn to write an embedded OS in Rust 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **6,503** &nbsp;&nbsp; folks: **372**  &nbsp;&nbsp; `1,440 stars this month`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,213** &nbsp;&nbsp; folks: **358**  &nbsp;&nbsp; `749 stars this month`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **9,185** &nbsp;&nbsp; folks: **2,026**  &nbsp;&nbsp; `1,015 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,408** &nbsp;&nbsp; folks: **9,134**  &nbsp;&nbsp; `4,300 stars this month`

1. [0voice / Introduction-to-Golang](https://github.com/0voice/Introduction-to-Golang)
    - 【未来服务器端编程语言】最全空降golang资料补给包（满血战斗），包含文章，书籍，作者论文，理论分析，开源框架，云原生，大佬视频，大厂实战分享ppt
    - language: **无** &nbsp;&nbsp; stars: **3,300** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `1,639 stars this month`

1. [pyg-team / pytorch_geometric](https://github.com/pyg-team/pytorch_geometric)
    - Graph Neural Network Library for PyTorch
    - language: **Python** &nbsp;&nbsp; stars: **12,637** &nbsp;&nbsp; folks: **2,155**  &nbsp;&nbsp; `856 stars this month`
...
1. [metaplex-foundation / metaplex](https://github.com/metaplex-foundation/metaplex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,271** &nbsp;&nbsp; folks: **2,311**  &nbsp;&nbsp; `776 stars this month`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,532** &nbsp;&nbsp; folks: **8,254**  &nbsp;&nbsp; `2,665 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,609** &nbsp;&nbsp; folks: **2,459**  &nbsp;&nbsp; `2,167 stars this month`

1. [containers / podman](https://github.com/containers/podman)
    - Podman: A tool for managing OCI containers and pods.
    - language: **Go** &nbsp;&nbsp; stars: **10,566** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `1,650 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,594** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `3,773 stars this month`
...
1. [PySimpleGUI / PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,401** &nbsp;&nbsp; folks: **1,235**  &nbsp;&nbsp; `1,369 stars this month`
