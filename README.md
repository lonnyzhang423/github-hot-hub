...
1. [yuchenlin / rebiber](https://github.com/yuchenlin/rebiber)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **662** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `153 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,131** &nbsp;&nbsp; folks: **1,148**  &nbsp;&nbsp; `185 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,147** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `132 stars today`

1. [qutebrowser / qutebrowser](https://github.com/qutebrowser/qutebrowser)
    - A keyboard-driven, vim-like browser based on PyQt5.
    - language: **Python** &nbsp;&nbsp; stars: **6,283** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `45 stars today`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,533** &nbsp;&nbsp; folks: **977**  &nbsp;&nbsp; `102 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **74,218** &nbsp;&nbsp; folks: **10,730**  &nbsp;&nbsp; `94 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **308** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `50 stars today`
...
1. [alura-challenges / aluraquiz-base](https://github.com/alura-challenges/aluraquiz-base)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,163** &nbsp;&nbsp; folks: **463**  &nbsp;&nbsp; `127 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,499** &nbsp;&nbsp; folks: **20,999**  &nbsp;&nbsp; `11 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,170** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `4,318 stars this week`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,506** &nbsp;&nbsp; folks: **6,756**  &nbsp;&nbsp; `2,186 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,398** &nbsp;&nbsp; folks: **1,979**  &nbsp;&nbsp; `1,716 stars this week`

1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    - Secure and fast microVMs for serverless computing.
    - language: **Rust** &nbsp;&nbsp; stars: **14,373** &nbsp;&nbsp; folks: **973**  &nbsp;&nbsp; `801 stars this week`
...
1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,589** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `465 stars this week`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,648** &nbsp;&nbsp; folks: **13,388**  &nbsp;&nbsp; `499 stars this week`
...
1. [microsoft / DeepSpeed](https://github.com/microsoft/DeepSpeed)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,188** &nbsp;&nbsp; folks: **390**  &nbsp;&nbsp; `188 stars this week`

1. [microsoft / windows-rs](https://github.com/microsoft/windows-rs)
    - Rust for Windows
    - language: **Rust** &nbsp;&nbsp; stars: **4,111** &nbsp;&nbsp; folks: **99**  &nbsp;&nbsp; `1,242 stars this week`

1. [Marak / faker.js](https://github.com/Marak/faker.js)
    - generate massive amounts of realistic fake data in Node.js and the browser
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,544** &nbsp;&nbsp; folks: **2,600**  &nbsp;&nbsp; `639 stars this week`
...
1. [laravel / framework](https://github.com/laravel/framework)
    - 无
    - language: **PHP** &nbsp;&nbsp; stars: **23,309** &nbsp;&nbsp; folks: **7,900**  &nbsp;&nbsp; `282 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,147** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `386 stars this week`
...
1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **18,224** &nbsp;&nbsp; folks: **1,647**  &nbsp;&nbsp; `279 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,476** &nbsp;&nbsp; folks: **4,586**  &nbsp;&nbsp; `5,302 stars this month`

1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    - Server supporting the Signal Private Messenger applications on Android, Desktop, and iOS
    - language: **Java** &nbsp;&nbsp; stars: **5,467** &nbsp;&nbsp; folks: **1,337**  &nbsp;&nbsp; `3,200 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,076** &nbsp;&nbsp; folks: **1,782**  &nbsp;&nbsp; `3,621 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,421** &nbsp;&nbsp; folks: **173**  &nbsp;&nbsp; `3,296 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,497** &nbsp;&nbsp; folks: **913**  &nbsp;&nbsp; `2,454 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,506** &nbsp;&nbsp; folks: **6,756**  &nbsp;&nbsp; `2,854 stars this month`

1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    - Matrix (An open network for secure, decentralized communication) server setup using Ansible and Docker
    - language: **HTML** &nbsp;&nbsp; stars: **1,589** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `646 stars this month`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,398** &nbsp;&nbsp; folks: **1,979**  &nbsp;&nbsp; `2,213 stars this month`
...
1. [thecodingmachine / workadventure](https://github.com/thecodingmachine/workadventure)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,043** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `783 stars this month`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,580** &nbsp;&nbsp; folks: **1,227**  &nbsp;&nbsp; `249 stars this month`

1. [GoogleChrome / chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples)
    - Chrome Extensions Samples
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,605** &nbsp;&nbsp; folks: **4,751**  &nbsp;&nbsp; `393 stars this month`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of 5000+ publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,167** &nbsp;&nbsp; folks: **681**  &nbsp;&nbsp; `2,502 stars this month`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **48,340** &nbsp;&nbsp; folks: **27,263**  &nbsp;&nbsp; `1,262 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,292** &nbsp;&nbsp; folks: **849**  &nbsp;&nbsp; `464 stars this month`

1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    - Your self-hosted, globally interconnected microblogging community
    - language: **Ruby** &nbsp;&nbsp; stars: **23,583** &nbsp;&nbsp; folks: **3,907**  &nbsp;&nbsp; `1,101 stars this month`
