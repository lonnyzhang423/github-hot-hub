...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,026** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `52 stars today`

1. [NVlabs / SegFormer](https://github.com/NVlabs/SegFormer)
    - Official implementation of "SegFormer: Simple and Efficient Design for Semantic Segmentation with Transformers"
    - language: **Python** &nbsp;&nbsp; stars: **212** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `70 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **5,424** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `102 stars today`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    - Bee is a Swarm client implemented in Go. It’s the basic building block for the Swarm network: a private; decentralized; censorship-resistant and self-sustaining network for storing your (application) data.
    - language: **Go** &nbsp;&nbsp; stars: **1,026** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `803 stars this month`
...
1. [deepfakes / faceswap](https://github.com/deepfakes/faceswap)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,257** &nbsp;&nbsp; folks: **10,978**  &nbsp;&nbsp; `2,182 stars this month`

1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    - Fig adds autocomplete to your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,322** &nbsp;&nbsp; folks: **486**  &nbsp;&nbsp; `2,095 stars this month`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **181,048** &nbsp;&nbsp; folks: **48,959**  &nbsp;&nbsp; `11,879 stars this month`

1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **6,606** &nbsp;&nbsp; folks: **1,439**  &nbsp;&nbsp; `1,392 stars this month`

1. [microsoft / winget-pkgs](https://github.com/microsoft/winget-pkgs)
    - The Microsoft community Windows Package Manager manifest repository
    - language: **PowerShell** &nbsp;&nbsp; stars: **4,394** &nbsp;&nbsp; folks: **1,423**  &nbsp;&nbsp; `945 stars this month`

1. [microsoft / winget-cli](https://github.com/microsoft/winget-cli)
    - Windows Package Manager CLI (aka winget)
    - language: **C++** &nbsp;&nbsp; stars: **13,871** &nbsp;&nbsp; folks: **629**  &nbsp;&nbsp; `2,175 stars this month`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **5,726** &nbsp;&nbsp; folks: **1,161**  &nbsp;&nbsp; `1,792 stars this month`
...
1. [academind / react-complete-guide-code](https://github.com/academind/react-complete-guide-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **717** &nbsp;&nbsp; folks: **1,426**  &nbsp;&nbsp; `356 stars this month`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **17,946** &nbsp;&nbsp; folks: **4,049**  &nbsp;&nbsp; `918 stars this month`

1. [taosdata / TDengine](https://github.com/taosdata/TDengine)
    - An open-source big data platform designed and optimized for the Internet of Things (IoT).
    - language: **C** &nbsp;&nbsp; stars: **15,389** &nbsp;&nbsp; folks: **3,898**  &nbsp;&nbsp; `557 stars this month`
...
1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Shell** &nbsp;&nbsp; stars: **4,039** &nbsp;&nbsp; folks: **1,025**  &nbsp;&nbsp; `712 stars this month`

1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    - All Algorithms implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **39,019** &nbsp;&nbsp; folks: **12,805**  &nbsp;&nbsp; `1,746 stars this month`

1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,238** &nbsp;&nbsp; folks: **2,178**  &nbsp;&nbsp; `812 stars this month`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **5,424** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `3,228 stars this month`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,778** &nbsp;&nbsp; folks: **341**  &nbsp;&nbsp; `422 stars this month`
...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **132,253** &nbsp;&nbsp; folks: **42,530**  &nbsp;&nbsp; `3,953 stars this month`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **JavaScript** &nbsp;&nbsp; stars: **151,225** &nbsp;&nbsp; folks: **73,671**  &nbsp;&nbsp; `1,367 stars this month`
