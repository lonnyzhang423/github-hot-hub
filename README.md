...
1. [EleutherAI / gpt-neo](https://github.com/EleutherAI/gpt-neo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,067** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `1,453 stars today`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **8,913** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `2,069 stars this week`

1. [LukeSmithxyz / based.cooking](https://github.com/LukeSmithxyz/based.cooking)
    - A simple culinary website.
    - language: **Makefile** &nbsp;&nbsp; stars: **1,000** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `544 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **810** &nbsp;&nbsp; folks: **81**  &nbsp;&nbsp; `418 stars this week`

1. [521xueweihan / GitHub520](https://github.com/521xueweihan/GitHub520)
    - 😘 让你“爱”上 GitHub，解决访问时图裂、加载慢的问题。（无需安装）
    - language: **Python** &nbsp;&nbsp; stars: **4,071** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `1,230 stars this week`
...
1. [benhoyt / countwords](https://github.com/benhoyt/countwords)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **141** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `48 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    - Awesome Docker Compose samples
    - language: **HTML** &nbsp;&nbsp; stars: **8,913** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `4,648 stars this month`

1. [alievk / avatarify-python](https://github.com/alievk/avatarify-python)
    - Avatars for Zoom, Skype and other video-conferencing apps.
    - language: **Python** &nbsp;&nbsp; stars: **13,057** &nbsp;&nbsp; folks: **1,858**  &nbsp;&nbsp; `3,126 stars this month`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,663** &nbsp;&nbsp; folks: **846**  &nbsp;&nbsp; `3,817 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run Mac in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X!
    - language: **Shell** &nbsp;&nbsp; stars: **12,480** &nbsp;&nbsp; folks: **545**  &nbsp;&nbsp; `3,907 stars this month`

1. [jart / cosmopolitan](https://github.com/jart/cosmopolitan)
    - fast portable static native textmode containers
    - language: **C** &nbsp;&nbsp; stars: **4,353** &nbsp;&nbsp; folks: **114**  &nbsp;&nbsp; `3,061 stars this month`

1. [android / compose-samples](https://github.com/android/compose-samples)
    - Official Jetpack Compose samples.
    - language: **Kotlin** &nbsp;&nbsp; stars: **6,373** &nbsp;&nbsp; folks: **1,094**  &nbsp;&nbsp; `1,302 stars this month`

1. [AliaksandrSiarohin / first-order-model](https://github.com/AliaksandrSiarohin/first-order-model)
    - This repository contains the source code for the paper First Order Motion Model for Image Animation
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,594** &nbsp;&nbsp; folks: **2,226**  &nbsp;&nbsp; `1,335 stars this month`

1. [authelia / authelia](https://github.com/authelia/authelia)
    - The Single Sign-On Multi-Factor portal for web apps
    - language: **Go** &nbsp;&nbsp; stars: **5,497** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `2,520 stars this month`
...
1. [liamg / traitor](https://github.com/liamg/traitor)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,991** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `1,893 stars this month`

1. [grishka / Houseclub](https://github.com/grishka/Houseclub)
    - A barebones unofficial Android app for Clubhouse
    - language: **Java** &nbsp;&nbsp; stars: **2,339** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `1,147 stars this month`

1. [google / model_search](https://github.com/google/model_search)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,903** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,543 stars this month`

1. [iperov / DeepFaceLab](https://github.com/iperov/DeepFaceLab)
    - DeepFaceLab is the leading software for creating deepfakes.
    - language: **Python** &nbsp;&nbsp; stars: **25,366** &nbsp;&nbsp; folks: **5,668**  &nbsp;&nbsp; `1,984 stars this month`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **7,787** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `1,566 stars this month`

1. [orkestral / venom](https://github.com/orkestral/venom)
    - Venom is the most complete javascript library for Whatsapp, 100% Open Source.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,321** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `1,227 stars this month`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **21,636** &nbsp;&nbsp; folks: **5,394**  &nbsp;&nbsp; `1,591 stars this month`

1. [pyroscope-io / pyroscope](https://github.com/pyroscope-io/pyroscope)
    - 🔥 Continuous Profiling Platform 🔥 Debug performance issues down to a single line of code
    - language: **Go** &nbsp;&nbsp; stars: **3,089** &nbsp;&nbsp; folks: **116**  &nbsp;&nbsp; `2,136 stars this month`
...
1. [lloesche / valheim-server-docker](https://github.com/lloesche/valheim-server-docker)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **691** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `468 stars this month`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **100,267** &nbsp;&nbsp; folks: **34,538**  &nbsp;&nbsp; `2,723 stars this month`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - 🔎 Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **23,503** &nbsp;&nbsp; folks: **2,351**  &nbsp;&nbsp; `2,894 stars this month`

1. [pancakeswap / pancake-frontend](https://github.com/pancakeswap/pancake-frontend)
    - 🥞 Pancake main features (farms, pools, IFO, lottery, profiles)
    - language: **TypeScript** &nbsp;&nbsp; stars: **192** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `106 stars this month`

1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    - Guide on Domain-Driven Design, Hexagonal architecture, best practices etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,883** &nbsp;&nbsp; folks: **117**  &nbsp;&nbsp; `976 stars this month`

1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    - 基于代码生成器的低代码平台，超越传统商业平台！前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis-plus，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新低代码开发模式OnlineCoding->代码生成->手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高开发效率，帮助公司节省成本，同时又不失灵活性。
    - language: **Java** &nbsp;&nbsp; stars: **21,050** &nbsp;&nbsp; folks: **8,123**  &nbsp;&nbsp; `1,564 stars this month`

1. [stefan-jansen / machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading)
    - Code for Machine Learning for Algorithmic Trading, 2nd edition.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,341** &nbsp;&nbsp; folks: **1,040**  &nbsp;&nbsp; `1,448 stars this month`

1. [github / codeql](https://github.com/github/codeql)
    - CodeQL: the libraries and queries that power security researchers around the world, as well as code scanning in GitHub Advanced Security (code scanning), LGTM.com, and LGTM Enterprise
    - language: **CodeQL** &nbsp;&nbsp; stars: **2,465** &nbsp;&nbsp; folks: **514**  &nbsp;&nbsp; `461 stars this month`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **116,759** &nbsp;&nbsp; folks: **16,619**  &nbsp;&nbsp; `3,439 stars this month`
