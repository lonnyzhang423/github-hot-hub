...
1. [ascoders / weekly](https://github.com/ascoders/weekly)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,062** &nbsp;&nbsp; folks: **1,379**  &nbsp;&nbsp; `190 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,246** &nbsp;&nbsp; folks: **429**  &nbsp;&nbsp; `168 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **175** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `101 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,874** &nbsp;&nbsp; folks: **1,397**  &nbsp;&nbsp; `1,481 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,454** &nbsp;&nbsp; folks: **444**  &nbsp;&nbsp; `2,411 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,187** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `1,879 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,281** &nbsp;&nbsp; folks: **60**  &nbsp;&nbsp; `391 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,928** &nbsp;&nbsp; folks: **568**  &nbsp;&nbsp; `1,488 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **293** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `173 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,157** &nbsp;&nbsp; folks: **45,664**  &nbsp;&nbsp; `2,397 stars this week`

1. [peterq / pan-light](https://github.com/peterq/pan-light)
    - 百度网盘不限速客户端, golang + qt5, 跨平台图形界面
    - language: **Go** &nbsp;&nbsp; stars: **11,484** &nbsp;&nbsp; folks: **2,465**  &nbsp;&nbsp; `308 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,231** &nbsp;&nbsp; folks: **4,805**  &nbsp;&nbsp; `1,017 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,793** &nbsp;&nbsp; folks: **7,957**  &nbsp;&nbsp; `1,971 stars this week`
...
1. [CSSEGISandData / COVID-19](https://github.com/CSSEGISandData/COVID-19)
    ...
    - language: **无** &nbsp;&nbsp; stars: **26,329** &nbsp;&nbsp; folks: **16,836**  &nbsp;&nbsp; `238 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,746** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `359 stars this week`

1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    - RandomX, CryptoNight, AstroBWT and Argon2 CPU/GPU miner
    - language: **C++** &nbsp;&nbsp; stars: **4,560** &nbsp;&nbsp; folks: **2,113**  &nbsp;&nbsp; `142 stars this week`
...
1. [PaddlePaddle / PaddleGAN](https://github.com/PaddlePaddle/PaddleGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,977** &nbsp;&nbsp; folks: **468**  &nbsp;&nbsp; `324 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,454** &nbsp;&nbsp; folks: **444**  &nbsp;&nbsp; `3,675 stars this month`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,952** &nbsp;&nbsp; folks: **2,389**  &nbsp;&nbsp; `1,313 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,452** &nbsp;&nbsp; folks: **235**  &nbsp;&nbsp; `3,077 stars this month`
...
1. [zhangdaiscott / JimuReport](https://github.com/zhangdaiscott/JimuReport)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,251** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `640 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,793** &nbsp;&nbsp; folks: **7,957**  &nbsp;&nbsp; `3,235 stars this month`
...
1. [getify / You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS)
    ...
    - language: **无** &nbsp;&nbsp; stars: **136,685** &nbsp;&nbsp; folks: **27,187**  &nbsp;&nbsp; `1,988 stars this month`
