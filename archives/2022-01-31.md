...
`最后更新时间：2022-01-31 04:09:43 +0800`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **527** &nbsp;&nbsp; folks: **55**  &nbsp;&nbsp; `36 stars today`
...
1. [PGYER / codefever](https://github.com/PGYER/codefever)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **524** &nbsp;&nbsp; folks: **76**  &nbsp;&nbsp; `59 stars today`

1. [obsproject / obs-studio](https://github.com/obsproject/obs-studio)
    - OBS Studio - Free and open source software for live streaming and screen recording
    - language: **C** &nbsp;&nbsp; stars: **35,648** &nbsp;&nbsp; folks: **5,578**  &nbsp;&nbsp; `36 stars today`

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **16,035** &nbsp;&nbsp; folks: **778**  &nbsp;&nbsp; `123 stars today`

1. [dgraph-io / dgraph](https://github.com/dgraph-io/dgraph)
    - Native GraphQL Database with graph backend
    - language: **Go** &nbsp;&nbsp; stars: **17,432** &nbsp;&nbsp; folks: **1,290**  &nbsp;&nbsp; `103 stars today`

1. [scaffold-eth / scaffold-eth](https://github.com/scaffold-eth/scaffold-eth)
    - 🏗 forkable Ethereum dev stack focused on fast product iterations
    - language: **CSS** &nbsp;&nbsp; stars: **5,482** &nbsp;&nbsp; folks: **1,767**  &nbsp;&nbsp; `13 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,275** &nbsp;&nbsp; folks: **40,291**  &nbsp;&nbsp; `7 stars today`
...
1. [veler / DevToys](https://github.com/veler/DevToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,074** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `3,772 stars this week`
...
1. [khuedoan / homelab](https://github.com/khuedoan/homelab)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,985** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `1,741 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **178,426** &nbsp;&nbsp; folks: **20,546**  &nbsp;&nbsp; `1,756 stars this week`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,933** &nbsp;&nbsp; folks: **2,932**  &nbsp;&nbsp; `422 stars this week`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **52,827** &nbsp;&nbsp; folks: **4,408**  &nbsp;&nbsp; `822 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,301** &nbsp;&nbsp; folks: **5,547**  &nbsp;&nbsp; `656 stars this week`
...
1. [yuzu-emu / yuzu](https://github.com/yuzu-emu/yuzu)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **18,432** &nbsp;&nbsp; folks: **1,554**  &nbsp;&nbsp; `569 stars this week`

1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    - Project Cider. A new look into listening and enjoying Apple Music in style and performance. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **527** &nbsp;&nbsp; folks: **55**  &nbsp;&nbsp; `132 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **11,110** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `360 stars this week`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **C** &nbsp;&nbsp; stars: **126,044** &nbsp;&nbsp; folks: **41,168**  &nbsp;&nbsp; `1,607 stars this week`
...
1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,150** &nbsp;&nbsp; folks: **9,045**  &nbsp;&nbsp; `801 stars this week`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,662** &nbsp;&nbsp; folks: **1,119**  &nbsp;&nbsp; `362 stars this week`

1. [abiosoft / colima](https://github.com/abiosoft/colima)
    - Container runtimes on macOS (and Linux) with minimal setup
    - language: **Go** &nbsp;&nbsp; stars: **1,951** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `533 stars this week`

1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    - A Python framework for creating reproducible, maintainable and modular data science code.
    - language: **Python** &nbsp;&nbsp; stars: **6,339** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `937 stars this week`

1. [microsoft / playwright](https://github.com/microsoft/playwright)
    - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,628** &nbsp;&nbsp; folks: **1,473**  &nbsp;&nbsp; `1,058 stars this week`

1. [scikit-learn / scikit-learn](https://github.com/scikit-learn/scikit-learn)
    - scikit-learn: machine learning in Python
    - language: **Python** &nbsp;&nbsp; stars: **48,835** &nbsp;&nbsp; folks: **22,577**  &nbsp;&nbsp; `239 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,074** &nbsp;&nbsp; folks: **3,101**  &nbsp;&nbsp; `3,724 stars this month`

1. [files-community / Files](https://github.com/files-community/Files)
    - A modern file manager for Windows
    - language: **C#** &nbsp;&nbsp; stars: **19,254** &nbsp;&nbsp; folks: **1,051**  &nbsp;&nbsp; `3,995 stars this month`
...
1. [adrianhajdin / project_web3.0](https://github.com/adrianhajdin/project_web3.0)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,285** &nbsp;&nbsp; folks: **260**  &nbsp;&nbsp; `1,068 stars this month`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **11,819** &nbsp;&nbsp; folks: **2,228**  &nbsp;&nbsp; `2,506 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **29,781** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `4,360 stars this month`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **13,853** &nbsp;&nbsp; folks: **1,243**  &nbsp;&nbsp; `1,374 stars this month`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,592** &nbsp;&nbsp; folks: **1,833**  &nbsp;&nbsp; `1,119 stars this month`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **6,644** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `3,221 stars this month`

1. [Textualize / rich](https://github.com/Textualize/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **34,426** &nbsp;&nbsp; folks: **1,108**  &nbsp;&nbsp; `2,668 stars this month`

1. [withastro / astro](https://github.com/withastro/astro)
    - Build fast websites, faster. 🚀🧑‍🚀✨
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,149** &nbsp;&nbsp; folks: **493**  &nbsp;&nbsp; `1,450 stars this month`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,351** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `1,499 stars this month`
...
1. [containers / podman](https://github.com/containers/podman)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **12,196** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `658 stars this month`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,933** &nbsp;&nbsp; folks: **2,932**  &nbsp;&nbsp; `835 stars this month`

1. [dwyl / english-words](https://github.com/dwyl/english-words)
    - 📝 A text file containing 479k English words for all your dictionary/word-based projects e.g: auto-completion / autosuggestion
    - language: **Python** &nbsp;&nbsp; stars: **6,251** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `404 stars this month`

1. [TandoorRecipes / recipes](https://github.com/TandoorRecipes/recipes)
    - Application for managing recipes, planning meals, building shopping lists and much much more!
    - language: **HTML** &nbsp;&nbsp; stars: **2,561** &nbsp;&nbsp; folks: **208**  &nbsp;&nbsp; `598 stars this month`
