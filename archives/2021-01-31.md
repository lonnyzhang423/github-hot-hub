...
`最后更新时间：2021-01-31 17:11:17 +0800`

## 今日热门仓库

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,898** &nbsp;&nbsp; folks: **1,004**  &nbsp;&nbsp; `307 stars today`

1. [evilsocket / ditto](https://github.com/evilsocket/ditto)
    - A tool for IDN homograph attacks and detection.
    - language: **Go** &nbsp;&nbsp; stars: **261** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `111 stars today`

1. [bullhe4d / bigwatermelon](https://github.com/bullhe4d/bigwatermelon)
    - 合成大西瓜源码,修改版
    - language: **JavaScript** &nbsp;&nbsp; stars: **409** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `172 stars today`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,346** &nbsp;&nbsp; folks: **2,203**  &nbsp;&nbsp; `323 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,401** &nbsp;&nbsp; folks: **1,180**  &nbsp;&nbsp; `377 stars today`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,731** &nbsp;&nbsp; folks: **485**  &nbsp;&nbsp; `46 stars today`
...
1. [yeungon / In-JavaScript-we-trust](https://github.com/yeungon/In-JavaScript-we-trust)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **405** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `35 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **8,582** &nbsp;&nbsp; folks: **21,004**  &nbsp;&nbsp; `65 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,310** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `187 stars today`
...
1. [ErickWendel / semana-javascript-expert02](https://github.com/ErickWendel/semana-javascript-expert02)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **466** &nbsp;&nbsp; folks: **48**  &nbsp;&nbsp; `104 stars today`

1. [sdushantha / wifi-password](https://github.com/sdushantha/wifi-password)
    - Quickly fetch your WiFi password and if needed, generate a QR code of your WiFi to allow phones to easily connect
    - language: **Python** &nbsp;&nbsp; stars: **633** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `227 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,348** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `4,480 stars this week`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,600** &nbsp;&nbsp; folks: **6,764**  &nbsp;&nbsp; `2,105 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **2,898** &nbsp;&nbsp; folks: **1,004**  &nbsp;&nbsp; `402 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **23,698** &nbsp;&nbsp; folks: **4,529**  &nbsp;&nbsp; `485 stars this week`
...
1. [leon-thomm / Ryven](https://github.com/leon-thomm/Ryven)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,475** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `1,013 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,605** &nbsp;&nbsp; folks: **1,311**  &nbsp;&nbsp; `1,464 stars this week`

1. [hathach / tinyusb](https://github.com/hathach/tinyusb)
    - An open source cross-platform USB stack for embedded system
    - language: **C** &nbsp;&nbsp; stars: **1,420** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `574 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **1,310** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `610 stars this week`
...
1. [Hunlongyu / ZY-Player](https://github.com/Hunlongyu/ZY-Player)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **7,751** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `437 stars this week`
...
1. [rqlite / rqlite](https://github.com/rqlite/rqlite)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,485** &nbsp;&nbsp; folks: **386**  &nbsp;&nbsp; `694 stars this week`
...
1. [dbeaver / dbeaver](https://github.com/dbeaver/dbeaver)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **18,263** &nbsp;&nbsp; folks: **1,657**  &nbsp;&nbsp; `302 stars this week`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,346** &nbsp;&nbsp; folks: **2,203**  &nbsp;&nbsp; `695 stars this week`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,308** &nbsp;&nbsp; folks: **847**  &nbsp;&nbsp; `128 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,489** &nbsp;&nbsp; folks: **1,344**  &nbsp;&nbsp; `3,229 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,111** &nbsp;&nbsp; folks: **1,786**  &nbsp;&nbsp; `3,641 stars this month`

1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    - A private messenger for iOS.
    - language: **Swift** &nbsp;&nbsp; stars: **7,644** &nbsp;&nbsp; folks: **2,003**  &nbsp;&nbsp; `2,307 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,636** &nbsp;&nbsp; folks: **922**  &nbsp;&nbsp; `2,563 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,600** &nbsp;&nbsp; folks: **6,764**  &nbsp;&nbsp; `2,958 stars this month`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **18,934** &nbsp;&nbsp; folks: **4,755**  &nbsp;&nbsp; `1,378 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,453** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `3,256 stars this month`
...
1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    - Matrix (An open network for secure, decentralized communication) server setup using Ansible and Docker
    - language: **HTML** &nbsp;&nbsp; stars: **1,605** &nbsp;&nbsp; folks: **358**  &nbsp;&nbsp; `660 stars this month`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **10,455** &nbsp;&nbsp; folks: **536**  &nbsp;&nbsp; `2,551 stars this month`
...
1. [owid / covid-19-data](https://github.com/owid/covid-19-data)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,332** &nbsp;&nbsp; folks: **1,072**  &nbsp;&nbsp; `708 stars this month`
...
1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,596** &nbsp;&nbsp; folks: **1,230**  &nbsp;&nbsp; `261 stars this month`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **48,388** &nbsp;&nbsp; folks: **27,287**  &nbsp;&nbsp; `1,273 stars this month`
...
1. [brave / brave-browser](https://github.com/brave/brave-browser)
    - Next generation Brave browser for Android, Linux, macOS, Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,308** &nbsp;&nbsp; folks: **847**  &nbsp;&nbsp; `473 stars this month`
...
1. [didi / DoraemonKit](https://github.com/didi/DoraemonKit)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **16,622** &nbsp;&nbsp; folks: **2,361**  &nbsp;&nbsp; `513 stars this month`
