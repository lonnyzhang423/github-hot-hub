...
`最后更新时间：2021-02-04 00:13:46 +0800`
...
1. [googlevr / tilt-brush](https://github.com/googlevr/tilt-brush)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **1,585** &nbsp;&nbsp; folks: **311**  &nbsp;&nbsp; `746 stars this week`
...
1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,751** &nbsp;&nbsp; folks: **1,319**  &nbsp;&nbsp; `290 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **10,370** &nbsp;&nbsp; folks: **3,309**  &nbsp;&nbsp; `432 stars this week`

1. [RustPython / RustPython](https://github.com/RustPython/RustPython)
    - A Python Interpreter written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **7,020** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `647 stars this week`

1. [peng-zhihui / HoloCubic](https://github.com/peng-zhihui/HoloCubic)
    - 透明小电视
    - language: **C** &nbsp;&nbsp; stars: **983** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `292 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,647** &nbsp;&nbsp; folks: **2,027**  &nbsp;&nbsp; `994 stars this week`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **30,384** &nbsp;&nbsp; folks: **3,874**  &nbsp;&nbsp; `467 stars this week`

1. [apache / arrow](https://github.com/apache/arrow)
    - Apache Arrow is a cross-language development platform for in-memory data. It specifies a standardized language-independent columnar memory format for flat and hierarchical data, organized for efficient analytic operations on modern hardware. It also provides computational libraries and zero-copy streaming messaging and interprocess communication…
    - language: **C++** &nbsp;&nbsp; stars: **7,026** &nbsp;&nbsp; folks: **1,775**  &nbsp;&nbsp; `66 stars this week`
...
1. [wagoodman / dive](https://github.com/wagoodman/dive)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,466** &nbsp;&nbsp; folks: **911**  &nbsp;&nbsp; `237 stars this week`
...
1. [directus / directus](https://github.com/directus/directus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,861** &nbsp;&nbsp; folks: **902**  &nbsp;&nbsp; `294 stars this week`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,559** &nbsp;&nbsp; folks: **1,355**  &nbsp;&nbsp; `3,284 stars this month`

1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    - A private messenger for Android.
    - language: **Java** &nbsp;&nbsp; stars: **19,614** &nbsp;&nbsp; folks: **4,617**  &nbsp;&nbsp; `5,462 stars this month`

1. [signalapp / Signal-Desktop](https://github.com/signalapp/Signal-Desktop)
    - Signal — Private Messenger for Windows, Mac, and Linux
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,172** &nbsp;&nbsp; folks: **1,795**  &nbsp;&nbsp; `3,702 stars this month`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **34,878** &nbsp;&nbsp; folks: **6,801**  &nbsp;&nbsp; `3,259 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,001** &nbsp;&nbsp; folks: **943**  &nbsp;&nbsp; `2,830 stars this month`

1. [spantaleev / matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy)
    - Matrix (An open network for secure, decentralized communication) server setup using Ansible and Docker
    - language: **HTML** &nbsp;&nbsp; stars: **1,633** &nbsp;&nbsp; folks: **362**  &nbsp;&nbsp; `681 stars this month`

1. [didi / Logi-KafkaManager](https://github.com/didi/Logi-KafkaManager)
    - 一站式Apache Kafka集群指标监控与运维管控平台
    - language: **Java** &nbsp;&nbsp; stars: **1,519** &nbsp;&nbsp; folks: **365**  &nbsp;&nbsp; `848 stars this month`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **16,166** &nbsp;&nbsp; folks: **5,758**  &nbsp;&nbsp; `807 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,647** &nbsp;&nbsp; folks: **2,027**  &nbsp;&nbsp; `2,596 stars this month`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,620** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `282 stars this month`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **18,994** &nbsp;&nbsp; folks: **4,769**  &nbsp;&nbsp; `1,340 stars this month`
...
1. [WebKit / WebKit](https://github.com/WebKit/WebKit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **363** &nbsp;&nbsp; folks: **48**  &nbsp;&nbsp; `281 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,781** &nbsp;&nbsp; folks: **13,430**  &nbsp;&nbsp; `1,059 stars this month`

1. [HarisIqbal88 / PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet)
    - Latex code for making neural networks diagrams
    - language: **TeX** &nbsp;&nbsp; stars: **11,974** &nbsp;&nbsp; folks: **1,667**  &nbsp;&nbsp; `2,014 stars this month`
...
1. [jerry3747 / taobao_seckill](https://github.com/jerry3747/taobao_seckill)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **795** &nbsp;&nbsp; folks: **637**  &nbsp;&nbsp; `597 stars this month`

1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    - A collection of algorithms and data structures
    - language: **Java** &nbsp;&nbsp; stars: **8,788** &nbsp;&nbsp; folks: **2,245**  &nbsp;&nbsp; `1,445 stars this month`

1. [wangzhiwubigdata / God-Of-BigData](https://github.com/wangzhiwubigdata/God-Of-BigData)
    - 大数据面试题，大数据成神之路开启...Flink/Spark/Hadoop/Hbase/Hive...
    - language: **无** &nbsp;&nbsp; stars: **3,751** &nbsp;&nbsp; folks: **1,319**  &nbsp;&nbsp; `462 stars this month`

1. [firecracker-microvm / firecracker](https://github.com/firecracker-microvm/firecracker)
    - Secure and fast microVMs for serverless computing.
    - language: **Rust** &nbsp;&nbsp; stars: **14,460** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `1,029 stars this month`
...
1. [tootsuite / mastodon](https://github.com/tootsuite/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **23,617** &nbsp;&nbsp; folks: **3,922**  &nbsp;&nbsp; `1,095 stars this month`
