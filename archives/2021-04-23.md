...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,853** &nbsp;&nbsp; folks: **1,461**  &nbsp;&nbsp; `281 stars today`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,976** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `348 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,565** &nbsp;&nbsp; folks: **7,947**  &nbsp;&nbsp; `437 stars today`

1. [vitling / acid-banger](https://github.com/vitling/acid-banger)
    - The Endless Acid Banger
    - language: **TypeScript** &nbsp;&nbsp; stars: **779** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `242 stars today`
...
1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,133** &nbsp;&nbsp; folks: **1,575**  &nbsp;&nbsp; `131 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,831** &nbsp;&nbsp; folks: **1,388**  &nbsp;&nbsp; `1,772 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,302** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `2,487 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,268** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `587 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,666** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `771 stars this week`
...
1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,823** &nbsp;&nbsp; folks: **9,410**  &nbsp;&nbsp; `335 stars this week`

1. [microsoft / Swin-Transformer](https://github.com/microsoft/Swin-Transformer)
    - This is an official implementation for "Swin Transformer: Hierarchical Vision Transformer using Shifted Windows".
    - language: **Python** &nbsp;&nbsp; stars: **2,748** &nbsp;&nbsp; folks: **218**  &nbsp;&nbsp; `589 stars this week`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **20,254** &nbsp;&nbsp; folks: **5,139**  &nbsp;&nbsp; `338 stars this week`
...
1. [PaddlePaddle / PaddleGAN](https://github.com/PaddlePaddle/PaddleGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,968** &nbsp;&nbsp; folks: **468**  &nbsp;&nbsp; `380 stars this week`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **15,425** &nbsp;&nbsp; folks: **315**  &nbsp;&nbsp; `482 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,565** &nbsp;&nbsp; folks: **7,947**  &nbsp;&nbsp; `1,750 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **281** &nbsp;&nbsp; folks: **194**  &nbsp;&nbsp; `158 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,662** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `303 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **73,431** &nbsp;&nbsp; folks: **6,619**  &nbsp;&nbsp; `247 stars this week`
...
1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,080** &nbsp;&nbsp; folks: **105**  &nbsp;&nbsp; `424 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,704** &nbsp;&nbsp; folks: **542**  &nbsp;&nbsp; `1,195 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,976** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `678 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,302** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `3,542 stars this month`

1. [r4j0x00 / exploits](https://github.com/r4j0x00/exploits)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,207** &nbsp;&nbsp; folks: **668**  &nbsp;&nbsp; `1,801 stars this month`

1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录认证、权限认证、分布式Session会话、微服务网关鉴权、单点登录、OAuth2.0、踢人下线、Redis集成、前后台分离、记住我模式、模拟他人账号、临时身份切换、账号封禁、多账号认证体系、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成、WebFlux集成...
    - language: **Java** &nbsp;&nbsp; stars: **2,268** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `1,323 stars this month`
...
1. [Uniswap / uniswap-v3-core](https://github.com/Uniswap/uniswap-v3-core)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **612** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `622 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **8,531** &nbsp;&nbsp; folks: **1,004**  &nbsp;&nbsp; `2,910 stars this month`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,573** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `752 stars this month`

1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    - A boilerplate for building production-ready RESTful APIs using Node.js, Express, and Mongoose
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,253** &nbsp;&nbsp; folks: **475**  &nbsp;&nbsp; `1,366 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,404** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `1,182 stars this month`

1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,823** &nbsp;&nbsp; folks: **9,410**  &nbsp;&nbsp; `432 stars this month`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,741** &nbsp;&nbsp; folks: **966**  &nbsp;&nbsp; `1,219 stars this month`
...
1. [zhangdaiscott / JimuReport](https://github.com/zhangdaiscott/JimuReport)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,242** &nbsp;&nbsp; folks: **494**  &nbsp;&nbsp; `636 stars this month`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,786** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `1,490 stars this month`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,356** &nbsp;&nbsp; folks: **3,100**  &nbsp;&nbsp; `221 stars this month`

1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    - 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识。
    - language: **无** &nbsp;&nbsp; stars: **24,394** &nbsp;&nbsp; folks: **5,504**  &nbsp;&nbsp; `1,291 stars this month`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **103,873** &nbsp;&nbsp; folks: **17,258**  &nbsp;&nbsp; `4,612 stars this month`
