...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,701** &nbsp;&nbsp; folks: **1,453**  &nbsp;&nbsp; `140 stars today`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,809** &nbsp;&nbsp; folks: **4,794**  &nbsp;&nbsp; `361 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,384** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `468 stars today`

1. [vitling / acid-banger](https://github.com/vitling/acid-banger)
    - The Endless Acid Banger
    - language: **TypeScript** &nbsp;&nbsp; stars: **641** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `98 stars today`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,272** &nbsp;&nbsp; folks: **1,539**  &nbsp;&nbsp; `91 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,793** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `1,871 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,183** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `2,490 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,257** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `777 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,608** &nbsp;&nbsp; folks: **882**  &nbsp;&nbsp; `687 stars this week`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,540** &nbsp;&nbsp; folks: **2,111**  &nbsp;&nbsp; `159 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,384** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `1,573 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **268** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `117 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,614** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `205 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **73,419** &nbsp;&nbsp; folks: **6,618**  &nbsp;&nbsp; `251 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,597** &nbsp;&nbsp; folks: **523**  &nbsp;&nbsp; `1,112 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,809** &nbsp;&nbsp; folks: **4,794**  &nbsp;&nbsp; `465 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,183** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `3,438 stars this month`
...
1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,322** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `853 stars this month`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,937** &nbsp;&nbsp; folks: **2,377**  &nbsp;&nbsp; `1,305 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,366** &nbsp;&nbsp; folks: **234**  &nbsp;&nbsp; `3,011 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,522** &nbsp;&nbsp; folks: **1,003**  &nbsp;&nbsp; `3,047 stars this month`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,564** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `745 stars this month`

1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    - A boilerplate for building production-ready RESTful APIs using Node.js, Express, and Mongoose
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,231** &nbsp;&nbsp; folks: **473**  &nbsp;&nbsp; `1,346 stars this month`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,350** &nbsp;&nbsp; folks: **3,098**  &nbsp;&nbsp; `218 stars this month`

1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    - 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识。
    - language: **无** &nbsp;&nbsp; stars: **24,381** &nbsp;&nbsp; folks: **5,499**  &nbsp;&nbsp; `1,285 stars this month`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **103,844** &nbsp;&nbsp; folks: **17,251**  &nbsp;&nbsp; `4,596 stars this month`
