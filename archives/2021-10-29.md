...
1. [DouyinFE / semi-design](https://github.com/DouyinFE/semi-design)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,450** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `588 stars today`
...
1. [modern-js-dev / modern.js](https://github.com/modern-js-dev/modern.js)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,623** &nbsp;&nbsp; folks: **86**  &nbsp;&nbsp; `297 stars today`
...
1. [louislam / uptime-kuma](https://github.com/louislam/uptime-kuma)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,698** &nbsp;&nbsp; folks: **473**  &nbsp;&nbsp; `5,111 stars this month`
...
1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,031** &nbsp;&nbsp; folks: **789**  &nbsp;&nbsp; `2,463 stars this month`

1. [microsoft / Data-Science-For-Beginners](https://github.com/microsoft/Data-Science-For-Beginners)
    - 10 Weeks, 20 Lessons, Data Science for All!
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,674** &nbsp;&nbsp; folks: **557**  &nbsp;&nbsp; `3,682 stars this month`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,033** &nbsp;&nbsp; folks: **450**  &nbsp;&nbsp; `604 stars this month`
...
1. [john-smilga / node-express-course](https://github.com/john-smilga/node-express-course)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **696** &nbsp;&nbsp; folks: **651**  &nbsp;&nbsp; `229 stars this month`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **121,888** &nbsp;&nbsp; folks: **32,670**  &nbsp;&nbsp; `3,420 stars this month`

1. [mattermost / mattermost-server](https://github.com/mattermost/mattermost-server)
    - Mattermost is an open source platform for secure collaboration across the entire software development lifecycle.
    - language: **Go** &nbsp;&nbsp; stars: **21,288** &nbsp;&nbsp; folks: **5,207**  &nbsp;&nbsp; `380 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,708** &nbsp;&nbsp; folks: **1,220**  &nbsp;&nbsp; `2,050 stars this month`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,663** &nbsp;&nbsp; folks: **29,235**  &nbsp;&nbsp; `691 stars this month`
...
1. [smartcontractkit / full-blockchain-solidity-course-py](https://github.com/smartcontractkit/full-blockchain-solidity-course-py)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,613** &nbsp;&nbsp; folks: **510**  &nbsp;&nbsp; `1,285 stars this month`

1. [projectdiscovery / nuclei-templates](https://github.com/projectdiscovery/nuclei-templates)
    - Community curated list of templates for the nuclei engine to find security vulnerabilities.
    - language: **Python** &nbsp;&nbsp; stars: **2,649** &nbsp;&nbsp; folks: **847**  &nbsp;&nbsp; `328 stars this month`

1. [rwightman / pytorch-image-models](https://github.com/rwightman/pytorch-image-models)
    - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more
    - language: **Python** &nbsp;&nbsp; stars: **14,059** &nbsp;&nbsp; folks: **2,219**  &nbsp;&nbsp; `966 stars this month`

1. [tsoding / porth](https://github.com/tsoding/porth)
    - It's like Forth but in Python
    - language: **Python** &nbsp;&nbsp; stars: **573** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `391 stars this month`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **22,709** &nbsp;&nbsp; folks: **5,839**  &nbsp;&nbsp; `981 stars this month`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **125,444** &nbsp;&nbsp; folks: **20,412**  &nbsp;&nbsp; `5,320 stars this month`

1. [docker / compose](https://github.com/docker/compose)
    - Define and run multi-container applications with Docker
    - language: **Go** &nbsp;&nbsp; stars: **23,995** &nbsp;&nbsp; folks: **4,014**  &nbsp;&nbsp; `533 stars this month`
...
1. [argoproj / argo-cd](https://github.com/argoproj/argo-cd)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,412** &nbsp;&nbsp; folks: **1,754**  &nbsp;&nbsp; `435 stars this month`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **35,691** &nbsp;&nbsp; folks: **2,939**  &nbsp;&nbsp; `1,287 stars this month`

1. [odoo / odoo](https://github.com/odoo/odoo)
    - Odoo. Open Source Apps To Grow Your Business.
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,119** &nbsp;&nbsp; folks: **15,182**  &nbsp;&nbsp; `591 stars this month`

1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    - 🛁 Clean Code concepts adapted for JavaScript
    - language: **JavaScript** &nbsp;&nbsp; stars: **59,469** &nbsp;&nbsp; folks: **7,523**  &nbsp;&nbsp; `2,449 stars this month`
